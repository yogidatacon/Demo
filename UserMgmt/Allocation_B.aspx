<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin.Master" CodeBehind="Allocation_B.aspx.cs" Inherits="UserMgmt.Allocation_B" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyContent" runat="server">
                            ...
                            <body>
                                <div>
                                    <ul class="nav nav-tabs">
                                        ...
                                        <span style="color: #fff; font-size: 14px;">Molasses Approval Pending List</span></asp:LinkButton></li>
                                        <li class="active">
                                            <asp:LinkButton runat="server" ID="btnAllocation_B" OnClick="btnAllocation_B_Click">
                                        <span style="color: #fff; font-size: 14px;">Referred Back By Commissioner</span></asp:LinkButton></li>
                                        <li>
                                            <asp:LinkButton runat="server" ID="btnAllocation_A" OnClick="btnAllocation_A_Click">
                                        <span style="color: #fff; font-size: 14px;">Molasses Approved List</span></asp:LinkButton></li>
                                        <li>
                                            <asp:LinkButton runat="server" ID="btnAllocation_I" OnClick="btnAllocation_I_Click">
                                        <span style="color: #fff; font-size: 14px;">Molasses Issued List</span></asp:LinkButton></li>
                                    </ul>
                                    <br />
                                </div>
                                <div class="x_title">
                                    <h2>Referred Back By Commissioner</h2>
  ...
  <asp:LinkButton ID="LinkButton3" runat="server" CommandName="Page" CommandArgument="Next" CssClass="myButton1"><i class="fa fa-chevron-right"></i></asp:LinkButton>
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Indenter Unit Name" ItemStyle-Font-Bold="true" Visible="true" ItemStyle-Width="20px">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="From Sugar Mill" ItemStyle-Font-Bold="true" Visible="true" ItemStyle-Width="20px">
                                                    <ItemTemplate>
