<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterCaseMgmt.Master" AutoEventWireup="true" CodeBehind="ChargesheetList.aspx.cs" Inherits="UserMgmt.ChargesheetList" %>
                                    ...
                                    <asp:GridView ID="grdChargesheetListView" runat="server" AutoGenerateColumns="false" PageSize="10" AllowPaging="true" EmptyDataText="No Records" 
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="TableID" ItemStyle-Font-Bold="true"  ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    <asp:Label ID="TableId" runat="server" Visible="true" Text='<%#Eval("seizure_chargesheet_id") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Disposal Mode"  ItemStyle-Font-Bold="true" Visible="true" ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblDisposalname" runat="server" Visible="true" Text='<%#Eval("disposalmode_name") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                              <asp:TemplateField HeaderText="Disposal Mode"  ItemStyle-Font-Bold="true" Visible="false" ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblDisposalMode" runat="server" Visible="true" Text='<%#Eval("disposalmode_code") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Remarks" ItemStyle-Font-Bold="true" Visible="true" ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblRemarks" runat="server" Visible="true" Text='<%#Eval("chargesheet_remarks") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
