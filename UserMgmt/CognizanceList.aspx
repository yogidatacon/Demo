<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterCaseMgmt.Master" AutoEventWireup="true" CodeBehind="CognizanceList.aspx.cs" Inherits="UserMgmt.CognizanceList" %>
                        ...
                        <div class="x_panel">
                            ...
                            <body>
                                ...
                                <div class="x_content">
                                    ...
                                    <asp:GridView ID="grdCognizanceListView" runat="server" AutoGenerateColumns="false" PageSize="10" AllowPaging="true" EmptyDataText="No Records" 
                                        HeaderStyle-BackColor="#26b8b8" HeaderStyle-ForeColor="#ECF0F1" class="table table-striped responsive-utilities jambo_table" OnPageIndexChanging="grdCognizanceListView_PageIndexChanging">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Cognizance Date" ItemStyle-Font-Bold="true"  ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCognizanceDate" runat="server" Visible="true" Text='<%#Eval("currentstagedate") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Cognizance under section " ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCognizanceundersection" runat="server" Visible="true" Text='<%#Eval("chargedundersection") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
