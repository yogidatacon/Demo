...
namespace UserMgmt
{
    public partial class DME_List : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                Session["seizureNo"] = "";
                string s11 = Session["district_code"].ToString();
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            if (IsPostBack)
            {
                ...
                _seiz = BL_cm_seiz_ExcisableArticlesSeized.GetFilterList("","");
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            {
                var ad = (from s in _seiz
                          where s.caseno.StartsWith(txtpage.Text)
                          select s);
                grdUnSubmittedList.DataSource = ad.ToList();
                grdUnSubmittedList.DataBind();
          ...
          if (ddsearch.SelectedValue == "prfirno")
           ...
           if (ddsearch.SelectedValue == "district_code")
            {
                var ad = (from s in _seiz
                          where s.district_name == txtpage.Text.Trim()
                          select s);
                grdUnSubmittedList.DataSource = ad.ToList();
                grdUnSubmittedList.DataBind();
            }
            ...
            {
                var ad = (from s in _seiz
                          where s.thana_name == txtpage.Text.Trim()
                          select s);
                grdUnSubmittedList.DataSource = ad.ToList();
                grdUnSubmittedList.DataBind();
            }
            ...
            {
                var ad = (from s in _seiz
                          where s.case_hearingdate == txtpage.Text.Replace("/","-").Trim()
                          select s);
                grdUnSubmittedList.DataSource = ad.ToList();
                grdUnSubmittedList.DataBind();
            }
