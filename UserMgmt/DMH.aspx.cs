...
namespace UserMgmt
{
    public partial class DMH_Action : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                //ddlCaseType.Items.Insert(0, "Select");
                //ddlCaseType.Items.Insert(1, "New");
                //ddlCaseType.Items.Insert(2, "Old",);
                ...
                if (Session["rtype"].ToString() != "0")
                {
                    ...
                    ProposedLetterNo.Value= obj.proposed_letterno.Trim();
                    ddlPrFirNo.SelectedValue = obj.seizure_fir_no.ToString();
                    txtProposedLetterNo.Text = obj.proposed_letterno.Trim();
                    txtProposedLetterDate.Text = obj.proposed_letterdate.Trim();
                    ProposedLetterDate.Value = obj.proposed_letterdate.Trim();
                    CalendarExtender3.StartDate =Convert.ToDateTime( obj.proposed_letterdate);
                    if(obj.next_hearingdate!="")
                    CalendarExtender5.StartDate = Convert.ToDateTime(obj.next_hearingdate);
                    else
                        CalendarExtender5.StartDate = Convert.ToDateTime(obj.case_hearingdate);
                    CalendarExtender4.StartDate = Convert.ToDateTime(obj.case_hearingdate);

                    

                    ddlCaseType.SelectedValue =obj.case_type;
                    CaseType.Value = obj.case_type;

                    txtCaseNo.Text = obj.caseno.Trim();
                    CaseNo.Value = obj.caseno.Trim();
                    txtCaseRegisterDate.Text = obj.case_registerdate.Trim();
                    CaseRegisterDate.Value = obj.case_registerdate.Trim();
                    ddlNameofCourt.SelectedValue = obj.court_master_code.Trim();
                    NameofCourt.Value = obj.court_master_code.Trim();
                    ddlActionPorposed.SelectedValue = obj.case_action;
                    if (obj.next_hearingdate!="" && obj.next_hearingdate !=null)
                    txtDateofHearing.Text = obj.next_hearingdate.Substring(0,10).Replace("/","-");
                    if (obj.confiscationorderdate != "" && obj.confiscationorderdate != null)
                    {
                        txtConfiscationOrderDate.Text = obj.confiscationorderdate.Substring(0, 10).Replace("/", "-");
                        CalendarExtender3.SelectedDate = Convert.ToDateTime(obj.confiscationorderdate);
                    }
                    ...
                    if (obj.next_hearingdate != "")
                        ...
                        CalendarExtender5.StartDate = Convert.ToDateTime(obj.case_hearingdate);
                    CalendarExtender4.SelectedDate = Convert.ToDateTime(obj.proposed_letterdate);
                    // txt.Text = obj.case_hearingdate;
                    txtRremarks.Text = obj.remarks;
                    txtRemarks.Text = obj.hremarks;
                    ...
                    grdHearingDetails.DataSource = obj.hearings;
                    grdHearingDetails.DataBind();
                    ...
                    dateofhearing.Value = obj.case_hearingdate;
                 ...
                 //   Image3.Visible = false;
                    ...
                    if (Session["rtype"].ToString() == "1")
                    {
                        ...
                        ddlActionPorposed.Attributes.Add("disabled", "disabled");
                        if (obj.case_action == "Next Hearing")
                            txtDateofHearing.Attributes.Add("disabled", "disabled");
                        if (obj.case_action == "Case Dispose")
                        {
                            txtConfiscationOrderNo.Attributes.Add("disabled", "disabled");
        ...
        protected void btnSaveasDraft_Click(object sender, EventArgs e)
        {
            if (IsPostBack)
            {
                ...
                cm_obj.proposed_letterno = ProposedLetterNo.Value;
                cm_obj.proposed_letterdate = ProposedLetterDate.Value;// DateTime.Now.ToShortDateString();
                cm_obj.case_type = CaseType.Value;
                cm_obj.caseno = CaseNo.Value;
                cm_obj.case_registerdate = CaseRegisterDate.Value;
                ...
                cm_obj.case_action = ddlActionPorposed.SelectedItem.ToString();
                if (cm_obj.case_action == "Next Hearing")
                {
                    cm_obj.next_hearingdate = txtDateofHearing.Text;
                    cm_obj.confiscationorderno = "";
                    cm_obj.confiscationorderdate = "";
                ...
                else
                {
                    ...
                    cm_obj.next_hearingdate = "";
                    //cm_obj.hearing_status = "Disposed at " + ddlNameofCourt.SelectedItem.ToString();
                }
                ...
                if (rdbPolice.Checked)
                    cm_obj.raidby = "P";
                cm_obj.hremarks = txtRemarks.Text;
                int i = 0;
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            if (IsPostBack)
            {
                ...
                cm_obj.case_registerdate = CaseRegisterDate.Value;
                cm_obj.court_master_code = NameofCourt.Value;
                cm_obj.case_hearingdate = dateofhearing.Value;
                cm_obj.user_id = Session["UserID"].ToString();
                cm_obj.lastmodified_date = DateTime.Now.ToShortDateString();
                ...
                {
                    cm_obj.next_hearingdate = txtDateofHearing.Text;
                    cm_obj.hearing_status = "Next Hearing";
                }
                else
                {
                    cm_obj.confiscationorderno = txtConfiscationOrderNo.Text.Trim();
        ...
        protected void ddlDistrict_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            var clist = from c in _court
                        select c;
            ddlNameofCourt.DataSource = clist.ToList();
