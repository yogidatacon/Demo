<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeBehind="DMH_List.aspx.cs" Inherits="UserMgmt.DMH_List" %>
                        ...
                        ID="btnLast" runat="server" CommandArgument="Last" Width="30px" Visible="false" Height="20px" BackColor="Blue" CommandName="Page" ImageUrl="~/img/icons8-last-50.png" />
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="PR/FIR No" ItemStyle-Font-Bold="true" Visible="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblThana" runat="server" Visible="true" Text='<%#Eval("prfirno") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>

                                                            <asp:TemplateField HeaderText="Vehicle/Property" ItemStyle-Wrap="true" ItemStyle-Font-Bold="true" Visible="true" ItemStyle-Width="10px">
                                                                <ItemTemplate>
                                                              ...
                                                              <asp:TemplateField HeaderText="Date of Hearing" ItemStyle-Font-Bold="true" Visible="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblDateofHearing" runat="server" Visible="true" Text='<%# Eval("next_hearingdate")%>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Action Proposed" ItemStyle-Font-Bold="true"  ItemStyle-Width="30px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblaction" runat="server" ItemStyle-Wrap="true" Visible="true" Text='<%# Eval("hearing_status").ToString()=="Y"?"Pending":Eval("hearing_status").ToString() %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField HeaderText="Action" ItemStyle-Font-Bold="true" HeaderStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:LinkButton Text="Edit" ID="btnEdit" CssClass="myButton1" runat="server" OnClick="btnEdit_Click" Visible='<%# Eval("hearing_status").ToString()=="Next Hearing" ? true:Eval("hearing_status").ToString()=="Y" ? true: false %>' CommandName="Edit"><i class="fa fa-pencil-square-o">
                                                                                    </i> 
                                                                    </asp:LinkButton>
                                                                </ItemTemplate>
