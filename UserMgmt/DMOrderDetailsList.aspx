<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterCaseMgmt.Master" AutoEventWireup="true" CodeBehind="DMOrderDetailsList.aspx.cs" Inherits="UserMgmt.DMOrderDetailsList" %>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="x_panel">
                            ...
                            <head>
                                ...
                                <title>DM Order Details List</title>
                            </head>
                            <body>
                                ...
                                <div class="x_content">
                                    ...
                                    <asp:GridView ID="grdDMOrderDetails" runat="server" AutoGenerateColumns="false" PageSize="10" AllowPaging="true" EmptyDataText="No Records" 
                                        HeaderStyle-BackColor="#26b8b8" HeaderStyle-ForeColor="#ECF0F1" class="table table-striped responsive-utilities jambo_table" OnPageIndexChanging="grdDMOrderDetails_PageIndexChanging">
                                        <Columns>
                                            <asp:TemplateField HeaderText="seizureno" ItemStyle-Font-Bold="true"  ItemStyle-Width="20px">
                                             ...
                                             <asp:TemplateField HeaderText="TableId" ItemStyle-Font-Bold="true"  ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    <asp:Label ID="TableId" runat="server" Visible="true" Text='<%#Eval("seizure_dmconfiscation_id") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Letter No" ItemStyle-Font-Bold="true" Visible="true" ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label1" runat="server" Visible="true" Text='<%#Eval("appl_letterno") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Order Date" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblOrderDate" runat="server" Visible="true" Text='<%#Eval("dmorderdate") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="DM Remarks" ItemStyle-Font-Bold="true" Visible="true" ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblDMRemarks" runat="server" Visible="true" Text='<%#Eval("dmremarks") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
