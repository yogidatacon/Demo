...
namespace UserMgmt
{
    public partial class DefenceStatementForm : System.Web.UI.Page
    {
        #region Variables
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (firDetails.prfirno != null)
                {
                    ...
                    string datelock = BL_CM_Common.GetDate("exciseautomation.seizure_trial where seizureNo='" + seizureNo + "' and trialstage_code='6'", "currentstagedate");
                ...
                if (Session["rtype"].ToString() != "0")
                {
                    ...
                    txtDefenceEvidenceDate.Text = obj.currentstagedate;
                    ...
                    if ((Session["rtype"].ToString() == "1"))
                    {
                        ...
                        txtDefenceEvidenceDate.Attributes.Add("disabled", "disabled");
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            if (IsPostBack)
            {
                ...
                cm_obj.currentstagedate = txtDefenceEvidenceDate.Text;
                ...
                if (cmp > 0)
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "script", "alert('Please ensure that the Next hearing Date should be  greater than  to the Defence Evidence Date.\');", true);
                    return;
                ...
                else
                {
                    ...
                    cm_obj.trialstage_code = 7;
                    cm_obj.currentstage = 7;
                    cm_obj.currentstagedate = txtDefenceEvidenceDate.Text;
                    cm_obj.nexthearingdate = txtNexthearingDate.Text;
