...
namespace UserMgmt
{
    ...
    {
        List<Department> partytypes = new List<Department>();
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                partytypes = new List<Department>();
                partytypes = BL_User_Mgnt.GetDeptList("");
        ...
        protected void grdpartytypemasterList_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            if (Session["deptsearch"] != null && Session["depttext"] != null)
            {
                ddsearch.SelectedValue = Session["deptsearch"].ToString();
                txtpage.Text = Session["depttext"].ToString();
                if (ddsearch.SelectedValue != "Select")
                {
                    ...
                    if (txtpage != null)
                    {
                        ...
                        partytypes = new List<Department>();
                        partytypes = BL_Party_Type_Master.SearchDept("department_master", ddsearch.SelectedValue, txtpage.Text);
        ...
        protected void AddRecord_Click(object sender, EventArgs e)
        {
            Session["UserID"] = Session["UserID"];
            Session["rtype"] = "0";
            Response.Redirect("DepartmentMasterForm.aspx");
        }
        ...
        protected void btnView_Click(object sender, EventArgs e)
        {
            ...
            string Name = (gvr.Cells[gvr.Cells.Count - 1].FindControl("lblparty_type_Name") as Label).Text;
            string Code = (gvr.Cells[gvr.Cells.Count - 1].FindControl("lblparty_type_code") as Label).Text;
           // string Status = (gvr.Cells[gvr.Cells.Count - 1].FindControl("lblStatus") as Label).Text;
            Session["department_Code"] = Code;
            Session["department_Name"] = Name;
        ...
        protected void btnsearch_Click(object sender, EventArgs e)
        {
            ...
            if (ddsearch.SelectedValue != "Select")
            {
                ...
                Session["deptsearch"] = ddsearch.SelectedValue;
                if (txtpage != null)
                {
                    Session["depttext"] = txtpage.Text;
        ...
        protected void grdpartytypemasterList_DataBound(object sender, EventArgs e)
        {
            ...
            {
                ddsearch.SelectedValue = Session["deptsearch"].ToString();
                txtpages.Text = Session["depttext"].ToString();
            }
        ...
        {
            Session["deptsearch"] = null;
            Session["depttext"] = null;
            partytypes = new List<Department>();
            partytypes = BL_User_Mgnt.GetDeptList("");
            grdpartytypemasterList.DataSource = partytypes;
            grdpartytypemasterList.DataBind();
