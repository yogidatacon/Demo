<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="DispatchTypeMasterList.aspx.cs" Inherits="UserMgmt.DispatchTypeMasterList" %>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="x_panel">
                            ...
                            <head>
                                ...
                                <title>Dispatch Type List</title>
                                   <script>
                                    function chkDuplicateAccessTypeName() {
                                        debugger;
                                        var email = $('#BodyContent_grdDispatchTypeList_txtSearch2').val();
                                        var jsondata = JSON.stringify($('#BodyContent_grdDispatchTypeList_txtSearch2').val());
                                        $.ajax({
                                            type: "POST",
                                            //url: "UserRegistrationForm.aspx/chkDuplicateEmail",
                                            url: "DispatchTypeMasterList.aspx/chkDuplicateAccessTypeName",
                                            data: '{name:' + jsondata + '}',
                                ...
                                <ul class="nav nav-tabs">
                                 <li>
                                    ...
                                    <a>
                                        ...
                                        <asp:LinkButton runat="server" CssClass="myButton3 " ID="AddRecord" OnClick="AddRecord_Click" Style="float: right"><i class="fa fa-plus-circle"> ADD NEW RECORD</i></asp:LinkButton></a>
                                    <div class="row">
                                                 <div class="x_panel">
                                        <div class="x_title">
                                                     <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
                                                    <h2>Dispatch Type List</h2>
                                                     <div runat="server" visible="false"   style="float:right">
                                         <asp:TextBox ID="txtSearch" Width="250px" AutoComplete="off" runat="server"   Height="30px" placeholder="Search Dispatch Type Name"  AutoPostBack="true" OnTextChanged="txtSearch_TextChanged"></asp:TextBox>
                                         ...
                                         <asp:UpdatePanel runat="server">
                                                    <ContentTemplate>
                                                <div class="x_content">
                                                    <asp:GridView ID="grdDispatchTypeList" OnDataBound="grdDispatchTypeList_DataBound" OnPageIndexChanging="grdDispatchTypeList_PageIndexChanging" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="10" EmptyDataText="No Data" 
                                               ...
                                               <asp:ListItem Text="Select" Value="Select"></asp:ListItem>
                                                <asp:ListItem Text="Dispatch Type Name" Value="dispatch_type_name"></asp:ListItem>
                                                                  <asp:ListItem Text="Dispatch Type Code" Value="dispatch_type_code"></asp:ListItem>
                ...
                <asp:ImageButton ID="btnNext" Visible="false"
                    runat="server" CommandArgument="Next" Width="30px" Height="20px" CommandName="Page" ForeColor="Blue" BackColor="Blue" ImageUrl="~/img/icons8-next-50.png"  /> <asp:ImageButton
                        ID="btnLast" runat="server" CommandArgument="Last" Width="30px" Visible="false" Height="20px" BackColor="Blue" CommandName="Page" ImageUrl="~/img/icons8-last-50.png" />
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="Dispatch Type Name" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblDispatchTypeName" runat="server" Visible="true" Text='<%#Eval("dispatch_type_name") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Dispatch Type Code" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblDispatchTypeCode" runat="server" Visible="true" Text='<%#Eval("dispatch_type_code") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                           
                                                            <asp:TemplateField HeaderText="Dispatch Type Id" Visible="false" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblDispatchTypeId" runat="server" Visible="true" Text='<%#Eval("dispatch_type_id") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
