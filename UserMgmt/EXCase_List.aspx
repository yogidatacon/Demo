<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeBehind="EXCase_List.aspx.cs" Inherits="UserMgmt.EXCase_List" %>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="x_panel">
                            ...
                            <head>
                                ...
                                <title>Case Hearing List at Excise Commissioner Court for Vehicle / Property Under Prohibition Act</title>
                            ...
                            <body>
                              <%--  <asp:LinkButton runat="server" CssClass="myButton3 " ID="btnAddRecord" OnClick="AddRecord_Click" Style="float: right"><i class="fa fa-plus-circle"> ADD NEW RECORD</i></asp:LinkButton>--%>
                                <div class="x_title">
                                    <h2>Case Hearing List at Excise Commissioner Court for Vehicle / Property Under Prohibition Act </h2>
