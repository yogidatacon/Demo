...
namespace UserMgmt
{
    public partial class FinalArgumentForm : System.Web.UI.Page
    {
        #region Variables
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (firDetails.prfirno != null)
                {
                    ...
                    string datelock = BL_CM_Common.GetDate("exciseautomation.seizure_trial where seizureNo='" + seizureNo + "' and trialstage_code='7'", "currentstagedate");
                ...
                {                    
                    ...
                    txtFinalArgumentDate.Text = obj.currentstagedate;
                    ...
                    if ((Session["rtype"].ToString() == "1"))
                    {
                        ...
                        txtFinalArgumentDate.Attributes.Add("disabled", "disabled");
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            if (IsPostBack)
            {
                ...
                cm_obj.trialstage_code = 8;
                cm_obj.currentstage = 8;
                cm_obj.currentstagedate = txtFinalArgumentDate.Text;
                ...
                if (cmp >= 0)
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "script", "alert('Please ensure that the Next hearing Date is greater than or equal to the Final Argument Date.\');", true);
                    return;
