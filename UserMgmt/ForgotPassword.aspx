    ...
    <script type="text/javascript">
     ...
     <script type="text/javascript">
                                    function ShowHidePassword() {
                                        debugger;
                                        var txt = $('#<%=txtNewPassword.ClientID%>');
                                    ...
                                    function ShowHidePassword1() {
                                        debugger;
                                        var txt = $('#<%=txtConfirmPassword.ClientID%>');
                                        if (txt.prop("type") == "password") {
                                            txt.prop("type", "text");
                ...
                <div class="main-chatbox" style="display: none">
                  ...
                  <script  type="text/javascript">
                                    ...
                                    function compare() {
                                        ...
                                        var string1 = document.getElementById('<%=txtNewPassword.ClientID%>').value;
                                        var string2 = document.getElementById('<%=txtConfirmPassword.ClientID%>').value;
                    ...
                    <div class="">
                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <p>&nbsp;</p>
                                 <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                     &nbsp;<asp:LinkButton ID="btnCheckUser" runat="server" Visible="true" CssClass="btn btn-danger" OnClick="btnUserCheck_Click" >Check User
                                            <span aria-hidden="true" class="fa fa-spin"> </span></asp:LinkButton>
                                   <%-- &nbsp;<asp:LinkButton ID="btnGenerateOtp" runat="server" Visible="false" CssClass="btn btn-danger" OnClick="btnOtp_Click">Generate OTP
                                            <span aria-hidden="true" class="fa fa-spin"> </span></asp:LinkButton>--%>
                                ...
                                <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                    ...
                                    <%--<input type="password" id="txtNewPassword" runat="server" class="form-control" name="size" visible="false">--%>
                                     <asp:TextBox ID="txtNewPassword" onchange="CheckPassword(this.id)" TextMode="Password" class="form-control validate[required]" runat="server" data-toggle="tooltip" data-placement="right" title="Password should have minimum 8 characters in length. At least one character in upper case, lower case & Numeric and special characters!"  visible="false"></asp:TextBox>
                                    <%--<input id="cbshowhidepwd1" name="Show" type="checkbox" onclick="ShowHidePassword();" runat="server" visible="false"/><label id="LblShow" class="control-label" visible="false" runat="server"><span  id="SpanShow" style="color: red" visible="false" runat="server"></span>Show</label>--%>
                                ...
                                <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                   ...
                                   <%-- <input type="password" id="txtConfirmPassword" runat="server" class="form-control" name="size" visible="false">--%>
                                     <asp:TextBox ID="txtConfirmPassword" CssClass="form-control" TextMode="Password" MaxLength="20" data-toggle="tooltip" data-placement="right" title="Password should have minimum 8 characters in length. At least one character in upper case, lower case & Numeric and special characters!"   runat="server" onchange="return compare();" visible="false"></asp:TextBox>
                                   <%-- <input id="cbshowhidepwd2" type="checkbox" onclick="ShowHidePassword1();" visible="false" runat="server" /><label id="LblShow1" class="control-label" visible="false" runat="server"><span id="SpanShow1" style="color: red" visible="false" runat="server"></span>Show</label>
                                                <asp:HiddenField ID="txtpass" runat="server" />--%>
                                     <asp:RequiredFieldValidator id="RequiredFieldValidatorConpwd" runat="server"
                               ...
                               <div class="clearfix"></div>
                                <p>&nbsp;</p>
                                <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                    <label class="control-label" runat="server" id="LblEnterCaptcha" visible="false"><span style="color: red">*</span>Enter Captcha </label>
                                   <%-- <input type="text" id="txtCaptcha" runat="server" class="form-control" name="size" visible="false">--%>
                                    <asp:TextBox ID="txtCaptcha" runat="server" CssClass="form-control"  visible="false"></asp:TextBox>  
                                ...
                                <div>
                                 <cc1:CaptchaControl ID="Captcha1" runat="server" CaptchaBackgroundNoise="Low" CaptchaLength="5"
                                      ...
                                      FontColor="#D20B0C" NoiseColor="#B1B1B1" height="46px" Width="200px" visible="false" />
                                </div>                       
                                <div class="clearfix"></div>
                                <p>&nbsp;</p>
                                <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                    <asp:LinkButton ID="btnSubmit" runat="server"  Visible="false" class="btn btn-primary pull-left" OnClick="btnSubmit_Click">
