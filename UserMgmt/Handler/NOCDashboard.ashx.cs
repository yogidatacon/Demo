...
{
    /// <summary>
    /// Summary description for NOCDashboard
    /// </summary>
    public class NOCDashboard : IHttpHandler, IRequiresSessionState
    {
        ...
        private string ProcessChartData(DataTable dt)
        {
            ...
            chartConfig.Add("exportFileName", "NOC Approval Status");
        ...
        private void GetChartData(ref DataTable dt,string userid)
        {
            ...
            using (NpgsqlConnection con = new NpgsqlConnection(connstring))
            {
                ...
                using (NpgsqlCommand command = new NpgsqlCommand())
                    ...
                    {
                        using (NpgsqlDataAdapter da = new NpgsqlDataAdapter("SELECT * FROM exciseautomation.nocstatusdashboard ", cn))
                        {
                            // fill data table
                            da.Fill(dt);
                    ...
                    {
                        using (NpgsqlDataAdapter da = new NpgsqlDataAdapter("SELECT caseno,countno FROM exciseautomation.nocstatusdashboarduserid where user_id='"+userid+"'", cn))
                        {
                            // fill data table
                            da.Fill(dt);
