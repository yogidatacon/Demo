...
{
    /// <summary>
    /// Summary description for NOCDashboardSugarMill
    /// </summary>
    public class NOCDashboardSugarMill : IHttpHandler
    {
        ...
        private string ProcessChartData(DataTable dt)
        {
            ...
            chartConfig.Add("exportFileName", "NOC Approval Status For Export Of Molasses");
        ...
        private void GetChartData(ref DataTable dt)
        {
            ...
            using (NpgsqlConnection con = new NpgsqlConnection(connstring))
            {
                ...
                using (NpgsqlDataAdapter da = new NpgsqlDataAdapter("SELECT * FROM exciseautomation.nocstatusdashboardsugarmill", cn))
                {
                    // fill data table
                    da.Fill(dt);
