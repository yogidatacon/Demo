    ...
    public partial class WebForm3 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (firDetails.prfirno != null)
                {
                    ...
                    string datelock = BL_CM_Common.GetDate("exciseautomation.seizure_trial where seizureNo='" + seizureNo + "' and trialstage_code='8'", "currentstagedate");
                ...
                {                    
                    ...
                    txtJudgementDate.Text = obj.currentstagedate;
                    txtConvictionundersection.Text = obj.chargedundersection;
                    txtPunishment.Text = obj.punishment;
                    txtFine.Text = obj.fine;
                    txtRemarks.Text = obj.remarks;
                    ddlJudgementType.SelectedValue = obj.judgementType;
                    ddlAccusedName.SelectedValue = obj.accusedId;
                    //ddlAccusedName.SelectedValue = obj.seizure_accused_details_id;
                    ...
                    if ((Session["rtype"].ToString() == "1"))
                    {
                        ...
                        txtJudgementDate.Attributes.Add("disabled", "disabled");
                        txtConvictionundersection.Attributes.Add("disabled", "disabled");
                        txtPunishment.Attributes.Add("disabled", "disabled");
                        txtFine.Attributes.Add("disabled", "disabled");
                        txtRemarks.Attributes.Add("disabled", "disabled");
                        ddlAccusedName.Attributes.Add("disabled", "disabled");
                        ddlJudgementType.Attributes.Add("disabled", "disabled");
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            if (IsPostBack)
            {
                ...
                cm_obj.trialstage_code = 9;
                cm_obj.currentstage = 9;
                cm_obj.currentstagedate = txtJudgementDate.Text;
                cm_obj.chargedundersection = txtConvictionundersection.Text;
                cm_obj.punishment = txtPunishment.Text;
                cm_obj.fine = txtFine.Text;
                ...
                cm_obj.accusedId = ddlAccusedName.SelectedValue;
                cm_obj.judgementType = ddlJudgementType.SelectedValue;
