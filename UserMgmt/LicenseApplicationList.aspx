<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="LicenseApplicationList.aspx.cs" Inherits="UserMgmt.LicenseApplicationList" %>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="x_panel">
                            ...
                            <head>
                                ...
                                <title>License Application List</title>
                            </head>
                            <body>
                              ...
                              <%--  <li>
                                ...
                                <div class="x_panel">
                                 <div class="x_title">
                                    ...
                                    <h2>License Application List</h2>
                                ...
                                <div class="x_content">
                                    ...
                                    <asp:GridView ID="grdLicenseList" runat="server"  AutoGenerateColumns="false"   AllowPaging="true" PageSize="10"  OnPageIndexChanging="grdProductList_PageIndexChanging" EmptyDataText="No Records" OnDataBound="grdLicenseList_DataBound"
                ...
                <asp:ImageButton ID="btnNext" Visible="false"
                    runat="server" CommandArgument="Next" Width="30px" Height="20px" CommandName="Page" ForeColor="Blue" BackColor="Blue" ImageUrl="~/img/icons8-next-50.png"  /> <asp:ImageButton
                        ID="btnLast" runat="server" CommandArgument="Last" Width="30px" Visible="false" Height="20px" BackColor="Blue" CommandName="Page" ImageUrl="~/img/icons8-last-50.png" />
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="License Fee Code" ItemStyle-Font-Bold="true" ItemStyle-Width="20px" >
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblCode" runat="server" Text='<%#Eval("lic_fee_code") %>' ></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                             <asp:TemplateField HeaderText="License Application Name" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblLicenseApplicationName" runat="server" Visible="true" Text='<%#Eval("applicant_name") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="License Type" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblName" runat="server" Visible="true" Text='<%#Eval("lic_type_code") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                              <asp:TemplateField HeaderText="License ID" ItemStyle-Font-Bold="true" Visible="false" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblapplicationid" runat="server" Visible="true" Text='<%#Eval("lic_application_id") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                             <asp:TemplateField HeaderText="End Date" ItemStyle-Font-Bold="true" Visible="false" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblenddate" runat="server" Visible="true" Text='<%#Eval("end_date") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                              ...
                                              <asp:TemplateField HeaderText="Party_code" Visible="false" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblstatus" runat="server" Text='<%# Eval("record_status").ToString() == "A" ? "Recommended by Superintendent/Asst. Commissioner" :Eval("record_status").ToString()=="R"? "Rejected":Eval("record_status").ToString()=="D"? "Recommended By Deputy Commissioner":Eval("record_status").ToString()=="C"? "Approved By Commissioner":Eval("record_status").ToString()=="I"? "Issued":Eval("record_status").ToString()=="E"? "Expired":Eval("record_status").ToString()=="B"? "Refer Back By Commissioner":(Eval("record_status").ToString()=="Y"? "Pending":"Draft") %>'></asp:Label>
                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Action" ItemStyle-Font-Bold="true" HeaderStyle-HorizontalAlign="Center" >
                                                                <ItemTemplate>
                                                                   ...
                                                                   <asp:LinkButton Text="Edit" id="btnEdit"  CssClass="myButton1"   runat="server" OnClick="btnEdit_Click"  Visible='<%# Eval("record_status").ToString() == "N" ? true:Eval("record_status").ToString() == "R" ? true:false %>'  CommandName="Edit" ><i class="fa fa-pencil-square-o"> 
                                                                                    </i> 
                                                                            </asp:LinkButton>
                                                                    <asp:LinkButton Text="Renewal" id="btnrenewal" CssClass="myButton7"  runat="server" OnClick="btnrenewal_Click" Visible="false"  CommandName="Renewal" ><i class="fa">R
                                                                                    </i>
                                                                            </asp:LinkButton>
                                                                </ItemTemplate>
