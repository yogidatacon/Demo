...
namespace UserMgmt
{
    public partial class LicenseFeeList : System.Web.UI.Page
    {
        List<LicenseFee> list = new List<LicenseFee>();
        protected void Page_Load(object sender, EventArgs e)
        {
            if(!IsPostBack)
            {
                ...
                list = new List<LicenseFee>();
                list = BL_LicenseFee.GetList(Session["UserID"].ToString());
        ...
        protected void AddRecord_Click(object sender, EventArgs e)
        {
            Session["UserID"] = Session["UserID"];
            Session["rtype"] = "0";
            Response.Redirect("LicenseFeeMaster");
        }
        ...
        protected void btnView_Click(object sender, EventArgs e)
        {
            ...
            string license = (gvr.Cells[gvr.Cells.Count - 1].FindControl("lblLicensefeeid") as Label).Text;
        ...
        protected void grdProductList_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            if (Session["lfsearch"] != null && Session["lftext"] != null)
            {
                ddsearch.SelectedValue = Session["lfsearch"].ToString();
                txtpage.Text = Session["lftext"].ToString();
                if (ddsearch.SelectedValue != "Select")
                {
                    ...
                    if (txtpage != null)
                    {
                        ...
                        list = new List<LicenseFee>();
                        list = BL_LicenseFee.SearchLicense("lic_type_Master", ddsearch.SelectedValue, txtpage.Text);
                        grdLicenseList.DataSource = list;
                        grdLicenseList.DataBind();
                    }
                }
        ...
        protected void btnsearch_Click(object sender, EventArgs e)
        {
            ...
            if (ddsearch.SelectedValue != "Select")
            {
                ...
                Session["lfsearch"] = ddsearch.SelectedValue;
                if (txtpage != null)
                {
                    Session["lftext"] = txtpage.Text;
                    string qery = txtSearch.Text.ToString();
                qery = Regex.Replace(qery, @"(^\w)|(\s\w)", m => m.Value.ToUpper());
        ...
        protected void grdLicenseList_DataBound(object sender, EventArgs e)
        {
            ...
            {
                ddsearch.SelectedValue = Session["lfsearch"].ToString();
                txtpages.Text = Session["lftext"].ToString();
            }
