...
namespace UserMgmt
{
    public partial class LicenseSubTypeList : System.Web.UI.Page
    {
        List<LicenseSubType> list = new List<LicenseSubType>();
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                list = new List<LicenseSubType>();
                list = BL_LicenseSubType.GetList(Session["UserID"].ToString());
        ...
        protected void AddRecord_Click(object sender, EventArgs e)
        {
            Session["UserID"] = Session["UserID"];
            Session["rtype"] = "0";
            Response.Redirect("LicenseSubTypeForm");
        }
        ...
        protected void btnView_Click(object sender, EventArgs e)
        {
            ...
            string license = (gvr.Cells[gvr.Cells.Count - 1].FindControl("lblLicenseTypeCode") as Label).Text;
            Session["licensetype"] = license;
        ...
        protected void grdProductList_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            if (Session["lssearch"] != null && Session["lstext"] != null)
            {
                ddsearch.SelectedValue = Session["lssearch"].ToString();
                txtpage.Text = Session["lstext"].ToString();
                if (ddsearch.SelectedValue != "Select")
                {
                    ...
                    if (txtpage != null)
                    {
                        ...
                        list = new List<LicenseSubType>();
                        list = BL_LicenseSubType.SearchLicense("lic_type_Master", ddsearch.SelectedValue, txtpage.Text);
                        grdLicenseList.DataSource = list;
                        grdLicenseList.DataBind();
                    }
                }
        ...
        protected void btnsearch_Click(object sender, EventArgs e)
        {
            ...
            if (ddsearch.SelectedValue != "Select")
            {
                ...
                Session["lssearch"] = ddsearch.SelectedValue;
                if (txtpage != null)
                {
                    Session["lstext"] = txtpage.Text;
                    string qery = txtSearch.Text.ToString();
                qery = Regex.Replace(qery, @"(^\w)|(\s\w)", m => m.Value.ToUpper());
        ...
        protected void grdLicenseList_DataBound(object sender, EventArgs e)
        {
            ...
            {
                ddsearch.SelectedValue = Session["lssearch"].ToString();
                txtpages.Text = Session["lstext"].ToString();
            }
