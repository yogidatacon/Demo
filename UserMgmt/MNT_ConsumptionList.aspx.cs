...
namespace UserMgmt
{
    public partial class MNT_ConsumptionList : System.Web.UI.Page
    {
        string user_role = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
             ...
             //   Session["Username"] = user.user_name.ToString();
                ...
                ic = BL_Molasses_Allocation.GetMNTCONList();
        ...
        protected void btnAddRecord_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("MNT_Consumption.aspx");
        }
        ...
        protected void btnView_Click(object sender, EventArgs e)
        {
            ...
            Session["CONfinancial_year"] = financial_year;
            Session["UserID"] = Session["UserID"].ToString();
            Session["mirid"] = mirid;
            Session["rtype"] = 1;
            Response.Redirect("MNT_Consumption.aspx");
