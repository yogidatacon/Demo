...
namespace UserMgmt
{
    public partial class MobileappReport : System.Web.UI.Page
    {
                ...
                if (Request.UrlReferrer != null)
                {
                    ...
                    if (user.user_id == "Admin" || user.role_name.Trim() == "Commissioner" || user.role_name.Trim() == "Deputy Commissioner" || user.role_name.Trim() == "Assistant Commissioner")
                    {
                        var list = (from s in reports
                                    where s.partytype == "Excise" && (/*s.id == 85 || s.id == 86 ||*/ s.id == 87 || s.id == 88 || s.id == 94||s.id==95)
                                    select s);
        ...
        protected void ddlReportName_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (ddlReportName.SelectedValue == "87"  || ddlReportName.SelectedValue == "95")
            {
                DEPT.Visible = false;
                Court.Visible = false;
                DST.Visible = true;
            }
            if ( ddlReportName.SelectedValue == "88" || ddlReportName.SelectedValue == "94")
            {
                DEPT.Visible = false;
                Court.Visible = false;
                DST.Visible = false;
