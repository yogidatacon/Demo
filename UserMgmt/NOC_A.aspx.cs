...
namespace UserMgmt
{
    public partial class NOC_A : System.Web.UI.Page
    {
                ...
                if (Request.UrlReferrer != null && System.Web.HttpContext.Current.Session["UserID"] != null)
                {
                  ...
                  //  Session["UserID"] = Session["UserID"];
                    ...
                    if (user != null)
                    {
                        ...
                        if (Session["product1"] != null)
                        {
                            ddproduct.SelectedValue = Session["product1"].ToString();
                        ...
                        else
                        {
                            ...
                            else if (user.party_type == "All" || user.party_type == "ALL")
                            {
                                ...
                                //if (value == 1)
                                //{
                                //    workflow = BL_WorkFlow.Checkworkflow("ENP", "113", user.role_name_code.ToString(), "", user.id.ToString());
                                //}
                                //else
                                //{
                                ...
                                if (workflow.Count > 0)
                                {
                                    ...
                                    if (workflow[0].approver_level == "1")
                                    {
                                        var product = (from s in noc
                                                       where s.noc_status.Trim() != "" && s.noc_status.Trim() != "Refer Back to Assistant Commissioner" && s.record_status != "R" && s.district == user.district_code
                                                       orderby s.noc_id descending
                                                       select s);
                                    ...
                                    {
                                        var product = (from s in noc
                                                       where s.record_status.Trim() == "A" || s.record_status.Trim() == "I"
                                                       orderby s.noc_id descending
                                                       select s);
        ...
        protected void Issued_Click(object sender, EventArgs e)
        {
            if (IsPostBack)
            {
                ...
                string NOC_ID = (grdNOCApplicationList.Rows[rowindex].FindControl("lblApplicationNo") as Label).Text;
                string party_code = (grdNOCApplicationList.Rows[rowindex].FindControl("lblparty_code") as Label).Text;
                string financialyear = (grdNOCApplicationList.Rows[rowindex].FindControl("lblfinancialyear") as Label).Text;
                Session["UserID"] = Session["UserID"].ToString();
                Session["nocparty_code"] = party_code;
                ...
                noc.financial_year =financialyear;
                noc.noc_id = NOC_ID;
        ...
        protected void grdNOCApplicationList_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            if (System.Web.HttpContext.Current.Session["UserID"] != null)
            {
                ...
                if (Session["nocasearch"] != null && Session["nocatext"] != null)
                {
                    ddsearch.SelectedValue = Session["nocasearch"].ToString();
                    txtpage.Text = Session["nocatext"].ToString();
                        ...
                        else if (user.party_type == "All" || user.party_type == "ALL")
                        {
                            ...
                            if (workflow.Count > 0)
                            {
                                ...
                                if (workflow[0].approver_level == "1")
                                {
                                    ...
                                    {
                                        var product = (from s in noc
                                                       where s.noc_status.Trim() != "" && s.noc_status.Trim() != "Refer Back to Assistant Commissioner" && s.record_status != "R" && s.district == user.district_code && s.noc_for == ddproduct.SelectedValue && s.valid_upto==txtpage.Text
                                                       orderby s.noc_id descending
                                                       select s);
                                    ...
                                    {
                                        var product = (from s in noc
                                                       where s.noc_status.Trim() != "" && s.noc_status.Trim() != "Refer Back to Assistant Commissioner" && s.record_status != "R" && s.district == user.district_code && s.noc_for == ddproduct.SelectedValue
                                                       orderby s.noc_id descending
                                                       select s);
                                ...
                                if (workflow[0].approver_level == "2")
                                {
                                    ...
                                    {
                                        var product = (from s in noc
                                                       where s.record_status.Trim() == "A" && s.noc_for == ddproduct.SelectedValue && s.valid_upto == txtpage.Text
                                                       orderby s.noc_id descending
                                                       select s);
                                    ...
                                    {
                                        var product = (from s in noc
                                                       where s.record_status.Trim() == "A" && s.noc_for == ddproduct.SelectedValue
                                                       orderby s.noc_id descending
                                                       select s);
                                ...
                                if (workflow[0].approver_level == "3")
                                {
                                    ...
                                    {
                                        var product = (from s in noc
                                                       where s.record_status.Trim() == "A" || s.record_status.Trim() == "I" && s.noc_for == ddproduct.SelectedValue && s.valid_upto == txtpage.Text
                                                       orderby s.noc_id descending
                                                       select s);
                                    ...
                                    {
                                        var product = (from s in noc
                                                       where s.record_status.Trim() == "A" || s.record_status.Trim() == "I" && s.noc_for == ddproduct.SelectedValue
                                                       orderby s.noc_id descending
                                                       select s);
                            ...
                            if (workflow.Count > 0)
                            {
                                if (workflow[0].approver_level == "1")
                                {
                                    if (ddsearch.SelectedValue == "valid_upto")
                                    {
                                        ...
                                        var product = (from s in noc
                                                       where s.noc_status.Trim() != "" && s.noc_status.Trim() != "Refer Back to Assistant Commissioner" && s.record_status != "R" && s.district == user.district_code && s.valid_upto == txtpage.Text
                                                       orderby s.noc_id descending
                                                       select s);
                                ...
                                if (workflow[0].approver_level == "2")
                                {
                                    if (ddsearch.SelectedValue == "valid_upto")
                                    {
                                        ...
                                        var product = (from s in noc
                                                       where s.record_status.Trim() == "A" && s.valid_upto == txtpage.Text
                                                       orderby s.noc_id descending
                                                       select s);
                                ...
                                if (workflow[0].approver_level == "3")
                                {
                                    if (ddsearch.SelectedValue == "valid_upto")
                                    {
                                        ...
                                        var product = (from s in noc
                                                       where s.record_status.Trim() == "A" || s.record_status.Trim() == "I" && s.valid_upto == txtpage.Text
                                                       orderby s.noc_id descending
                                                       select s);
        ...
        protected void grdNOCApplicationList_DataBound(object sender, EventArgs e)
        {
            ...
            {
                ddsearch.SelectedValue = Session["nocasearch"].ToString();
                txtpages.Text = Session["nocatext"].ToString();
            }
        ...
        protected void ddproduct_TextChanged(object sender, EventArgs e)
        {
                ...
                if (ddproduct.SelectedValue != "Select")
                {
                    Session["product1"] = ddproduct.SelectedValue;
                    if (user != null)
                    {
        ...
        protected void btnsearch_Click(object sender, EventArgs e)
        {
            ...
            if (ddsearch.SelectedValue != "Select")
            {
                Session["nocasearch"] = ddsearch.SelectedValue;
                if (txtpage != null)
                {
                    Session["nocatext"] = txtpage.Text;
                    UserDetails user = new UserDetails();
                    user = BL_UserDetails.CheckUser(Session["UserID"].ToString());
                    if (user != null)
                    {
        ...
        {
            Session["nocasearch"] = null;
            Session["nocatext"] = null;
            UserDetails user = new UserDetails();
            user = BL_UserDetails.CheckUser(Session["UserID"].ToString());
            if (Session["product1"] != null)
            {
