...
namespace UserMgmt
{
    public partial class NOC_B : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.UrlReferrer != null && System.Web.HttpContext.Current.Session["UserID"] != null)
                {
                    ...
                    if (user != null)
                    {
                        ...
                        if (Session["product2"] != null)
                        {
                            ddproduct.SelectedValue = Session["product2"].ToString();
                                ...
                                if (workflow.Count > 0)
                                {
                                    ...
                                    if (workflow[0].approver_level == "1")
                                    {
                                        var product = (from s in noc
                                                       where s.noc_status.Trim() == "Refer Back to Assistant Commissioner" && s.district == user.district_code
                                                       orderby s.noc_id descending
                                                       select s);
                                    ...
                                    {
                                        var product = (from s in noc
                                                       where s.noc_status.Trim() == "Refer Back to Assistant Commissioner" || s.noc_status.Trim() == "Refer Back to Deputy Commissioner"
                                                       orderby s.noc_id descending
                                                       select s);
                                    ...
                                    {
                                        var product = (from s in noc
                                                       where s.noc_status.Trim() == "Refer Back to Deputy Commissioner"
                                                       orderby s.noc_id descending
                                                       select s);
        ...
        protected void grdNOCApplicationList_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            if (System.Web.HttpContext.Current.Session["UserID"] != null)
            {
                ...
                if (Session["nocbsearch"] != null && Session["nocbtext"] != null)
                {
                    ddsearch.SelectedValue = Session["nocbsearch"].ToString();
                    txtpage.Text = Session["nocbtext"].ToString();
                        ...
                        else if (user.party_type == "All" || user.party_type == "ALL")
                        {
                            ...
                            if (workflow.Count > 0)
                            {
                                ...
                                if (workflow[0].approver_level == "1")
                                {
                                    ...
                                    {
                                        var product = (from s in noc
                                                       where s.noc_status.Trim() == "Refer Back to Assistant Commissioner" && s.district == user.district_code && s.noc_for == ddproduct.SelectedValue && s.valid_upto == txtpage.Text
                                                       orderby s.noc_id descending
                                                       select s);
                                    ...
                                    {
                                        var product = (from s in noc
                                                       where s.noc_status.Trim() == "Refer Back to Assistant Commissioner" && s.district == user.district_code && s.noc_for == ddproduct.SelectedValue
                                                       orderby s.noc_id descending
                                                       select s);
                                ...
                                if (workflow[0].approver_level == "2")
                                {
                                    ...
                                    {
                                        var product = (from s in noc
                                                       where s.noc_for == ddproduct.SelectedValue && (s.noc_status.Trim() == "Refer Back to Assistant Commissioner" || s.noc_status.Trim() == "Refer Back to Deputy Commissioner") && s.valid_upto == txtpage.Text
                                                       orderby s.noc_id descending
                                                       select s);
                                    ...
                                    {
                                        var product = (from s in noc
                                                       where s.noc_for == ddproduct.SelectedValue && (s.noc_status.Trim() == "Refer Back to Assistant Commissioner" || s.noc_status.Trim() == "Refer Back to Deputy Commissioner")
                                                       orderby s.noc_id descending
                                                       select s);
                                ...
                                if (workflow[0].approver_level == "3")
                                {
                                    ...
                                    {
                                        var product = (from s in noc
                                                       where s.noc_status.Trim() == "Refer Back to Deputy Commissioner" && s.noc_for == ddproduct.SelectedValue && s.valid_upto == txtpage.Text
                                                       orderby s.noc_id descending
                                                       select s);
                                    ...
                                    {
                                        var product = (from s in noc
                                                       where s.noc_status.Trim() == "Refer Back to Deputy Commissioner" && s.noc_for == ddproduct.SelectedValue
                                                       orderby s.noc_id descending
                                                       select s);
                    ...
                    if (user != null)
                    {
                        ...
                        else if (user.party_type == "All" || user.party_type == "ALL")
                        {
                            ...
                            if (workflow[0].approver_level == "1")
                            {
                                ...
                                {
                                    var product = (from s in noc
                                                   where s.noc_status.Trim() == "Refer Back to Assistant Commissioner" && s.district == user.district_code && s.valid_upto == txtpage.Text
                                                   orderby s.noc_id descending
                                                   select s);
                            ...
                            if (workflow[0].approver_level == "2")
                            {
                                ...
                                {
                                    var product = (from s in noc
                                                   where s.noc_status.Trim() == "Refer Back to Assistant Commissioner" || s.noc_status.Trim() == "Refer Back to Deputy Commissioner" && s.valid_upto == txtpage.Text
                                                   orderby s.noc_id descending
                                                   select s);
                            ...
                            if (workflow[0].approver_level == "3")
                            {
                                ...
                                {
                                    var product = (from s in noc
                                                   where s.noc_status.Trim() == "Refer Back to Deputy Commissioner" && s.valid_upto == txtpage.Text
                                                   orderby s.noc_id descending
                                                   select s);
        ...
        protected void grdNOCApplicationList_DataBound(object sender, EventArgs e)
        {
            ...
            {
                ddsearch.SelectedValue = Session["nocbsearch"].ToString();
                txtpages.Text = Session["nocbtext"].ToString();
            }
        ...
        protected void ddproduct_TextChanged(object sender, EventArgs e)
        {
            ...
            if (ddproduct.SelectedValue != "Select")
            {
                Session["product2"] = ddproduct.SelectedValue;
        ...
        protected void btnsearch_Click(object sender, EventArgs e)
        {
            ...
            if (ddsearch.SelectedValue != "Select")
            {
                Session["nocpsearch"] = ddsearch.SelectedValue;
                if (txtpage != null)
                {
                    Session["nocptext"] = txtpage.Text;
                    UserDetails user = new UserDetails();
                    user = BL_UserDetails.CheckUser(Session["UserID"].ToString());
                    if (user != null)
                    {
        ...
        {
            Session["nocbsearch"] = null;
            Session["nocbtext"] = null;
            UserDetails user = new UserDetails();
            user = BL_UserDetails.CheckUser(Session["UserID"].ToString());
            if (Session["product2"] != null)
            {
