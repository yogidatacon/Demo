...
namespace UserMgmt
{
    public partial class NOC_P : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.UrlReferrer != null && System.Web.HttpContext.Current.Session["UserID"] != null)
                {
                    ...
                    if (user != null)
                    {
                        ...
                        if (Session["product4"] != null)
                        {
                            ddproduct.SelectedValue = Session["product4"].ToString();
                                ...
                                if (workflow.Count > 0)
                                {
                                    ...
                                    if (workflow[0].approver_level == "1")
                                    {
                                        var product = (from s in noc
                                                       where s.record_status == "Y" && s.noc_status == "" && s.district == user.district_code
                                                       orderby s.noc_id descending
                                                       select s);
                                    ...
                                    {
                                        var product = (from s in noc
                                                       where s.noc_status.Trim() == "Recommended by Assistant Commissioner"
                                                       orderby s.noc_id descending
                                                       select s);
                                    ...
                                    {
                                        var product = (from s in noc
                                                       where s.noc_status.Trim() == "Recommended by Deputy Commissioner"
                                                       orderby s.noc_id descending
                                                       select s);
            ...
            if (System.Web.HttpContext.Current.Session["UserID"] != null)
            {
                ...
                if (ddproduct.SelectedValue != "Select")
                {
                    if (user != null)
                    {
                        ...
                        if (Session["nocpsearch"] != null && Session["nocptext"] != null)
                        {
                            ddsearch.SelectedValue = Session["nocpsearch"].ToString();
                            txtpage.Text = Session["nocptext"].ToString();
                        ...
                        if (user.party_type == "All" || user.party_type == "ALL")
                        {
                            ...
                            if (workflow.Count > 0)
                            {
                                ...
                                if (workflow[0].approver_level == "1")
                                {
                                    ...
                                    {
                                        var noc1 = (from s in noc
                                                    where s.record_status == "Y" && s.noc_status == "" && s.district == user.district_code && s.noc_for == ddproduct.SelectedValue && s.valid_upto == txtpage.Text
                                    ...
                                    {
                                        var product = (from s in noc
                                                       where s.record_status == "Y" && s.noc_status == "" && s.district == user.district_code && s.noc_for == ddproduct.SelectedValue
                                                       orderby s.noc_id descending
                                                       select s);
                                ...
                                if (workflow[0].approver_level == "2")
                                {
                                    ...
                                    {
                                        var noc1 = (from s in noc
                                                    where s.noc_status.Trim() == "Recommended by Assistant Commissioner" && s.noc_for == ddproduct.SelectedValue && s.valid_upto == txtpage.Text
                                                    orderby s.slno descending
                                                    select s);
                                        grdNOCApplicationList.DataSource = noc1.ToList();
                                        grdNOCApplicationList.DataBind();
                                    ...
                                    {
                                        var product = (from s in noc
                                                       where s.noc_status.Trim() == "Recommended by Assistant Commissioner" && s.noc_for == ddproduct.SelectedValue
                                                       orderby s.noc_id descending
                                                       select s);
                                ...
                                if (workflow[0].approver_level == "3")
                                {
                                    ...
                                    {
                                        var noc1 = (from s in noc
                                                    where s.noc_status.Trim() == "Recommended by Deputy Commissioner" && s.noc_for == ddproduct.SelectedValue && s.valid_upto == txtpage.Text
                                                    orderby s.slno descending
                                                    select s);
                                        grdNOCApplicationList.DataSource = noc1.ToList();
                                        grdNOCApplicationList.DataBind();
                                    ...
                                    {
                                        var product = (from s in noc
                                                       where s.noc_status.Trim() == "Recommended by Deputy Commissioner" && s.noc_for == ddproduct.SelectedValue
                                                       orderby s.noc_id descending
                                                       select s);
                        ...
                        if (user.party_type == "All" || user.party_type == "ALL")
                        {
                            ...
                            if (workflow.Count > 0)
                            {
                                ...
                                if (workflow[0].approver_level == "1")
                                {
                                    ...
                                    {
                                        var noc1 = (from s in noc
                                                    where s.record_status == "Y" && s.noc_status == "" && s.district == user.district_code && s.valid_upto == txtpage.Text
                                                    orderby s.slno descending
                                                    select s);
                                        grdNOCApplicationList.DataSource = noc1.ToList();
                                        grdNOCApplicationList.DataBind();
                                ...
                                if (workflow[0].approver_level == "2")
                                {
                                    ...
                                    {
                                        var noc1 = (from s in noc
                                                    where s.noc_status.Trim() == "Recommended by Assistant Commissioner" && s.valid_upto == txtpage.Text
                                                    orderby s.slno descending
                                                    select s);
                                        grdNOCApplicationList.DataSource = noc1.ToList();
                                        grdNOCApplicationList.DataBind();
                                ...
                                if (workflow[0].approver_level == "3")
                                {
                                    ...
                                    {
                                        var noc1 = (from s in noc
                                                    where s.noc_status.Trim() == "Recommended by Deputy Commissioner" && s.valid_upto == txtpage.Text
                                                    orderby s.slno descending
                                                    select s);
                                        grdNOCApplicationList.DataSource = noc1.ToList();
                                        grdNOCApplicationList.DataBind();
        ...
        protected void ddproduct_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                Session["product4"] = ddproduct.SelectedValue;
                if (user != null)
                {
        ...
        {
            Session["nocpsearch"] = null;
            Session["nocptext"] = null;
            UserDetails user = new UserDetails();
            user = BL_UserDetails.CheckUser(Session["UserID"].ToString());
            if (Session["product4"] != null)
            {
