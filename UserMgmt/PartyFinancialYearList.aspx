<%@ Page Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="PartyFinancialYearList.aspx.cs" Inherits="UserMgmt.PartyFinancialYearList" %>
                            ...
                            <head>
                                ...
                                <title>User Management</title>
                                    ...
                                    function chkDuplicateAccessTypeName() {
                                        debugger;
                                        var email = $('#BodyContent_partyFinancialList_txtSearch2').val();
                                        var jsondata = JSON.stringify($('#BodyContent_partyFinancialList_txtSearch2').val());
                                        $.ajax({
                                            type: "POST",
                                            //url: "UserRegistrationForm.aspx/chkDuplicateEmail",
                                            url: "PartyFinancialYearList.aspx/chkDuplicateAccessTypeName",
                                            data: '{name:' + jsondata + '}',
                                    ...
                                    $(document).ready(function () {
                                        $('#BodyContent_partyFinancialList_ddlsearch1').change(function () {
                                            $('#BodyContent_partyFinancialList_txtSearch2').val('');
                                        });
                                    });
                                    </script>
                                ...
                                <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="x_panel">
                                                <div class="x_title">
                                                    <h2>Party Type Financial Year List</h2>
                                                    <div class="clearfix"></div>
                                                </div>
                                                <div class="x_content">

                                                    <asp:GridView ID="partyFinancialList" runat="server" AutoGenerateColumns="false" AllowPaging="true" OnPageIndexChanging="partyFinancialList_PageIndexChanging" PageSize="10"
                                                        HeaderStyle-BackColor="#26b8b8" OnDataBound="partyFinancialList_DataBound" HeaderStyle-ForeColor="#ECF0F1" class="table table-striped responsive-utilities jambo_table" HeaderStyle-HorizontalAlign="Center">
                    ...
                    runat="server" CommandArgument="Next" Width="30px" Height="20px" CommandName="Page" ForeColor="Blue" BackColor="Blue" ImageUrl="~/img/icons8-next-50.png"  /> <asp:ImageButton
                        ID="btnLast" runat="server" CommandArgument="Last" Width="30px" Visible="false" Height="20px" BackColor="Blue" CommandName="Page" ImageUrl="~/img/icons8-last-50.png" />
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Party Type Name" HeaderStyle-HorizontalAlign="Center" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblpartytypename" runat="server" Visible="true" Text='<%#Eval("party_type_name") %>'></asp:Label>

                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Party Type code" Visible="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblpartytypecode" runat="server" Visible="true" Text='<%#Eval("party_type_code") %>'></asp:Label>

                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Status" HeaderStyle-HorizontalAlign="Center" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblStatus" runat="server" Visible="true" Text='<%#Eval("status").ToString()=="N"? "InActive":"Active" %>'></asp:Label>
                                                            ...
                                                            <asp:TemplateField HeaderText="Action" ItemStyle-Font-Bold="true" HeaderStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton Text="View" ID="btnView" CssClass="myButton" runat="server" CommandArgument='<%# Bind("id") %>' CommandName="View" OnClick="btnView_Click"><i class="fa fa-search-plus">
                                                                                    </i> 
                                                                    </asp:LinkButton>
                                                                     <asp:LinkButton Text="Edit" id="btnEdit"  CssClass="myButton1" Visible='<%#Eval("status").ToString()=="N" ? false : true %>'   runat="server" CommandArgument='<%# Bind("id") %>'   CommandName="Edit" OnClick="btnEdit_Click" ><i class="fa fa-pencil-square-o"> 
                                                                                    </i> 
                                                                            </asp:LinkButton>
                                                                </ItemTemplate>
