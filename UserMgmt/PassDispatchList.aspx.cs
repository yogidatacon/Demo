...
namespace UserMgmt
{
    public partial class PassDispatchList : System.Web.UI.Page
    {
        ...
        protected void btnView_Click(object sender, EventArgs e)
        {
            ...
            Session["PDfinancial_year"] = financial_year;
        ...
        protected void grdPassApplicationList_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            if (System.Web.HttpContext.Current.Session["UserID"] != null && ddPassFor.SelectedValue != "Select")
            {
                ...
                UserDetails user = new UserDetails();
                user = BL_UserDetails.CheckUser(Session["UserID"].ToString());
                if (Session["enapasssearch"] != null && Session["enapasstext"] != null)
                {
                    ddsearch.SelectedValue = Session["enapasssearch"].ToString();
                    txtpage.Text = Session["enapasstext"].ToString();
                        ...
                        if (txtpage != null)
                        {
                            if (ddsearch.SelectedValue == "dispatch_date")
                            {
                                if (txtpage.Text.ToString().Length == 10)
                                {
                                    ...
                                    pass = BL_PassDispatch.GetPassList();
                                }
                                else
                                {
                            ...
                            {
                                pass = BL_PassDispatch.Search(ddPassFor.SelectedValue, ddsearch.SelectedValue, txtpage.Text);
                            }
                        }
                    }
                }
                ...
                if (Session["rolename"].ToString() == "Applicant" && Session["usertype"].ToString() == "Sugar Mill")
                {
                    ...
                    if (ddPassFor.SelectedValue == "DOM")
                    {
                        if (grdPassApplicationList.Rows.Count > 0)
                        {
                            grdPassApplicationList.HeaderRow.Cells[4].Text = "Permit No";
                        }
                    }
                ...
                else if (Session["rolename"].ToString() == "Bond Officer" && Session["usertype"].ToString() == "Distillery Unit" || Session["usertype"].ToString() == "ENA Distillery Unit")
                {
                    if (ddsearch.SelectedValue == "dispatch_date")
                    {
                        var list = (from s in pass
                                    where s.party_code == Session["party_code"].ToString() && (s.record_status == "Y" || s.record_status == "I" || s.record_status == "R") && s.pass_type == ddPassFor.SelectedValue && s.dispatch_date == txtpage.Text && s.financial_year == user.financial_year
                                    orderby s.pass_reqno descending
                                    select s);
                        grdPassApplicationList.DataSource = list.ToList();
                        grdPassApplicationList.DataBind();
                    ...
                    {
                        var list = (from s in pass
                                    where s.party_code == Session["party_code"].ToString() && (s.record_status == "Y" || s.record_status == "I" || s.record_status == "R") && s.pass_type == ddPassFor.SelectedValue && s.financial_year == user.financial_year
                                    orderby s.pass_reqno descending
                                    select s);
                        grdPassApplicationList.DataSource = list.ToList();
                        grdPassApplicationList.DataBind();
        ...
        protected void LinkButton1_Click(object sender, EventArgs e)
        {
            ...
            Session["ReportId"] = "ENA Dispatch Report";
           // Session["cid"] = cid;
            ...
            if (System.Web.HttpContext.Current.Session["UserID"] != null && ddPassFor.SelectedValue != "Select")
            {
                ...
                if (Session["rolename"].ToString() == "Applicant" && Session["usertype"].ToString() == "Sugar Mill")
                {
                    ...
                    if (ddPassFor.SelectedValue == "DOM")
                    {
                        if (grdPassApplicationList.Rows.Count > 0)
                        {
                            grdPassApplicationList.HeaderRow.Cells[4].Text = "Issued Permit No";
                        }
                    }
                    foreach (GridViewRow dr1 in grdPassApplicationList.Rows)
                    {
                ...
                else if (Session["rolename"].ToString() == "Bond Officer" &&  Session["usertype"].ToString() == "ENA Distillery Unit")
                {
                    var list = (from s in pass
                                where s.party_code == Session["party_code"].ToString() && (s.record_status == "Y" || s.record_status == "I" || s.record_status == "R") && s.pass_type == ddPassFor.SelectedValue && s.financial_year == user.financial_year
                                orderby s.pass_reqno descending
        ...
        protected void grdPassApplicationList_DataBound(object sender, EventArgs e)
        {
            ...
            {
                ddsearch.SelectedValue = Session["enapasssearch"].ToString();
                txtpages.Text = Session["enapasstext"].ToString();
            }
        ...
        protected void btnsearch_Click(object sender, EventArgs e)
        {
            ...
            if (ddsearch.SelectedValue != "Select")
            {
                Session["enapasssearch"] = ddsearch.SelectedValue;
                if (txtpage != null)
                {
                    Session["enapasstext"] = txtpage.Text;
                    UserDetails user = new UserDetails();
                    user = BL_UserDetails.CheckUser(Session["UserID"].ToString());
                    if (user != null)
                    {
        ...
        {
            Session["enapasssearch"] = null;
            Session["enapasstext"] = null;
