...
namespace UserMgmt
{
    public partial class PolicePaperSupplyForm : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (firDetails.prfirno != null)
                {
                    ...
                    string datelock = BL_CM_Common.GetDate("exciseautomation.seizure_trial where seizureNo='" + seizureNo + "' and trialstage_code='2'", "currentstagedate");
                    CalendarExtender1.StartDate = Convert.ToDateTime(datelock);
                    CalendarExtender2.StartDate = Convert.ToDateTime(datelock);
                }
                ...
                if (Session["rtype"].ToString() != "0")
                {
                    ...
                    txtDateOfPolicepapersupply.Text = obj.currentstagedate;
                    ...
                    if ((Session["rtype"].ToString() == "1"))
                    {
                        ...
                        txtDateOfPolicepapersupply.Attributes.Add("disabled", "disabled");
        ...
        protected void ShowRecord_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("PolicePaperSupplyList");
        }
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            if (IsPostBack)
            {
                ...
                cm_obj.trialstage_code = 3;
                cm_obj.currentstage = 3;
                cm_obj.currentstagedate = txtDateOfPolicepapersupply.Text;
                ...
                if (cmp > 0)
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "script", "alert('Please ensure that the Next hearing Date should be greater than or equal to the Date Of Police paper supply.\');", true);
                    return;
                    // date1 is greater means date1 is comes after date2
                }
                if (cmp1 > 0)
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "script", "alert('Please ensure that the Date Of Police paper supply should be greater than or equal to the FIR Date.\');", true);
                    return;
                    // date1 is greater means date1 is comes after date2
                }
                else
