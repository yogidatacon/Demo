<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="ProductMasterList.aspx.cs" Inherits="UserMgmt.ProductMasterList" %>
                        ...
                        <div class="x_panel">
                                ...
                                <title>Product Master List</title>
                                   <script>
                                    function chkDuplicateAccessTypeName() {
                                        debugger;
                                        var email = $('#BodyContent_grdProductMaster_txtSearch2').val();
                                        var jsondata = JSON.stringify($('#BodyContent_grdProductMaster_txtSearch2').val());
                                        $.ajax({
                                            type: "POST",
                                            //url: "UserRegistrationForm.aspx/chkDuplicateEmail",
                                            url: "ProductMasterList.aspx/chkDuplicateAccessTypeName",
                                            data: '{name:' + jsondata + '}',
                                    ...
                                    $(document).ready(function () {
                                        $('#BodyContent_grdProductMaster_ddlsearch1').change(function () {
                                            $('#BodyContent_grdProductMaster_txtSearch2').val('');
                                        });
                                    });
                            ...
                            <body>
                                ...
                                <div class="x_title">
                                    ...
                                    <h2>Product Master List</h2>
                                     <div runat="server" visible="false"   style="float:right">
                                                         <asp:TextBox ID="txtSearch" runat="server" Width="250px" AutoComplete="off"   Height="30px" placeholder="Search Product Name"  AutoPostBack="true" OnTextChanged="txtSearch_TextChanged" ></asp:TextBox>
                                ...
                                <asp:UpdatePanel runat="server">
                                                    <ContentTemplate>
                                <div class="x_content">
                                    <asp:GridView ID="grdProductMaster" OnDataBound="grdProductMaster_DataBound" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="10" OnPageIndexChanging="grdProductMaster_PageIndexChanging" EmptyDataText="No Records"
                                        ...
                                        <PagerSettings FirstPageImageUrl="~/img/icons8-first-50.png" 
                                               ...
                                               <asp:ListItem Text="Select" Value="Select"></asp:ListItem>
                                                                  <asp:ListItem Text="Product Type Name" Value="product_type_name"></asp:ListItem>
                ...
                <asp:ImageButton ID="btnNext" Visible="false"
                    runat="server" CommandArgument="Next" Width="30px" Height="20px" CommandName="Page" ForeColor="Blue" BackColor="Blue" ImageUrl="~/img/icons8-next-50.png"  /> <asp:ImageButton
                        ID="btnLast" runat="server" CommandArgument="Last" Width="30px" Visible="false" Height="20px" BackColor="Blue" CommandName="Page" ImageUrl="~/img/icons8-last-50.png" />
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="Product Type Name" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblProductCode" runat="server" Text='<%#Eval("product_type_Name") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Product Code" Visible="true" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCode" runat="server" Text='<%#Eval("product_code") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Product Name" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblName" runat="server" Text='<%#Eval("product_name") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Product Type Code" Visible="false" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblProduct" runat="server" Text='<%#Eval("product_type_Code") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
