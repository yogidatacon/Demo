<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterCaseMgmt.Master" AutoEventWireup="true" CodeBehind="ProsecutionEvidenceForm.aspx.cs" Inherits="UserMgmt.ProsecutionEvidenceForm" %>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="x_panel">
                            ...
                            <head>
                                ...
                                <title>Prosecution Evidence Form</title>
                                <script>
                               ...
                               <script language="javascript" type="text/javascript">
                                    function validationMsg() {
                                        ...
                                        <%-- if (document.getElementById('<%=ddlPRFIRNo.ClientID%>').value == '') {
                                             alert("Select PRFIRNo");
                                        ...
                                        <%--if (document.getElementById('<%=txtChargesheetundersection.ClientID%>').value == '') {
                                         ...
                                         if (document.getElementById('<%=txtPRFIRNo.ClientID%>').value == '') {
                                          ...
                                          if (document.getElementById('<%=txtProsecutionEvidenceDate.ClientID%>').value == '') {
                                              alert("Enter Prosecution Evidence Date");
                                            document.getElementById("<% =txtProsecutionEvidenceDate.ClientID%>").focus();
                                            return false;
                                          }
                                        ...
                                        <%--var Prosecution_Evidence_Date = document.getElementById('<%=txtProsecutionEvidenceDate.ClientID%>').value;
                                        ...
                                        if (Prosecution_Evidence_Date != '' && Nexthearing_Date != '' && Prosecution_Evidence_Date > Nexthearing_Date) {
                                            alert("Please ensure that the Nexthearing Date  is greater than or equal to the Prosecution Evidence Date .");
                                            return false;
                                        }--%>
                                    }
                                </script>
                            ...
                            <body>
                                ...
                                <div class="x_title">
                                    <h2>Prosecution Evidence Form</h2>
                                ...
                                <a>
                                     <asp:LinkButton runat="server" ID="btnSeizure" Height="100%" Width="12%" OnClick="btnSeizure_Click"  CssClass="btn btn-primary" data-toggle="tooltip" data-placement="bottom" title="View Seizure"> Seizure</asp:LinkButton>
                                </a>
                               <%-- <a>
                                       <asp:LinkButton runat="server" ID="btnFIR" Height="100%" Width="12%" CssClass="btn btn-primary" data-toggle="tooltip" data-placement="bottom" title="View FIR"> FIR</asp:LinkButton>
                                </a>
                                <a>
                                       <asp:LinkButton runat="server" ID="btnChargeSheet" Height="100%" Width="12%"  CssClass="btn btn-primary" data-toggle="tooltip" data-placement="bottom" title="View Charge Sheet">Charge Sheet </asp:LinkButton>
                                </a>
                                 <a>
                                       <asp:LinkButton runat="server" ID="btnBail" Height="100%" Width="12%"  CssClass="btn btn-primary" data-toggle="tooltip" data-placement="bottom" title="View Charge Sheet">Bail</asp:LinkButton>
                                </a>--%>
                                       <div class="clearfix"></div>
                                        <p>&nbsp;</p>
                                 ...
                                 <div class="col-md-3 col-sm-12 col-xs-12 form-inline">
                                     ...
                                     <div class="col-md-3 col-sm-12 col-xs-12 form-inline">
                                                <label class="control-label" style="display:inline"><span style="color: red">*</span> Date of Prosecution Evidence</label><br />
                                                <cc1:CalendarExtender runat="server" PopupButtonID="Image1" TargetControlID="txtProsecutionEvidenceDate" Format="dd-MM-yyyy" ID="CalendarExtender1"></cc1:CalendarExtender>
                                                <asp:TextBox ID="txtProsecutionEvidenceDate" onchange="chkDuplicateDates();" data-toggle="tooltip" data-placement="right" ReadOnly="false" title="Bail Request Date" class="form-control validate[required]" AutoComplete="off" runat="server" Font-Size="14px">
                                                </asp:TextBox>
                                     ...
                                     <div class="col-md-3 col-sm-12 col-xs-12 form-inline">
                                                ...
                                                <asp:TextBox ID="txtNexthearingDate" onchange="chkDuplicateDates();" data-toggle="tooltip" data-placement="right" title="Bail Granted Date" ReadOnly="false" class="form-control validate[required]" AutoComplete="off" runat="server" Font-Size="14px">
                                                </asp:TextBox>
                                       ...
                                       <div class="clearfix"></div>
                                        ...
                                        <br />
                                        <asp:TextBox ID="txtRemarks" AutoComplete="off" CssClass="form-control" runat="server"  data-toggle="tooltip" data-placement="right" title="Remarks" Width="66%" TextMode="MultiLine"></asp:TextBox>
                                    </div>
                                        <div class="clearfix"></div>
                                        <p>&nbsp;</p>
                                       <div class="col-md-6 col-sm-12 col-xs-12 form-inline">
                                             <div style =" width:1000px; overflow:auto;"> 
                                    <asp:GridView ID="grWitness" runat="server" AutoGenerateColumns="false" PageSize="10" AllowPaging="true" EmptyDataText="No Records" 
                                        ...
                                        <Columns>
                                             ...
                                             <asp:TemplateField HeaderText="Witness Id" ItemStyle-Font-Bold="true"  ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblWitnessId" runat="server" Visible="false" Text='<%#Eval("") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Witness Type" ItemStyle-Font-Bold="true"  ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblWitnessType" runat="server" Visible="false" Text='<%#Eval("") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                             <asp:TemplateField HeaderText="Witness Name" ItemStyle-Font-Bold="true"  ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblWitnessName" runat="server" Visible="false" Text='<%#Eval("") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                             <asp:TemplateField HeaderText="Designation" ItemStyle-Font-Bold="true"  ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblDesignation" runat="server" Visible="false" Text='<%#Eval("") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
