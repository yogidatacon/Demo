<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin.Master" CodeBehind="RMR_GrainBase.aspx.cs" Inherits="UserMgmt.RMR_GrainBase" %>
                                    ...
                                    function Calcutate() {
                                        ...
                                        for (var i = 0; i < tb.length; i++)
                                        {
                                            if (tb[i].type == "text" )
                                            {
                                                ...
                                                var NetWeight = parseFloat($('#BodyContent_txtOtyDispatch').val()).toFixed(2);
                                                if (NetWeight < total)
                                                {
                                                   total -= parseFloat(sub);
                                                   alert("Qty not Matched with Receipt Qty");
                                 ...
                                 <script type="text/javascript" language="javascript">
                                     ...
                                     Sys.Application.add_load(function () {
                                      ...
                                      <div class="col-md-3 col-sm-12 col-xs-12 form-inline">
                                        ...
                                        <div class="col-md-3 col-sm-12 col-xs-12 form-inline">
                                        <label class="control-label" id="Label1" runat="server" style="display:inline"><span style="color: red">*</span> Raw Material</label><br />
                                      <asp:DropDownList ID="ddtypeofmeterial"  CssClass="form-control" data-toggle="tooltip" Width="60%" data-placement="right" title="Raw Material" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddtypeofmeterial_SelectedIndexChanged1">
                                        </asp:DropDownList>
                                    </div>
                                     <div class="col-md-3 col-sm-2 col-xs-12 form-inline">
                                        ...
                                        <asp:DropDownList ID="ddlSupplierType"  Height="30px" width="60%"  runat="server" data-toggle="tooltip" OnSelectedIndexChanged="ddlSupplierType_SelectedIndexChanged" data-placement="right" title="Party Name" Cssclass="form-control" Style="">
                                     ...
                                     <div id="ddp" runat="server" visible="false" class="col-md-3 col-sm-2 col-xs-12 form-inline">
                                        ...
                                        <asp:DropDownList ID="ddlparty"  Height="30px" width="85%" runat="server" data-toggle="tooltip" data-placement="right" title="Party Name" Cssclass="form-control" Style="">
                                                            <asp:ListItem Enabled="true" Text="Select" Value="Select"></asp:ListItem>
                                                        </asp:DropDownList>
                                    </div>
                                    ...
                                    <div class="col-md-3 col-sm-12 col-xs-12 form-inline">
                                     ...
                                     <div class="col-md-3 col-sm-12 col-xs-12 form-inline">
                                        ...
                                        <cc1:CalendarExtender runat="server" TargetControlID="txtRecieptDate" OnClientDateSelectionChanged="SelectDate1" Format="dd-MM-yyyy" ID="CalendarExtender2"></cc1:CalendarExtender>
                                    <asp:TextBox ID="txtRecieptDate"  data-toggle="tooltip" data-placement="right"  title="Click on Textbox to Select Reciept Date" class="form-control validate[required]" AutoComplete="off" runat="server" Font-Size="14px" ></asp:TextBox>
                                         <%-- <asp:ImageButton ID="Image3" class="control-label" runat="server" Height="30px" Width="30px" ImageUrl="common/theme/image1/calendar-512.png" />
                                             <%--<input type="date" id="txtRecieptDate" data-toggle="tooltip"  style="Width:60%" data-placement="right" title="Receipt Date" readonly="readonly" runat="server" class="form-control" >--%>
                                    ...
                                    <div class="col-md-3 col-sm-12 col-xs-12 form-inline">
                                     ...
                                     <div class="col-md-3 col-sm-2 col-xs-12 form-inline">
                                        ...
                                        <asp:DropDownList ID="ddlUOM"  Height="30px" width="50%"  runat="server" data-toggle="tooltip" data-placement="right"  title="UOM" Cssclass="form-control" Style="">
                                                        </asp:DropDownList>
                                    </div>
                                      <div class="clearfix"></div>
                                    <p>&nbsp;</p>
                                   ...
                                   <div style="height: 8%; background-color: #26b8b8;">
                                    ...
                                    &nbsp;
                                    <div class="clearfix"></div>
                                    <asp:UpdatePanel runat="server" ID="ap">
                                          <ContentTemplate>
                                        <div runat="server" id="div1">
                                            ...
                                            <Triggers>
        <asp:AsyncPostBackTrigger ControlID="ddtypeofmeterial" EventName="SelectedIndexChanged" />
    </Triggers>
                    </asp:UpdatePanel>                    
