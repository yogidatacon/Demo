<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="ReleaseRequestForm.aspx.cs" Inherits="UserMgmt.ReleaseRequestForm" %>
...
<%--                                  <div>
                                ...
                                <div class="x_content">
                                    ...
                                    <div  class="col-md-3 col-sm-12 col-xs-12 form-inline">
                                     ...
                                     <div  class="col-md-3 col-sm-12 col-xs-12 form-inline">
                                        <label class="control-label" style="display:inline"><span style="color: red"></span>MA Allotment Qty<%--Allotment Qty--%></label>
                                        <br />
                                    ...
                                    <p>&nbsp;</p>
                                    <div  class="col-md-3 col-sm-12 col-xs-12 form-inline">
                                        <label class="control-label" style="display:inline"><span style="color: red"></span>RR Qty Approved Till Now<%-- Total Released QTY--%></label>
                                        <br />
                                     ...
                                     <div  class="col-md-3 col-sm-12 col-xs-12 form-inline">
                                        <label class="control-label" style="display:inline"><span style="color: red"></span>RR Applied Qty<%--Release Requested QTY--%></label>
                                        <br />
                                     ...
                                     <div  class="col-md-3 col-sm-12 col-xs-12 form-inline">
                                        ...
                                        <asp:TextBox ID="txtNewRequestedQty" onchange="CheckQTY()" AutoComplete="off" CssClass="form-control" runat="server" data-toggle="tooltip" data-placement="right" onkeypress="return onlyDotsAndNumbers(this,event);" title="New Requested Qty" ></asp:TextBox>
                                         <asp:HiddenField ID="hidrqty" runat="server" />
                                    </div>
