<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true"  CodeBehind="RequestForPassList.aspx.cs" Inherits="UserMgmt.RequestForPassList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyContent" runat="server">
     <div role="main">
        ...
        <div class="">
            <div class="row top_tiles">
               ...
               &nbsp; <label class="control-label" style="display:inline"><span style="color:red">*</span>Pass / Dispatch For</label> <br />                                          
                                          &nbsp;  <asp:DropDownList ID="ddPassFor" AutoPostBack="true" runat="server" data-toggle="tooltip" data-placement="right" title="Pass / Dispatch For" OnSelectedIndexChanged="ddPassFor_SelectedIndexChanged" CssClass="form-control" style="">
                                                ...
                                                <asp:ListItem Text="RR" Value="M"></asp:ListItem>
                                                <asp:ListItem Text="NOC" Value="N"></asp:ListItem>
                                              </asp:DropDownList>
                                        </div>
  ...
  <asp:LinkButton ID="LinkButton3" runat="server" CommandName="Page"  CommandArgument="Next" CssClass="myButton1"><i class="fa fa-chevron-right"></i></asp:LinkButton>
      ...
      <span><asp:LinkButton ID="LinkButton5" runat="server" OnClick="LinkButton5_Click1" CssClass="btn btn-primary left"><i class="fa fa-refresh"> </i></asp:LinkButton></span> 
                                          ...
                                          <asp:TemplateField HeaderText="NOC IssuedNo"  ItemStyle-Font-Bold="true" Visible="true" ItemStyle-Width="30px">
                                            ...
                                            <asp:TemplateField HeaderText="Status" ItemStyle-Font-Bold="true"
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <asp:LinkButton Text="Edit" ID="btnEdit" CssClass="myButton1" runat="server"  CommandName="Edit" Visible='<%# Eval("record_status").ToString() == "N" ? true : false %>' OnClick="btnNOCEdit_Click"><i class="fa fa-pencil-square-o"> 
                                                                                    </i> 
                                                    </asp:LinkButton>
                                                    <asp:LinkButton Text="Apply Pass" ID="btnApply" CssClass="myButton7" runat="server"  CommandName="Edit" Visible='<%# Eval("record_status").ToString() == "Y" ? true :Eval("record_status").ToString() == "A" ? true: false %>' OnClick="btnNOCApply_Click"><i class="fa">G
                                                                                    </i> 
                                                    </asp:LinkButton>
                                                </ItemTemplate>
                                                <ItemStyle Width="10px" />
