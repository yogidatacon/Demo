<%@ Page Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="RoleLevelList.aspx.cs" Inherits="UserMgmt.RoleLevelList" %>
                                ...
                                <title>User Management</title>
                                  <script>
                                    function chkDuplicateAccessTypeName() {
                                        debugger;
                                        var email = $('#BodyContent_grdRoleLevelList_txtSearch2').val();
                                        var jsondata = JSON.stringify($('#BodyContent_grdRoleLevelList_txtSearch2').val());
                                        $.ajax({
                                            type: "POST",
                                            //url: "UserRegistrationForm.aspx/chkDuplicateEmail",
                                            url: "RoleLevelList.aspx/chkDuplicateAccessTypeName",
                                            data: '{name:' + jsondata + '}',
                                    ...
                                    $(document).ready(function () {
                                        $('#BodyContent_grdRoleLevelList_ddlsearch1').change(function () {
                                            $('#BodyContent_grdRoleLevelList_txtSearch2').val('');
                                        });
                                    });
                                    </script>
                            </head>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="x_panel">
                                                <div class="x_title">
                                                    ...
                                                    <h2>Role Level List</h2>
                                                     <div runat="server" visible="false"   style="float:right">
                                                         <asp:TextBox ID="txtSearch" runat="server" Width="250px" AutoComplete="off"   Height="30px" placeholder="Search Role Level Name"  AutoPostBack="true" OnTextChanged="txtSearch_TextChanged" ></asp:TextBox>
                                                    ...
                                                    <ContentTemplate>
                                                <div class="x_content">
                                                    <asp:GridView ID="grdRoleLevelList" runat="server" AutoGenerateColumns="false" 
                                                        AllowPaging="true"  OnPageIndexChanging="grdRoleLevelList_PageIndexChanging"
                                                        HeaderStyle-BackColor="#26b8b8" HeaderStyle-ForeColor="#ECF0F1" 
                                                        class="table table-striped responsive-utilities jambo_table" OnDataBound="grdRoleLevelList_DataBound">
                                               ...
                                               <asp:ListItem Text="Select" Value="Select"></asp:ListItem>
                                                                  <asp:ListItem Text="Role Level Name" Value="role_level_name"></asp:ListItem>
                                                <asp:ListItem Text="Role Description" Value="role_level_desc"></asp:ListItem>
                        ...
                        ID="btnLast" runat="server" CommandArgument="Last" Width="30px" Visible="false" Height="20px" BackColor="Blue" CommandName="Page" ImageUrl="~/img/icons8-last-50.png" />
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="RoleCode" Visible="false" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblRoleCode" runat="server" Visible="true" Text='<%#Eval("Role_level_code") %>'></asp:Label>

                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Role Level Name" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblRoleName" runat="server" Visible="true" Text='<%#Eval("levelname") %>'></asp:Label>

                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Role Description" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblRoleDescription" runat="server" Visible="true" Text='<%#Eval("description") %>'></asp:Label>
