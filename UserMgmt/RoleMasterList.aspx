<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeFile="RoleMasterList.aspx.cs" Inherits="UserMgmt.RoleMasterList" %>
   ...
   <head>
    ...
    <body>
      ...
      <li  >  <asp:LinkButton  ID="DistrictMaster"   runat="server" OnClick="DistrictMaster_Click"><span style="color:#fff;font-size:14px;">District Master</span></asp:LinkButton></li>
        ...
        <li  class="active">  <asp:LinkButton  ID="RoleMaster"   runat="server" OnClick="RoleMaster_Click"><span style="color:#fff;font-size:14px;">Role Master</span></asp:LinkButton></li> 
            ...
            <div class="row">
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <div class="x_panel">
                                                    ...
                                                    <div class="x_content">
                                                        <asp:GridView id="grdRoleMasterList" runat="server" AutoGenerateColumns="false"   AllowPaging="true" 
                                                        HeaderStyle-BackColor="#26b8b8" HeaderStyle-ForeColor="#ECF0F1" class="table table-striped responsive-utilities jambo_table">
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="Role Name" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblRoleName" runat="server" Visible="true" Text="Datacon" ></asp:Label>
                                                                   
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Role Leve" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblRoleLeveName" runat="server" Visible="true" Text="Datacon" ></asp:Label>
                                                            ...
                                                            <asp:TemplateField HeaderText="Access Type " ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblATName" runat="server" Visible="true" Text="Datacon" ></asp:Label>
                                                                   
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Parent Role" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblParentRole" runat="server" Visible="true" Text="Datacon" ></asp:Label>
