...
namespace UserMgmt
{
    public partial class RolePermissionList : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if(!IsPostBack)
            {
                ...
                rolepermisions = BL_RolePermisions.GetRolePermissionList();
                grdRolePermissionList.DataSource = rolepermisions;
        ...
        protected void AddRecord_Click(object sender, EventArgs e)
        {
            Session["UserID"] = Session["UserID"].ToString();
            Session["rtype"] = "0";
            Response.Redirect("RolePermissionForm");
        }
        ...
        protected void btnView_Click(object sender, EventArgs e)
        {
            ...
            string Role_name_Code = (gvr.Cells[gvr.Cells.Count - 1].FindControl("lblRole_Name_Code") as Label).Text;
            Session["UserID"] = Session["UserID"].ToString();
            Session["role_name_code"] = Role_name_Code;
            Session["rtype"] = "1";
            Response.Redirect("RolePermissionForm");
        }
        ...
        protected void btnEdit_Click(object sender, EventArgs e)
        {
            LinkButton btn = (LinkButton)sender;
            GridViewRow gvr = (GridViewRow)btn.NamingContainer;
            string RoleName = (gvr.Cells[gvr.Cells.Count - 1].FindControl("lblRoleName") as Label).Text;
            string Role_name_Code = (gvr.Cells[gvr.Cells.Count - 1].FindControl("lblRole_Name_Code") as Label).Text;
            Session["UserID"] = Session["UserID"].ToString();
            Session["role_name_code"] = Role_name_Code;
        ...
        protected void grdRolePermissionList_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            if (Session["rpsearch"] != null && Session["rptext"] != null)
            {
                ddsearch.SelectedValue = Session["rpsearch"].ToString();
                txtpage.Text = Session["rptext"].ToString();
                if (ddsearch.SelectedValue != "Select")
                {
                    ...
                    if (txtpage != null)
                    {
                        ...
                        rolepermisions = BL_RolePermisions.SearchRolePermissions("role_permission", ddsearch.SelectedValue, txtpage.Text);
                        grdRolePermissionList.DataSource = rolepermisions;
                        grdRolePermissionList.DataBind();
        ...
        public string chkDuplicateAccessTypeName(Object name)
        {
            ...
            return rolepermisions.ToString();
        }
        ...
        protected void btnsearch_Click(object sender, EventArgs e)
        {
            ...
            if (ddsearch.SelectedValue != "Select")
            {
                ...
                Session["rpsearch"] = ddsearch.SelectedValue;
                if (txtpage != null)
                {
                    Session["rptext"] = txtpage.Text;
        ...
        protected void grdRolePermissionList_DataBound(object sender, EventArgs e)
        {
            ...
            {
                ddsearch.SelectedValue = Session["rpsearch"].ToString();
                txtpages.Text = Session["rptext"].ToString();
            }
