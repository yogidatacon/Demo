...
namespace UserMgmt
{
    public partial class SECCase_Hearing : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                if (ViewState["Records5"] == null)
                {
                    dt5.Columns.Add("Status");
                    dt5.Columns.Add("Doc_Name");
                    dt5.Columns.Add("Doc_Type");
                    dt5.Columns.Add("Discription");
                    dt5.Columns.Add("Doc_Path");
                    dt5.Columns.Add("Doc_id");
                    dt5.Columns.Add("User_id");
                    ViewState["Records5"] = dt5;
                }
                ...
                if (Session["rtype"].ToString() != "0")
                {
                    ...
                    CalendarExtender2.StartDate = Convert.ToDateTime(obj.appealdate);
                    ...
                    {
                        txtNextHearing.Text = obj.next_hearingdate;
                        CalendarExtender2.SelectedDate = Convert.ToDateTime(obj.next_hearingdate);
                    }
                    txthRemarks.Text= obj.hremarks;
                    ...
                    for (int i = 0; i < obj.docs1.Count; i++)
                    {
                        ...
                        dt2.Rows.Add("", obj.docs1[i].doc_name, obj.docs1[i].document_type, obj.docs1[i].description, obj.docs1[i].doc_path, obj.docs1[i].seizure_docs_id);
                    ...
                    for (int i = 0; i < obj.docs5.Count; i++)
                    {
                        ...
                        if (i == 0)
                            dummytable.Visible = false;
                        dt5 = (DataTable)ViewState["Records5"];
                        dt5.Rows.Add("", obj.docs5[i].doc_name, obj.docs5[i].document_type, obj.docs5[i].description, obj.docs5[i].doc_path, obj.docs5[i].seizure_docs_id);
                        grdAdd5.DataSource = dt5;
                        grdAdd5.DataBind();
                        Doc_id++;
                    }
                    Doc_id = 0;
                    for (int i = 0; i < obj.docs.Count; i++)
                    {
                        ...
                        dt.Rows.Add("", obj.docs[i].doc_name, obj.docs[i].document_type, obj.docs[i].description, obj.docs[i].doc_path, obj.docs[i].seizure_docs_id);
                    ...
                    if (Session["rtype"].ToString() == "1")
                    {
                        ...
                        txtrRemarks.Attributes.Add("Disabled", "Disabled");
                        ...
                        // }
                        ddlActionPorposed.Enabled = false;
            ...
            if (IsPostBack)
            {
                if (IsPostBack)
                {
                    ...
                    if (cm_obj.case_action == "Next Hearing")
                        cm_obj.next_hearingdate = txtNextHearing.Text;
                    ...
                    if (rdbPolice.Checked)
                        cm_obj.raidby = "P";
                    cm_obj.hremarks = txthRemarks.Text;
                    int i = 0;
                    ...
                    if (val == true)
                    {
                        ...
                        Response.Redirect("SECCase_List");
                    }
                    else
                    {
            ...
            if (IsPostBack)
            {
                if (IsPostBack)
                {
                    ...
                    else
                    {
                        ...
                        cm_obj.hearing_status = "Disposed at Secretary Court";
                    }
