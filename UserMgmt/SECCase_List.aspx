<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeBehind="SECCase_List.aspx.cs" Inherits="UserMgmt.SECCase_List" %>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="x_panel">
                            ...
                            <head>
                                ...
                                <title>Case Hearing List at Secretary Court for Vehicle / Property Under Prohibition Act</title>
                            ...
                            <body>
                              <%--  <asp:LinkButton runat="server" CssClass="myButton3 " ID="btnAddRecord" OnClick="AddRecord_Click" Style="float: right"><i class="fa fa-plus-circle"> ADD NEW RECORD</i></asp:LinkButton>--%>
                                <div class="x_title">
                                    <h2>Case Hearing List at Secretary Court for Vehicle / Property Under Prohibition Act </h2>
                        ...
                        ID="btnLast" runat="server" CommandArgument="Last" Width="30px" Visible="false" Height="20px" BackColor="Blue" CommandName="Page" ImageUrl="~/img/icons8-last-50.png" />
                                                          ...
                                                          <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Appeal Status" ItemStyle-Font-Bold="true" Visible="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblAppealStatus" runat="server" Visible="true" Text='<%#Eval("hearing_status").ToString() == "Y" ? "Pending":Eval("hearing_status").ToString() == "N" ? "Pending": Eval("hearing_status").ToString() %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                             <asp:TemplateField HeaderText="regid" ItemStyle-Font-Bold="true" Visible="false" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblregid" runat="server" Visible="true" Text='<%# Eval("seccase_registration_id")%>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Action" ItemStyle-Font-Bold="true" HeaderStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:LinkButton Text="Edit" ID="btnEdit" CssClass="myButton1" runat="server" OnClick="btnEdit_Click" Visible='<%#Eval("hearing_status").ToString() == "Y" ? true:Eval("hearing_status").ToString() == "N" ? true:Eval("hearing_status").ToString() == "Next Hearing" ? true:false %>' CommandName="Edit"><i class="fa fa-pencil-square-o">
                                                                                    </i> 
                                                                    </asp:LinkButton>
                                                                </ItemTemplate>
