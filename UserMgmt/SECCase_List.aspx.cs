...
namespace UserMgmt
{
    public partial class SECCase_List : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                exs = BL_cm_seiz_Dmconfiscation.GetSECCaseList();
                var list = from s in exs where s.record_status=="Y"
                           select s;
                grdUnSubmittedList.DataSource = list.ToList();
        ...
        {
            Session["rtype"] = 0;
            Response.Redirect("SECCase_Hearing");
        }
        ...
        protected void btnView_Click(object sender, EventArgs e)
        {
            ...
            Session["UserID"] = Session["UserID"];
            Session["rtype"] = "1";
            Session["seccase_registration_id"] = ID;
            Response.Redirect("SECCase_Hearing");
        }
