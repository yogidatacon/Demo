<%@ Page Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="StateList.aspx.cs" Inherits="UserMgmt.StateList" %>
                        ...
                        <div class="x_panel">
                                ...
                                <title>User Management</title>
                                  <script>
                                    function chkDuplicateAccessTypeName() {
                                        debugger;
                                        var email = $('#BodyContent_StateListView_txtSearch2').val();
                                        var jsondata = JSON.stringify($('#BodyContent_StateListView_txtSearch2').val());
                                        $.ajax({
                                            type: "POST",
                                            //url: "UserRegistrationForm.aspx/chkDuplicateEmail",
                                            url: "StateList.aspx/chkDuplicateAccessTypeName",
                                            data: '{name:' + jsondata + '}',
                                    ...
                                    $(document).ready(function () {
                                        $('#BodyContent_StateListView_ddlsearch1').change(function () {
                                            $('#BodyContent_StateListView_txtSearch2').val('');
                                        });
                                    });
                                    </script>
                            </head>
                            <body>
                                <div>
                                    ...
                                    <br />
                                    <a>
                                        <asp:LinkButton runat="server" CssClass="myButton3 " ID="AddRecord" Style="float: right" OnClick="AddRecords_Click"><i class="fa fa-plus-circle"> ADD NEW RECORD</i></asp:LinkButton></a>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="x_panel">
                                                <div class="x_title">
                                                    ...
                                                    <h2>State List</h2>
                                                     <div runat="server" visible="false"   style="float:right">
                                                         <asp:TextBox ID="txtSearch" runat="server" Width="250px" AutoComplete="off"   Height="30px" placeholder="Search State Name"  AutoPostBack="true" OnTextChanged="txtSearch_TextChanged" ></asp:TextBox>
                                                ...
                                                <div class="x_content">
                                                    ...
                                                    <asp:GridView ID="StateListView" runat="server" AutoGenerateColumns="false" AllowPaging="true"  
                                                        OnPageIndexChanging="StateListView_PageIndexChanging"
                                                        HeaderStyle-BackColor="#26b8b8" HeaderStyle-ForeColor="#ECF0F1" 
                                                        class="table table-striped responsive-utilities jambo_table" 
                                                        OnSelectedIndexChanged="StateListView_SelectedIndexChanged" OnDataBound="GridView1_DataBound" >
                                               ...
                                               <asp:ListItem Text="Select" Value="Select"></asp:ListItem>
                                                ...
                                                <asp:ListItem Text="State Code" Value="state_code"></asp:ListItem>
                    ...
                    runat="server" CommandArgument="Next" Width="30px" Height="20px" CommandName="Page" ForeColor="Blue" BackColor="Blue" ImageUrl="~/img/icons8-next-50.png"  /> <asp:ImageButton
                        ID="btnLast" runat="server" CommandArgument="Last" Width="30px" Visible="false" Height="20px" BackColor="Blue" CommandName="Page" ImageUrl="~/img/icons8-last-50.png" />
                                                          ...
                                                          <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="State Name" Visible="false" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblStateID" runat="server" Visible="true" Text='<%#Eval("State_id") %>'></asp:Label>

                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Country Name" Visible="false" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblcountry_name" runat="server" Visible="true" Text='<%#Eval("country_name") %>'></asp:Label>
                                                            ...
                                                            <asp:TemplateField HeaderText="Action" ItemStyle-Font-Bold="true" HeaderStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton Text="View" ID="btnView" CssClass="myButton" runat="server" CommandArgument='<%# Bind("state_id") %>' OnClick="btnView_Click" CommandName="View"><i class="fa fa-search-plus">
                                                                                    </i> 
                                                                    </asp:LinkButton>
