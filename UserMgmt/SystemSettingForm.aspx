<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="SystemSettingForm.aspx.cs" Inherits="UserMgmt.SystemSettingForm" %>
                        ...
                        <div class="x_panel">
                            ...
                            <body>
                               <%-- <ul class="nav nav-tabs">
                                ...
                                <div class="x_title">
                                    <h2>System Setting Master</h2>
                                    <div class="clearfix"></div>
                                </div>
                                    <div class="col-md-3 col-sm-12 col-xs-12 form-inline">
                                        <label style="font-size: small"><span style="color: red">*</span>Parameter Name</label><br />
                                        <asp:TextBox ID="txtname1" AutoPostBack="true" AutoComplete="off" Style="text-transform:capitalize" onchange="chkDuplicateProductTypeName();"   CssClass="form-control" Height="30px" Width="250px" data-toggle="tooltip" data-placement="right" title="Parameter Name" runat="server" MaxLength="50"></asp:TextBox>
                                    </div>
                                     <div class="col-md-3 col-sm-12 col-xs-12 form-inline">
                                        <label style="font-size: small"><span style="color: red"></span>Parameter Value</label><br />
                                        <asp:TextBox ID="txtcode" AutoComplete="off"  CssClass="form-control" AutoPostBack="true"  data-toggle="tooltip" data-placement="right" title="Parameter Value" runat="server" OnTextChanged="txtcode_TextChanged" MaxLength="3"></asp:TextBox>
                                    </div>
                                       <div class="col-md-3 col-sm-12 col-xs-12 form-inline">
                                        <label style="font-size: small"><span style="color: red"></span>Parameter String</label><br />
                                        <asp:TextBox ID="txtparameter" AutoComplete="off"   CssClass="form-control" AutoPostBack="true" onkeypress="return Validate(event);"  data-toggle="tooltip" data-placement="right" title="Parameter Value" OnTextChanged="txtparameter_TextChanged" runat="server" ></asp:TextBox>
                                    </div>
                                    <p>&nbsp;</p>
                                    <p>&nbsp;</p>
