<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="SystemSettingList.aspx.cs" Inherits="UserMgmt.SystemSettingList" %>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="x_panel">
                            ...
                            <head>
                                ...
                                <title>System Setting Master List</title>
                            </head>
                            <body>
                               <%--  <ul class="nav nav-tabs">
                                ...
                                <div class="x_title">
                                    ...
                                    <h2>System Setting Master List</h2>
                                    <div runat="server" visible="false"   style="float:right">
                                                         <asp:TextBox ID="txtSearch" runat="server" Width="250px" AutoComplete="off"   Height="30px" placeholder="Search Product Type Name"  AutoPostBack="true" OnTextChanged="txtSearch_TextChanged" ></asp:TextBox>
                                    ...
                                    <div class="clearfix"></div>
                                                    ...
                                                    <ContentTemplate>
                                <div class="x_content">
                                    <asp:GridView ID="grdProductList" OnDataBound="grdProductList_DataBound" runat="server"  AutoGenerateColumns="false"  AllowPaging="true" PageSize="10" OnPageIndexChanging="grdProductList_PageIndexChanging" EmptyDataText="No Records"
                                    ...
                                    <PagerSettings FirstPageImageUrl="~/img/icons8-first-50.png" 
                                               ...
                                               <asp:ListItem Text="Select" Value="Select"></asp:ListItem>
                                                <asp:ListItem Text="Parameter Name" Value="parameter_name"></asp:ListItem>
                                                <asp:ListItem Text="Parameter Value" Value="parameter_value_num"></asp:ListItem>
                ...
                <asp:ImageButton ID="btnNext" Visible="false"
                    runat="server" CommandArgument="Next" Width="30px" Height="20px" CommandName="Page" ForeColor="Blue" BackColor="Blue" ImageUrl="~/img/icons8-next-50.png"  /> <asp:ImageButton
                        ID="btnLast" runat="server" CommandArgument="Last" Width="30px" Visible="false" Height="20px" BackColor="Blue" CommandName="Page" ImageUrl="~/img/icons8-last-50.png" />
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="Parameter Name" Visible="true" ItemStyle-Font-Bold="true" ItemStyle-Width="20px" >
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblCode" runat="server" Text='<%#Eval("parameter_name") %>' ></asp:Label>
                                                                   
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Parameter Value" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblName" runat="server" Visible="true" Text='<%#Eval("parameter_value_num") %>'  ></asp:Label>
                                                                   
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                                  <asp:TemplateField HeaderText="Parameter String" Visible="false" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblstring" runat="server" Visible="true" Text='<%#Eval("parameter_value_str") %>'  ></asp:Label>
                                                                   
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                       <asp:TemplateField HeaderText="id" Visible="false" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblid" runat="server" Visible="true" Text='<%#Eval("system_setting_id") %>'  ></asp:Label>
