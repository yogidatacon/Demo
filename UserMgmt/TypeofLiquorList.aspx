<%@ page language="C#" autoeventwireup="true" codebehind="TypeofLiquorList.aspx.cs" inherits="UserMgmt.TypeofLiquorList" masterpagefile="~/Admin.Master" %>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="x_panel">
                            ...
                            <head>
                                ...
                                <title>Type of Liquor Management</title>
                            </head>
                            <body>
                                <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="x_panel">
                                                <div class="x_title">
                                                    <h2>Type of Liquor List</h2>
                                                    <div class="clearfix"></div>
                                                </div>
                                                <div class="x_content">
                                                    <asp:GridView ID="grdLiquourList" runat="server" AutoGenerateColumns="false" PageSize="50" AllowPaging="true" OnPageIndexChanging="grdLiquourList_PageIndexChanging"
                                                        ...
                                                        <columns> 
                                                            ...
                                                            <asp:TemplateField HeaderText="Liquor Name"  ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="Action" ItemStyle-Font-Bold="true" HeaderStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton Text="" ID="btnEdit" CssClass="myButton1" runat="server"
                                                                        CommandArgument='<%#Eval("type_of_liquor_id") %>'  CommandName="Edit_Record"> 
                                                                          <i class="fa fa-pencil-square-o"></i>
                                                                    </asp:LinkButton> 

                                                                    <asp:LinkButton Text="" ID="btnDel" CssClass="deleteButton" runat="server"
                                                                        CommandArgument='<%#Eval("type_of_liquor_id") %>'  CommandName="Delete_Record"> 
