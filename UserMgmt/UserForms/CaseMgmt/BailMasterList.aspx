<%@ Page Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="BailMasterList.aspx.cs" Inherits="UserMgmt.BailMasterList" %>
                        ...
                        <div class="x_panel">
                            ...
                            <head>
                                    ...
                                    $(function () {
                                        $(".ddlsearch1s").change(function () {
                                            if ($(this).find('option:selected').text() == "1") {
                                                ...
                                                $('#BodyContent_BailMasterView_txtSearch2').val('');
                                            }
                                        });
                                    });
                                ...
                                <script language="javascript" type="text/javascript">
                                    function validationMsg() {
                                        debugger;;
                                        if ($("#BodyContent_BailMasterView_ddlsearch1").val() == 'Select') {
                                            alert("select search column!");
                                            $("#BodyContent_BailMasterView_ddlsearch1").focus();
                                            return false;
                                        }
                                        if ($("#BodyContent_BailMasterView_txtSearch2").val() == '') {
                                            alert("Enter search column Value!");
                                            $("#BodyContent_BailMasterView_txtSearch2").focus();
                                            return false;
                                        }
                                    }
                                    </script> 
                            ...
                            <body>
                               <ul class="nav nav-tabs">
                                ...
                                <div class="x_title">
                                    <h2>Bail Master List</h2>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">
                                     <asp:GridView  ID="BailMasterView"  runat="server" AutoGenerateColumns="false"   AllowPaging="true" OnDataBound="BailMasterView_DataBound" 
                                                        HeaderStyle-BackColor="#26b8b8" HeaderStyle-ForeColor="#ECF0F1" class="table table-striped responsive-utilities jambo_table" OnPageIndexChanging="BailMasterView_PageIndexChanging">
                                          <PagerSettings FirstPageImageUrl="~/img/icons8-first-50.png" 
                                                        ...
                                                        <PagerTemplate>
                                                            <asp:DropDownList ID="ddlsearch1" runat="server" Width="150px" 
                                                                ...
                                                                ForeColor="Black" Font-Size="12px" style="float:left" CssClass="ddlsearch1s">
                                               <asp:ListItem Text="Select" Value="Select"></asp:ListItem>
                                                <asp:ListItem Text="Bail Code" Value="bail_type_master_code"></asp:ListItem>
                                                <asp:ListItem Text="Bail Name" Value="bail_type_master_name"></asp:ListItem>
                        ...
                        ID="btnLast" runat="server" CommandArgument="Last" Width="30px" Visible="false" Height="20px" BackColor="Blue" CommandName="Page" ImageUrl="~/img/icons8-last-50.png" />
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="Code" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblCode" runat="server" Visible="true" Text='<%# Bind("bail_type_master_code") %>' ></asp:Label>
                                                                   
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Name" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblName" runat="server" Visible="true" Text='<%# Bind("bail_type_master_name") %>' ></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Id" ItemStyle-Font-Bold="true" ItemStyle-Width="20px" Visible="false">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblId" runat="server" Visible="true" Text='<%# Bind("bail_type_master_id") %>' ></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
