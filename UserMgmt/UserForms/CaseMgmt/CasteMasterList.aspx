<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="CasteMasterList.aspx.cs" Inherits="UserMgmt.CasteMasterList" %>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="x_panel">
                                ...
                                <script>
                                    $(function () {
                                        $(".ddlsearch1s").change(function () {
                                            if ($(this).find('option:selected').text() == "1") {
                                                ...
                                                $('#BodyContent_CasteMasterView_txtSearch2').val('');
                                            }
                                        });
                                    });
                                  ...
                                  <script language="javascript" type="text/javascript">
                                    function validationMsg() {
                                        debugger;;
                                        if ($("#BodyContent_CasteMasterView_ddlsearch1").val() == 'Select') {
                                            alert("select search column!");
                                            $("#BodyContent_CasteMasterView_ddlsearch1").focus();
                                            return false;
                                        }
                                        if ($("#BodyContent_CasteMasterView_txtSearch2").val() == '') {
                                            alert("Enter search column Value!");
                                            $("#BodyContent_CasteMasterView_txtSearch2").focus();
                                            return false;
                                        }
                                    }
                                    </script> 
                            ...
                            <body>
                                ...
                                <div class="x_title">
                                    <h2>Caste Master List</h2>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">
                                     <asp:GridView  ID="CasteMasterView"  runat="server" AutoGenerateColumns="false"   AllowPaging="true" OnPageIndexChanging="CasteMasterView_PageIndexChanging" OnDataBound="CasteMasterView_DataBound" 
                                          ...
                                          <PagerSettings FirstPageImageUrl="~/img/icons8-first-50.png" 
                                               ...
                                               <asp:ListItem Text="Select" Value="Select"></asp:ListItem>
                                                <asp:ListItem Text="Caste Code" Value="caste_code"></asp:ListItem>
                                                <asp:ListItem Text="Caste Name" Value="caste_name"></asp:ListItem>
                                                                <asp:ListItem Text="Category Code" Value="category_code"></asp:ListItem>
                                                                <asp:ListItem Text="Religion Name" Value="religion_name"></asp:ListItem>
                ...
                <asp:ImageButton ID="btnNext" Visible="false"
                    runat="server" CommandArgument="Next" Width="30px" Height="20px" CommandName="Page" ForeColor="Blue" BackColor="Blue" ImageUrl="~/img/icons8-next-50.png"  /> <asp:ImageButton
                        ID="btnLast" runat="server" CommandArgument="Last" Width="30px" Visible="false" Height="20px" BackColor="Blue" CommandName="Page" ImageUrl="~/img/icons8-last-50.png" />
                                          ...
                                          <Columns>
                                                            <asp:TemplateField HeaderText="Caste Code" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblCode" runat="server" Visible="true"  Text='<%#Eval("caste_code") %>'></asp:Label>
                                                                   
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Caste Name" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblName" runat="server" Visible="true" Text='<%#Eval("caste_name") %>' ></asp:Label>
                                                                   
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                             <asp:TemplateField HeaderText="Caste Category" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblCategory" runat="server" Visible="true"  Text='<%#Eval("category_code") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                             <asp:TemplateField HeaderText="Religion" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblReligion" runat="server" Visible="true"  Text='<%#Eval("religion_name") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="ReligionCode" ItemStyle-Font-Bold="true" Visible="false" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblReligionCode" runat="server" Visible="false"  Text='<%#Eval("religion_code") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Id" ItemStyle-Font-Bold="true" ItemStyle-Width="20px" Visible="false">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblId" runat="server" Visible="true"  Text='<%#Eval("caste_master_id") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
