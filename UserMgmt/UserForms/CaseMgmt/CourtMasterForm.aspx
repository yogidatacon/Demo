<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="CourtMasterForm.aspx.cs" Inherits="UserMgmt.CourtMasterForm" %>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="x_panel">
                            ...
                            <head>
                                ...
                                <title>Court Section Master</title>
                                    <script language="javascript" type="text/javascript">
                                    function validationMsg() {

                                        if (document.getElementById('<%=txtCode.ClientID%>').value == '') {
                                            alert("Enter  Court Section Code");
                                              document.getElementById("<% =txtCode.ClientID%>").focus();
                                            return false;
                                          
                                        }
                                        if (document.getElementById('<%=txtName.ClientID%>').value == '') {
                                            alert("Enter  Court Section Name");
                            ...
                            <body>
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                        ...
                                        <asp:TextBox ID="txtName"  AutoPostBack="true" class="form-control"  Height="30px" Width="250px" AutoComplete="off" data-toggle="tooltip" data-placement="right" title="Name" runat="server" MaxLength="100"></asp:TextBox>
                                    </div>
