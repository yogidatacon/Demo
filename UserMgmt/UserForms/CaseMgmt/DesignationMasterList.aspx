<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="DesignationMasterList.aspx.cs" Inherits="UserMgmt.DesignationMasterList" %>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="x_panel">
                            ...
                            <head>
                                ...
                                <title>Designation  Master List</title>
                                 <script>
                                    $(function () {
                                        $(".ddlsearch1s").change(function () {
                                            if ($(this).find('option:selected').text() == "1") {
                                                ...
                                                $('#BodyContent_DesignationMasterView_txtSearch2').val('');
                                            }
                                        });
                                    });
                                 ...
                                 <script language="javascript" type="text/javascript">
                                    function validationMsg() {
                                        debugger;;
                                        if ($("#BodyContent_DesignationMasterView_ddlsearch1").val() == 'Select') {
                                            alert("select search column!");
                                            $("#BodyContent_DesignationMasterView_ddlsearch1").focus();
                                            return false;
                                        }
                                        if ($("#BodyContent_DesignationMasterView_txtSearch2").val() == '') {
                                            alert("Enter search column Value!");
                                            $("#BodyContent_DesignationMasterView_txtSearch2").focus();
                                            return false;
                                        }
                                    }
                                    </script> 
                            ...
                            <body>
                                ...
                                <div class="x_content">
                                     <asp:GridView  ID="DesignationMasterView"  runat="server" AutoGenerateColumns="false"   AllowPaging="true" OnDataBound="DesignationMasterView_DataBound" OnPageIndexChanging="DesignationMasterView_PageIndexChanging" 
                                          ...
                                          <PagerSettings FirstPageImageUrl="~/img/icons8-first-50.png" 
                                                        ...
                                                        <PagerTemplate>
                                                            <asp:DropDownList ID="ddlsearch1" runat="server" Width="150px" 
                                                                Font-Bold="true" Height="25px"  CssClass="ddlsearch1s"
                                                                ForeColor="Black" Font-Size="12px" style="float:left">
                                               <asp:ListItem Text="Select" Value="Select"></asp:ListItem>
                                                <asp:ListItem Text="Designation Code" Value="designation_code"></asp:ListItem>
                                                <asp:ListItem Text="Designation Name" Value="designation_name"></asp:ListItem>
                                                  <asp:ListItem Text="Designation Type" Value="designation_type_name"></asp:ListItem>
                                                            </asp:DropDownList> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  
                        ...
                        ID="btnLast" runat="server" CommandArgument="Last" Width="30px" Visible="false" Height="20px" BackColor="Blue" CommandName="Page" ImageUrl="~/img/icons8-last-50.png" />
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="Code" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblCode" runat="server" Visible="true"  Text='<%#Eval("designation_code") %>' ></asp:Label>
                                                                   
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Name" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblName" runat="server" Visible="true"  Text='<%#Eval("designation_name") %>' ></asp:Label>
                                                                   
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                             <asp:TemplateField HeaderText="Designation Type" ItemStyle-Font-Bold="true" ItemStyle-Width="20px" Visible="false">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblDesignationType" runat="server" Visible="true"  Text='<%#Eval("designation_type_code") %>' ></asp:Label>
                                                                   
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                              <asp:TemplateField HeaderText="Designation Type" ItemStyle-Font-Bold="true" ItemStyle-Width="20px" >
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblDesignationName" runat="server" Visible="true"  Text='<%#Eval("designation_type_name") %>' ></asp:Label>
                                                             ...
                                                             <asp:TemplateField HeaderText="ID" ItemStyle-Font-Bold="true" ItemStyle-Width="20px" Visible="false">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblId" runat="server" Visible="true"  Text='<%#Eval("designation_master_id") %>' ></asp:Label>
