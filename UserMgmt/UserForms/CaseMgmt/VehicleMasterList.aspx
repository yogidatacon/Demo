<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="VehicleMasterList.aspx.cs" Inherits="UserMgmt.VehicleMasterList" %>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="x_panel">
                                ...
                                <title>Vehicle Master List</title>
                                    ...
                                    $(function () {
                                        $(".ddlsearch1s").change(function () {
                                            if ($(this).find('option:selected').text() == "1") {
                                                ...
                                                $('#BodyContent_grdVehicleMasterList_txtSearch2').val('');
                                            }
                                        });
                                    });
                                 ...
                                 <script language="javascript" type="text/javascript">
                                    function validationMsg() {
                                        debugger;;
                                        if ($("#BodyContent_grdVehicleMasterList_ddlsearch1").val() == 'Select') {
                                            alert("select search column!");
                                            $("#BodyContent_grdVehicleMasterList_ddlsearch1").focus();
                                            return false;
                                        }
                                        if ($("#BodyContent_grdVehicleMasterList_txtSearch2").val() == '') {
                                            alert("Enter search column Value!");
                                            $("#BodyContent_grdVehicleMasterList_txtSearch2").focus();
                                            return false;
                                        }
                                    }
                                    </script>
                            ...
                            <body>
                                ...
                                <br />
                                <a>
                                    <asp:LinkButton runat="server" CssClass="myButton3 " Visible="false" ID="AddRecord" Style="float: right" OnClick="AddRecord_Click"><i class="fa fa-plus-circle"> ADD NEW RECORD</i></asp:LinkButton></a>
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="x_panel">
                                            <div class="x_title">
                                                <h2>Vehicle Master List</h2>
                                                <div class="clearfix"></div>
                                            </div>
                                            <div class="x_content">
                                                <asp:GridView ID="grdVehicleMasterList" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="10" OnDataBound="grdVehicleMasterList_DataBound" 
                                                    HeaderStyle-BackColor="#26b8b8" HeaderStyle-ForeColor="#ECF0F1" class="table table-striped responsive-utilities jambo_table" OnPageIndexChanging="grdVehicleMasterList_PageIndexChanging">
                                               ...
                                               <asp:ListItem Text="Select" Value="Select"></asp:ListItem>
                                                <asp:ListItem Text="Vehicle Code" Value="vehicle_type_code"></asp:ListItem>
                                                <asp:ListItem Text="Vehicle Name" Value="vehicle_type"></asp:ListItem>
                ...
                <asp:ImageButton ID="btnNext" Visible="false"
                    runat="server" CommandArgument="Next" Width="30px" Height="20px" CommandName="Page" ForeColor="Blue" BackColor="Blue" ImageUrl="~/img/icons8-next-50.png"  /> <asp:ImageButton
                        ID="btnLast" runat="server" CommandArgument="Last" Width="30px" Visible="false" Height="20px" BackColor="Blue" CommandName="Page" ImageUrl="~/img/icons8-last-50.png" />
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="Vehicle Type Code" Visible="true" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Vehicle Type" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblVehicleTypeName" runat="server" Visible="true" Text='<%#Eval("vehicle_type") %>' ></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                           <asp:TemplateField HeaderText="ID" ItemStyle-Font-Bold="true" ItemStyle-Width="20px" Visible="false">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblId" runat="server" Visible="true" Text='<%#Eval("vehicle_type_id") %>' ></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
