<%@ Page Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="User_Mgmt.aspx.cs" Inherits="UserMgmt.Uset_Mgmt" %>
                            ...
                            <body>
                                ...
                                <div>
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li class="active">
                                            <asp:LinkButton runat="server" ID="btnSCM" Text="SCM" Visible="true" OnClick="btnSCM_Click">
                                        <span style="color: #fff; font-size: 14px;">SCM Dash Board</span></asp:LinkButton></li>
                                         <li >
                                            <asp:LinkButton runat="server" ID="btnEA" Text="EA" Visible="true" OnClick="btnEA_Click">
                                    ...
                                    <div id="distdiv" runat="server">
                                            <div id="DWMolassesPurchasecharts" runat="server">
                                                <div class="container">
                                                    <h5 style="align-content: center">Molasses Purchase Vs Consumption</h5>
                                                    <div class="flex-item">
                                            ...
                                            <div id="DWAbsoluteAlcoholChart" runat="server">
                                                <div class="container">
                                                    <h5 style="align-content: center">Absolute Alcohol Production Vs Consumption</h5>
                                                    <div class="flex-item">
                                            ...
                                            <div id="DWEthanolCharts" runat="server">
                                                <div class="container">
                                                    <h5 style="align-content: center">Ethanol Production Vs Sale</h5>
                                                    <div class="flex-item">
