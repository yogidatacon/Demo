<%@ Page Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="workflowlist.aspx.cs" Inherits="UserMgmt.workflowlist" %>
                                ...
                                <title>User Management</title>
                                   <script>
                                    function chkDuplicateAccessTypeName() {
                                        debugger;
                                        var email = $('#BodyContent_grdWorkFlowDetailsList_txtSearch2').val();
                                        var jsondata = JSON.stringify($('#BodyContent_grdWorkFlowDetailsList_txtSearch2').val());
                                        $.ajax({
                                            type: "POST",
                                            //url: "UserRegistrationForm.aspx/chkDuplicateEmail",
                                            url: "workflowlist.aspx/chkDuplicateAccessTypeName",
                                            data: '{name:' + jsondata + '}',
                                    ...
                                    $(document).ready(function () {
                                        $('#BodyContent_grdWorkFlowDetailsList_ddlsearch1').change(function () {
                                            $('#BodyContent_grdWorkFlowDetailsList_txtSearch2').val('');
                                        });
                                    });
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="x_panel">
                                                ...
                                                <asp:UpdatePanel runat="server">
                                                    <ContentTemplate>
                                                <div class="x_content">
                                                    <asp:GridView ID="grdWorkFlowDetailsList" runat="server" AutoGenerateColumns="false"
                                                         OnDataBound="grdWorkFlowDetailsList_DataBound"  AllowPaging="true" 
                                                        OnPageIndexChanging="grdWorkFlowDetailsList_PageIndexChanging"
                                                         ...
                                                         <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Tab Name" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                             ...
                                                             <asp:TemplateField HeaderText="Role Name"  ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblrole_name" runat="server" Visible="true" Text= '<%#Eval("role_name") %>'  ></asp:Label>
                                                                   
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="User Name"  ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbluser_name" runat="server" Visible="true" Text= '<%#Eval("User_id") %>'  ></asp:Label>
                                                                   
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="District" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblDistrict" runat="server" Visible="true" Text='<%#Eval("District") %>'></asp:Label>
