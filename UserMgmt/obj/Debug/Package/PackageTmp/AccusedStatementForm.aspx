<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterCaseMgmt.Master" AutoEventWireup="true" CodeBehind="AccusedStatementForm.aspx.cs" Inherits="UserMgmt.AccusedStatementForm" %>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="x_panel">
                            ...
                            <head>
                                ...
                                <title>Accused Statement Form</title>
                                <script>
        ...
        return false; 
                                    ...
                                    function validationMsg() {
                                       ...
                                       if (document.getElementById('<%=txtPRFIRNo.ClientID%>').value == '') {
                                        ...
                                        <%--if (document.getElementById('<%=txtChargesheetundersection.ClientID%>').value == '') {
                                          ...
                                          if (document.getElementById('<%=txtAccusedStatementDate.ClientID%>').value == '') {
                                              alert("Enter Accused Statement Date");
                                            document.getElementById("<% =txtAccusedStatementDate.ClientID%>").focus();
                                            return false;
                                          }
                                       ...
                                       <%-- var Accused_Statement_Date = document.getElementById('<%=txtAccusedStatementDate.ClientID%>').value;
                                        ...
                                        if (Accused_Statement_Date != '' && Nexthearing_Date != '' && Accused_Statement_Date > Nexthearing_Date) {
                                            alert("Please ensure that the Nexthearing Date  is greater than or equal to the Accused Statement Date .");
                                            return false;
                                        }--%>
                                    }
                                </script>
                            ...
                            <body>
                              ...
                              <%--   <div>
                                    <ul class="nav nav-tabs">
                                        <li >
                                            <asp:LinkButton runat="server" ID="btnCognizance" OnClick="btnCognizance_Click">
                                        <span style="color: #fff; font-size: 14px;">Cognizance </span></asp:LinkButton></li>
                                        <li >
                                            <asp:LinkButton runat="server" ID="btnAppearance" OnClick="btnAppearance_Click">
                                        <span style="color: #fff; font-size: 14px;">Appearance</span></asp:LinkButton></li>
                                        <li >
                                            <asp:LinkButton runat="server" ID="btnSupplyofPolicePaper" OnClick="btnSupplyofPolicePaper_Click">
                                        <span style="color: #fff; font-size: 14px;">Supply of Police Paper</span></asp:LinkButton></li>
                                        <li class="active">
                                            <asp:LinkButton runat="server" ID="btnChargedFrame" OnClick="btnChargedFrame_Click">
                                        <span style="color: #fff; font-size: 14px;">Framing Of Charges</span></asp:LinkButton></li>
                                        </ul></div> 
                            ...
                            <%--    <div style="float:right" class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                    ...
                                    <asp:Button ID="btnSearch" runat="server" Text="Search Sezuire No" CssClass="btn btn primary" />
                                </div>--%>
                                             </ContentTemplate>
                                    </asp:UpdatePanel>
                                      <div class="clearfix"></div>
                                    ...
                                    <asp:GridView ID="grdAccusedStatement" runat="server" AutoGenerateColumns="false" PageSize="10" AllowPaging="true" EmptyDataText="No Records" 
                                        HeaderStyle-BackColor="#26b8b8" HeaderStyle-ForeColor="#ECF0F1" class="table table-striped responsive-utilities jambo_table">
                                        <Columns>
                                            <asp:TemplateField HeaderText="Accused Statement Date" ItemStyle-Font-Bold="true"  ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblAccusedStatementDate" runat="server" Visible="false" Text='<%#Eval("") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Next Hearing Date" ItemStyle-Font-Bold="true" Visible="true" ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblNextHearingDate" runat="server" Visible="true" Text='<%#Eval("") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                ...
                                <a>
                                 ...
                                 <%--   <div class="col-md-3 col-sm-12 col-xs-12 form-inline ">
                                        ...
                                        <br />
                                        <asp:TextBox ID="txtChargesheetundersection" CssClass="form-control" runat="server"  data-toggle="tooltip" data-placement="right" title="Chargesheet under section"></asp:TextBox>
                                    </div>--%>
                                     <div class="col-md-3 col-sm-12 col-xs-12 form-inline">
                                                <label class="control-label" style="display:inline"><span style="color: red">*</span> Date of Accused Statement</label><br />
                                                <cc1:CalendarExtender runat="server" PopupButtonID="Image1" TargetControlID="txtAccusedStatementDate" Format="dd-MM-yyyy" ID="CalendarExtender1"></cc1:CalendarExtender>
                                                <asp:TextBox ID="txtAccusedStatementDate" onchange="chkDuplicateDates();" data-toggle="tooltip" data-placement="right" title="Date of Accused Statement" ReadOnly="false"  class="form-control validate[required]" onkeypress="return blockAllChar(event)" AutoComplete="off" runat="server" Font-Size="14px">
                                                </asp:TextBox>
                                     ...
                                     <div class="col-md-3 col-sm-12 col-xs-12 form-inline">
                                                ...
                                                <asp:TextBox ID="txtNexthearingDate" onchange="chkDuplicateDates();" data-toggle="tooltip" data-placement="right" title="Next hearing date" class="form-control validate[required]" ReadOnly="false" onkeypress="return blockAllChar(event)" AutoComplete="off" runat="server" Font-Size="14px">
                                                </asp:TextBox>
                                       ...
                                       <div class="col-md-6 col-sm-12 col-xs-12 form-inline">
                                             <div style =" width:1000px; overflow:auto;"> 
                                    <asp:GridView ID="grtxtAccusedStatement" runat="server" AutoGenerateColumns="false" PageSize="10" AllowPaging="true" EmptyDataText="No Records" 
                                        HeaderStyle-BackColor="#26b8b8" HeaderStyle-ForeColor="#ECF0F1" class="table table-striped responsive-utilities jambo_table">
                                        <Columns>
                                             ...
                                             <asp:TemplateField HeaderText="Accused Id" ItemStyle-Font-Bold="true"  ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblAccusedId" runat="server" Visible="false" Text='<%#Eval("") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                             <asp:TemplateField HeaderText="Accused Name" ItemStyle-Font-Bold="true"  ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblAccusedName" runat="server" Visible="false" Text='<%#Eval("") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                        <HeaderStyle BackColor="#26B8B8" ForeColor="#ECF0F1" BorderStyle="Solid" BorderWidth="2px" Height="25px" HorizontalAlign="Center"></HeaderStyle>
