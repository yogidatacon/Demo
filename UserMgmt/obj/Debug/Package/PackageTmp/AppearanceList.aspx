<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterCaseMgmt.Master" AutoEventWireup="true" CodeBehind="AppearanceList.aspx.cs" Inherits="UserMgmt.AppearanceList" %>
                        ...
                        <div class="x_panel">
                            ...
                            <body>
                                ...
                                <div class="x_content">
                                    ...
                                    <asp:GridView ID="grdAppearanceListView" runat="server" AutoGenerateColumns="false" PageSize="10" AllowPaging="true" EmptyDataText="No Records" 
                                        HeaderStyle-BackColor="#26b8b8" HeaderStyle-ForeColor="#ECF0F1" class="table table-striped responsive-utilities jambo_table" OnPageIndexChanging="grdAppearanceListView_PageIndexChanging">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Appearance Date" ItemStyle-Font-Bold="true"  ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblAppearanceDate" runat="server" Visible="true" Text='<%#Eval("currentstagedate") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
