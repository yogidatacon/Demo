<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="DailyDispatchClosureList.aspx.cs" Inherits="UserMgmt.DailyDispatchClosureList" %>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="x_panel">
                            ...
                            <head>
                                ...
                                <title>Daily Dispatch Closure List</title>
                                    <script>
                                    function chkDuplicateAccessTypeName() {
                                        debugger;
                                        var email = $('#BodyContent_grdDailyDispatchClosure_txtSearch2').val();
                                        var jsondata = JSON.stringify($('#BodyContent_grdDailyDispatchClosure_txtSearch2').val());
                                        $.ajax({
                                            type: "POST",
                                            //url: "UserRegistrationForm.aspx/chkDuplicateEmail",
                                            url: "DailyDispatchClosureList.aspx/chkDuplicateAccessTypeName",
                                            data: '{name:' + jsondata + '}',
                                    ...
                                    $(document).ready(function () {
                                        $('#BodyContent_grdDailyDispatchClosure_ddlsearch1').change(function () {
                                            $('#BodyContent_grdDailyDispatchClosure_txtSearch2').val('');
                                        });
                                    });
                            ...
                            <body>
                                ...
                                <div class="x_title">
                                    <h2>Daily Dispatch Closure List</h2>
                                    <div class="clearfix"></div>
                                     <asp:HiddenField ID="party_code" runat="server" />
                                </div>
                                <div class="x_content">
                                     <asp:GridView ID="grdDailyDispatchClosure" OnDataBound="grdDailyDispatchClosure_DataBound" runat="server"  AutoGenerateColumns="false" PageSize="10" AllowPaging="true"  EmptyDataText="No Records"  OnPageIndexChanging="grdDailyDispatchClosure_PageIndexChanging"
                                    ...
                                    <PagerSettings FirstPageImageUrl="~/img/icons8-first-50.png" 
                                               ...
                                               <asp:ListItem Text="Select" Value="Select"></asp:ListItem>
                                                <asp:ListItem Text="Closure Date" Value="closure_date"></asp:ListItem>
