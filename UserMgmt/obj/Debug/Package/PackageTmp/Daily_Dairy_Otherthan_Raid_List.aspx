<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Daily_Dairy_Otherthan_Raid_List.aspx.cs" Inherits="UserMgmt.Dairy_Daily_Otherthan_Raid_List" %>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="x_panel">
                            ...
                            <body>
                                ...
                                <div class="x_title">
                                    <h2>Daily Dairy Other than Raid Entry List</h2>
                                    <div class="clearfix"></div>
                                      ...
                                      <asp:GridView ID="grdRaidDetails" runat="server" AutoGenerateColumns="false" PageSize="10" AllowPaging="true" EmptyDataText="No Records" OnDataBound="grdRaidDetails_DataBound"
                                                        HeaderStyle-BackColor="#26b8b8" DataKeyNames="daily_dairy_otherthan_raid_id" HeaderStyle-ForeColor="#ECF0F1" class="table table-striped responsive-utilities jambo_table" OnPageIndexChanging="grdRaidDetails_PageIndexChanging" >
                        ...
                        ID="btnLast" runat="server" CommandArgument="Last" Width="30px" Visible="false" Height="20px" BackColor="Blue" CommandName="Page" ImageUrl="~/img/icons8-last-50.png" />
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Raid Date" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                             ...
                                                             <asp:TemplateField HeaderText="Intelligence Gathering" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                 <asp:Label ID="lblraidlocation" runat="server" Visible="true" Text='<%#Eval("intelligence_gathering") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                             <asp:TemplateField HeaderText="Petrolling" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                 <asp:Label ID="lblraiddistance" runat="server" Visible="true" Text='<%#Eval("petrolling") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                           
                                                            <asp:TemplateField HeaderText="vehicle Check" ItemStyle-Font-Bold="true" Visible="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblRaidleader" runat="server" Visible="true" Text='<%# Eval("vehicle_check")%>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Liquore Destruction" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblRecoveryStatus" runat="server" Visible="true" Text='<%#Eval("liquor_destruction")%>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                             <asp:TemplateField HeaderText="Witness Appeared in Court" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblWitness" runat="server" Visible="true" Text='<%#Eval("witness_appearance_in_court")%>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Status" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                              ...
                                                              <asp:TemplateField HeaderText="raidid" ItemStyle-Font-Bold="true" Visible="false" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblraidid" runat="server" Visible="true" Text='<%#Eval("daily_dairy_otherthan_raid_id") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
