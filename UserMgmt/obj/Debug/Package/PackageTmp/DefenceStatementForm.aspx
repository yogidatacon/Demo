<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterCaseMgmt.Master" AutoEventWireup="true" CodeBehind="DefenceStatementForm.aspx.cs" Inherits="UserMgmt.DefenceStatementForm" %>
                               ...
                               <script language="javascript" type="text/javascript">
                                    function validationMsg() {
                                      ...
                                      if (document.getElementById('<%=txtPRFIRNo.ClientID%>').value == '') {
                                          ...
                                          if (document.getElementById('<%=txtDefenceEvidenceDate.ClientID%>').value == '') {
                                              alert("Enter Defence Evidence Date");
                                            document.getElementById("<% =txtDefenceEvidenceDate.ClientID%>").focus();
                                            return false;
                                          }
                                       ...
                                       <%-- var Defence_Evidence_Date = document.getElementById('<%=txtDefenceEvidenceDate.ClientID%>').value;
                                        ...
                                        if (Defence_Evidence_Date != '' && Nexthearing_Date != '' && Defence_Evidence_Date > Nexthearing_Date) {
                                            alert("Please ensure that the Nexthearing Date  is greater than or equal to the Defence Evidence Date .");
                                            return false;
                                        }--%>
                                ...
                                <div class="x_title">
                                  ...
                                  <div class="x_content">
                                   ...
                                   <div class="col-md-3 col-sm-12 col-xs-12 form-inline">
                                     ...
                                     <div class="col-md-3 col-sm-12 col-xs-12 form-inline">
                                                <label class="control-label" style="display:inline"><span style="color: red">*</span> Defence Evidence Date</label><br />
                                                <cc1:CalendarExtender runat="server" PopupButtonID="Image1" TargetControlID="txtDefenceEvidenceDate" Format="dd-MM-yyyy" ID="CalendarExtender1"></cc1:CalendarExtender>
                                                <asp:TextBox ID="txtDefenceEvidenceDate" onchange="chkDuplicateDates();" data-toggle="tooltip" data-placement="right" title="Defence Evidence Date" class="form-control validate[required]" ReadOnly="false" AutoComplete="off" runat="server" Font-Size="14px">
                                                </asp:TextBox>
                                     ...
                                     <div class="col-md-3 col-sm-12 col-xs-12 form-inline">
                                                ...
                                                <asp:TextBox ID="txtNexthearingDate" onchange="chkDuplicateDates();" data-toggle="tooltip" data-placement="right" title="Next Hearing Date" class="form-control validate[required]" ReadOnly="false" AutoComplete="off" runat="server" Font-Size="14px">
                                                </asp:TextBox>
