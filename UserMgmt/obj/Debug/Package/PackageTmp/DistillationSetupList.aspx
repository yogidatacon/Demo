<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="DistillationSetupList.aspx.cs" Inherits="UserMgmt.DistillationSetupList" %>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="x_panel">
                            ...
                            <head>
                                ...
                                <title>Distillation Setup List</title>
                                   <script>
                                    function chkDuplicateAccessTypeName() {
                                        debugger;
                                        var email = $('#BodyContent_grdDistillationSetup_txtSearch2').val();
                                        var jsondata = JSON.stringify($('#BodyContent_grdDistillationSetup_txtSearch2').val());
                                        $.ajax({
                                            type: "POST",
                                            //url: "UserRegistrationForm.aspx/chkDuplicateEmail",
                                            url: "DistillationSetupList.aspx/chkDuplicateAccessTypeName",
                                            data: '{name:' + jsondata + '}',
                                    ...
                                    $(document).ready(function () {
                                        $('#BodyContent_grdDistillationSetup_ddlsearch1').change(function () {
                                            $('#BodyContent_grdDistillationSetup_txtSearch2').val('');
                                        });
                                    });
                            ...
                            <body>
                                <div>
                                 ...
                                 <div>
                                    <ul class="nav nav-tabs">
                                         <li >
                                            <asp:LinkButton runat="server" ID="LinkButton1" Text="Seizure List" OnClick="btnfermenter_Click" >
                                ...
                                <div class="x_title">
                                    <h2>Distillation Setup List</h2>
                                    <div class="clearfix"></div>
                                </div>
                                <div >
                                    <asp:GridView ID="grdDistillationSetup" OnDataBound="grdDistillationSetup_DataBound" runat="server" AutoGenerateColumns="false" PageSize="10" AllowPaging="true" EmptyDataText="No Records" OnPageIndexChanging="grdDistillationSetup_PageIndexChanging"
                                             ...
                                             <asp:DropDownList ID="ddlsearch1" runat="server" Width="150px" Font-Bold="true" Height="25px" ForeColor="Black" Font-Size="12px" style="float:left">
                                               <asp:ListItem Text="Select" Value="Select"></asp:ListItem>
                                                <asp:ListItem Text="Party Name" Value="party_name"></asp:ListItem>
                                                  <asp:ListItem Text="Distillation Date" Value="distillation_date"></asp:ListItem>
                                                   <asp:ListItem Text="Setup Date" Value="setup_date"></asp:ListItem>
                ...
                <asp:ImageButton ID="btnNext" Visible="false"
                    runat="server" CommandArgument="Next" Width="30px" Height="20px" CommandName="Page" ForeColor="Blue" BackColor="Blue" ImageUrl="~/img/icons8-next-50.png"  /> <asp:ImageButton
                        ID="btnLast" runat="server" CommandArgument="Last" Width="30px" Visible="false" Height="20px" BackColor="Blue" CommandName="Page" ImageUrl="~/img/icons8-last-50.png" />
                                        ...
                                        <Columns>
                                             <asp:TemplateField HeaderText="Distillation Id " ItemStyle-Font-Bold="true" Visible="false" ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblDistillationID" runat="server" Visible="false" Text='<%#Eval("distillation_id") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Distillation Date " ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblDistillationDate" runat="server" Visible="true" Text='<%#Eval("distillation_date") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Date of Setup" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblDateofSetup" runat="server" Visible="true" Text='<%#Eval("setup_date") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="To Fermenter VAT" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                              ...
                                              <asp:TemplateField HeaderText="Molasses" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblMolasses" runat="server" Visible="true" Text='<%#Eval("total_qty_transferred") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                           <asp:TemplateField HeaderText="rawmaterial_fermenter_id" ItemStyle-Font-Bold="true" ItemStyle-Width="20px" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblrawmaterialfermenterid" runat="server" Visible="true" Text='<%#Eval("rawmaterial_fermenter_id") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
