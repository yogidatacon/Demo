<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="FermentertoReceiverList.aspx.cs" Inherits="UserMgmt.FermentertoReceiverList" %>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="x_panel">
                            ...
                            <head>
                                ...
                                <title>Fermenter to Receiver List</title>
                                    <script>
                                    function chkDuplicateAccessTypeName() {
                                        debugger;
                                        var email = $('#BodyContent_grdFermentertoReceiver_txtSearch2').val();
                                        var jsondata = JSON.stringify($('#BodyContent_grdFermentertoReceiver_txtSearch2').val());
                                        $.ajax({
                                            type: "POST",
                                            //url: "UserRegistrationForm.aspx/chkDuplicateEmail",
                                            url: "FermentertoReceiverList.aspx/chkDuplicateAccessTypeName",
                                            data: '{name:' + jsondata + '}',
                                    ...
                                    $(document).ready(function () {
                                        $('#BodyContent_grdFermentertoReceiver_ddlsearch1').change(function () {
                                            $('#BodyContent_grdFermentertoReceiver_txtSearch2').val('');
                                        });
                                    });
                            ...
                            <body>
                                ...
                                <div class="x_title">
                                    <h2>Fermenter to Receiver List</h2>
                                    <div class="clearfix"></div>
                                     <asp:HiddenField ID="party_code" runat="server" />
                                </div>
                                <div>
                                     
                                    <asp:GridView ID="grdFermentertoReceiver" OnDataBound="grdFermentertoReceiver_DataBound" runat="server" AutoGenerateColumns="false" PageSize="10" AllowPaging="true" EmptyDataText="No Records" OnPageIndexChanging="grdFermentertoReceiver_PageIndexChanging"
                                        ...
                                        <PagerSettings FirstPageImageUrl="~/img/icons8-first-50.png" 
                                               ...
                                               <asp:ListItem Text="Select" Value="Select"></asp:ListItem>
                                                <asp:ListItem Text="Gauged Date" Value="gauged_date"></asp:ListItem>
                ...
                <asp:ImageButton ID="btnNext" Visible="false"
                    runat="server" CommandArgument="Next" Width="30px" Height="20px" CommandName="Page" ForeColor="Blue" BackColor="Blue" ImageUrl="~/img/icons8-next-50.png"  /> <asp:ImageButton
                        ID="btnLast" runat="server" CommandArgument="Last" Width="30px" Visible="false" Height="20px" BackColor="Blue" CommandName="Page" ImageUrl="~/img/icons8-last-50.png" />
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="Gauged Date" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblDate" runat="server" Visible="true" Text='<%#Eval("gauged_date") %>'></asp:Label>
                                            ...
                                            <asp:TemplateField HeaderText="fermenter_receiver_id" Visible="false" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblfermenterreceiverid" runat="server" Visible="true" Text='<%#Eval("fermenter_receiver_id") %>'></asp:Label>
