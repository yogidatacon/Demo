...
public class Handler : IHttpHandler
{
    ...
    private void GetChartData(ref DataTable dt)
    {
        ...
        using (NpgsqlConnection con = new NpgsqlConnection(connstring))
        {
            ...
            using (NpgsqlDataAdapter da = new NpgsqlDataAdapter("select record_status,count(1) as count from  exciseautomation.molasses_allotment_request group by record_status  order by record_status", cn))
            {
                // fill data table
                da.Fill(dt);
