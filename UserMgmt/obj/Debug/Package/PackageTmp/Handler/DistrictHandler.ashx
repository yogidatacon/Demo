...
public class Handler : IHttpHandler
{
    ...
    private string ProcessChartData(DataTable dt,string parentValue, string drillLevel, int maxLevel)
    {
        ...
        chartConfig.Add("caption", "Total Seizures by Thana- Till Date (  "+i.ToString()+" )"); // caption will change dynamically based on chart label
        chartConfig.Add("xAxisName",  parentValue ); // xaxis name will chnage dynamically based on chart label
