...
public class Handler : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        string[] levelValueMapping = new string[] {"Dristric","Thana", "createddate"};
    ...
    {
        string query;
        query = "select  TO_CHAR(createddate :: date, 'dd/mm/yyyy') as" + columnName + ", count(seizureno) as SeizureNoCount from exciseautomation.seizure_basicinfo group by " + columnName;
        return query;
    }
    private string BuildQuery(string columnName, string parentValue, string parentName)
    {
        string query;
        query = "select TO_CHAR(createddate :: date, 'dd/mm/yyyy') as" + columnName + ", count(seizureno) as SeizureNoCount from exciseautomation.seizure_basicinfo where " + parentName + "= '" + parentValue + "'Group by " + columnName;
        return query;
