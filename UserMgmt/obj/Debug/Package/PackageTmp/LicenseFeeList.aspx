<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="LicenseFeeList.aspx.cs" Inherits="UserMgmt.LicenseFeeList" %>
                                ...
                                <script>
                                    function chkDuplicateAccessTypeName() {
                                        ...
                                        $.ajax({
                                            ...
                                            url: "LicenseFeeList.aspx/chkDuplicateAccessTypeName",
                                            data: '{name:' + jsondata + '}',
                            ...
                            <body>
                                ...
                                <div class="x_content">
                                    <asp:GridView ID="grdLicenseList" runat="server"  AutoGenerateColumns="false"   AllowPaging="true" PageSize="10"  OnPageIndexChanging="grdProductList_PageIndexChanging" EmptyDataText="No Records"
                                                        HeaderStyle-BackColor="#26b8b8" HeaderStyle-ForeColor="#ECF0F1" OnDataBound="grdLicenseList_DataBound" CssClass="table table-striped responsive-utilities jambo_table">
                                    <PagerSettings FirstPageImageUrl="~/img/icons8-first-50.png" 
                                               ...
                                               <asp:ListItem Text="Select" Value="Select"></asp:ListItem>
                                                                  <asp:ListItem Text="License Fee Code" Value="lic_fee_code"></asp:ListItem>
                        ...
                        ID="btnLast" runat="server" CommandArgument="Last" Width="30px" Visible="false" Height="20px" BackColor="Blue" CommandName="Page" ImageUrl="~/img/icons8-last-50.png" />
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="License  Sub Type Name" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                              ...
                                                              <asp:TemplateField HeaderText="License Fee " ItemStyle-Font-Bold="true" Visible="false" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblLicensefeeid" runat="server" Visible="true" Text='<%#Eval("lic_fee_master_id") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
