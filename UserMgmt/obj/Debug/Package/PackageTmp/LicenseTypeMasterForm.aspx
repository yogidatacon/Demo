<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="LicenseTypeMasterForm.aspx.cs" Inherits="UserMgmt.LicenseTypeMasterForm" %>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="x_panel">
                            ...
                            <head>
                                ...
                                <title>License Type Master</title>
                                <script language="javascript" type="text/javascript">
                                    function validationMsg() {
                                         if (document.getElementById('<%=txtcode.ClientID%>').value == '') {
                                              alert("Enter License Type  Code");
                                ...
                                <script>
                                    function chkDuplicateUOMName() {
                                        ...
                                        $.ajax({
                                            ...
                                            url: "LicenseTypeMasterForm.aspx/chkDuplicateUOMName",
                                            data: '{name:' + jsondata + '}',
                                            ...
                                            success: function (msg) {
                                                ...
                                                if (parseInt(msg.d) > 0) {
                                                    alert("License Type Name is already exists");
                                    ...
                                    function chkDuplicateUOMCode() {
                                        ...
                                        $.ajax({
                                            type: "POST",
                                            //url: "UserRegistrationForm.aspx/chkDuplicateEmail",
                                            url: "LicenseTypeMasterForm.aspx/chkDuplicateUOMCode",
                                            data: '{code:' + jsondata + '}',
                                            datatype: "application/json",
                                            contentType: "application/json; charset=utf-8",
                                            cache: false,
                                            ...
                                            success: function (msg) {
                                                ...
                                                if (parseInt(msg.d) > 0) {
                                                    alert("Liense Code is already exists");
                            ...
                            <body>
                                ...
                                <div class="x_title">
                                    <h2>License Type Form</h2>
                                    <div class="clearfix"></div>
                                </div>
                                       <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                        <label style="font-size: small"><span style="color: red">*</span>License Type Code</label><br />
