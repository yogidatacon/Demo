<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="MNT_ConsumptionList.aspx.cs" Inherits="UserMgmt.MNT_ConsumptionList" %>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="x_panel">
                            ...
                            <head>
                                ...
                                <title>MNTP Consumption List</title>
                            </head>
                            <body>
                                <div>
                                ...
                                <asp:LinkButton runat="server" OnClick="btnAddRecord_Click" CssClass="myButton3 " ID="btnAddRecord"    Style="float: right"><i class="fa fa-plus-circle"> ADD NEW RECORD</i></asp:LinkButton>
                                <div class="x_title">
                                    <h2>M & TP Consumption List</h2>
                                ...
                                <div class="x_content">
                                    ...
                                    <asp:GridView ID="grdConsumptionList" runat="server" AutoGenerateColumns="false" PageSize="10" AllowPaging="true" EmptyDataText="No Records"  
                                        HeaderStyle-BackColor="#26b8b8" HeaderStyle-ForeColor="#ECF0F1" 
                                        class="table table-striped responsive-utilities jambo_table" OnRowDataBound="grdConsumptionList_RowDataBound" 
                                        OnPageIndexChanging="grdConsumptionList_PageIndexChanging">

                                        <Columns>
                                            <asp:TemplateField HeaderText="Id" ItemStyle-Font-Bold="true"  ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblconsumption_no" runat="server"  Text='<%#Eval("consumption_no") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Consumption Date" ItemStyle-Font-Bold="true" Visible="true" ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblconsumption_date" runat="server" Visible="true" Text='<%#Eval("consumption_date") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Product" ItemStyle-Font-Bold="true" Visible="true" ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblProduct" runat="server" Visible="true" Text='<%#Eval("product_name") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Action" ItemStyle-Font-Bold="true" HeaderStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton Text="View"   CommandName="View" OnClick="btnView_Click"  ID="btnView" CssClass="myButton" runat="server" ><i class="fa fa-search-plus">
                                                    </i> 
                                                    </asp:LinkButton>
                                                    <asp:LinkButton Text="Edit"  ID="btnEdit" CssClass="myButton1" runat="server" OnClick="btnEdit_Click"  
                                                        CommandName="Edit" Visible='<%# Eval("record_status").ToString() == "A" ? false : true %>'><i class="fa fa-pencil-square-o"> 
                                                    </i> 
                                                    </asp:LinkButton>
