<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="MntpAlloctionRequestList.aspx.cs" Inherits="UserMgmt.MntpAlloctionRequestList" %>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Request Date" ItemStyle-Font-Bold="true" Visible="true" ItemStyle-Width="20px">
                                             ...
                                             <asp:TemplateField HeaderText="party_code" ItemStyle-Font-Bold="true" Visible="false" ItemStyle-Width="20px">
                                              ...
                                              <asp:TemplateField HeaderText="From Distillery" ItemStyle-Font-Bold="true" Visible="true" ItemStyle-Width="20px">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Action" ItemStyle-Font-Bold="true" HeaderStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:LinkButton Text="Edit" ID="btnEdit" CssClass="myButton1" runat="server" Visible='<%# Eval("record_status").ToString() == "A" ? false:Eval("record_status").ToString() == "Y" ? false:Eval("record_status").ToString() == "R" ? false : Eval("record_status").ToString() == "I" ? false: Eval("record_status").ToString() == "B" ? false:true %>' CommandName="Edit" OnClick="btnEdit_Click"><i class="fa fa-pencil-square-o"> 
                                                    </i> 
                                                    </asp:LinkButton>
