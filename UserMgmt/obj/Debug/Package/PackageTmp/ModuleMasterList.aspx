<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="ModuleMasterList.aspx.cs" Inherits="UserMgmt.ModuleMasterList" %>
                                ...
                                <title>User Management</title>
                                 <script>
                                    function chkDuplicateAccessTypeName() {
                                        debugger;
                                        var email = $('#BodyContent_grdmodulemasterList_txtSearch2').val();
                                        var jsondata = JSON.stringify($('#BodyContent_grdmodulemasterList_txtSearch2').val());
                                        $.ajax({
                                            type: "POST",
                                            //url: "UserRegistrationForm.aspx/chkDuplicateEmail",
                                            url: "ModuleMasterList.aspx/chkDuplicateAccessTypeName",
                                            data: '{name:' + jsondata + '}',
                            ...
                            <body>
                                <div>
                                   <ul class="nav nav-tabs">
                                    ...
                                    <br />
                                    <asp:LinkButton runat="server" CssClass="myButton3 " OnClick="AddRecords_Click" ID="AddRecord" Style="float: right" ><i class="fa fa-plus-circle"> ADD NEW RECORD</i></asp:LinkButton>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="x_panel">
                                                <div class="x_title">
                                                    ...
                                                    <h2>Module Master List</h2>
                                                    <div runat="server" visible="false"  style="float:right">
                                                         <asp:TextBox ID="txtSearch" runat="server" Width="250px" AutoComplete="off"   Height="30px" placeholder="Search Module Name"  AutoPostBack="true" OnTextChanged="txtSearch_TextChanged" ></asp:TextBox>
                                                ...
                                                <div class="x_content">
                                                    ...
                                                    <asp:GridView ID="grdmodulemasterList" runat="server" AutoGenerateColumns="false" PageSize="10" AllowPaging="true"  EmptyDataText="No Records" OnPageIndexChanging="grdmodulemasterList_PageIndexChanging"
                                                        HeaderStyle-BackColor="#26b8b8" OnDataBound="grdmodulemasterList_DataBound" HeaderStyle-ForeColor="#ECF0F1" class="table table-striped responsive-utilities jambo_table" >
                                               ...
                                               <asp:ListItem Text="Select" Value="Select"></asp:ListItem>
                                                <asp:ListItem Text="Module Code" Value="module_code"></asp:ListItem>
                    ...
                    runat="server" CommandArgument="Next" Width="30px" Height="20px" CommandName="Page" ForeColor="Blue" BackColor="Blue" ImageUrl="~/img/icons8-next-50.png"  /> <asp:ImageButton
                        ID="btnLast" runat="server" CommandArgument="Last" Width="30px" Visible="false" Height="20px" BackColor="Blue" CommandName="Page" ImageUrl="~/img/icons8-last-50.png" />
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Module Code " ItemStyle-Font-Bold="true" ItemStyle-Width="20px"> 
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblModuleCode" runat="server" Visible="true" Text='<%#Eval("module_code") %>'></asp:Label>
                                                            ...
                                                            <asp:TemplateField HeaderText="mns" Visible="false" ItemStyle-Font-Bold="true" ItemStyle-Width="20px"> 
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblmns" runat="server" Visible="true" Text='<%#Eval("mns_no") %>'></asp:Label>
