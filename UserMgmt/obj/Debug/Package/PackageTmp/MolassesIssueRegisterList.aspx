<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" ValidateRequest="false" AutoEventWireup="true" CodeBehind="MolassesIssueRegisterList.aspx.cs" Inherits="UserMgmt.MolassesIssueRegisterList" %>
                        ...
                        <div class="x_panel">
                            ...
                            <head>
                                ...
                                <title> Molasses Issue Register List</title>
                                    ...
                                    function chkDuplicateAccessTypeName() {
                                        debugger;
                                        var email = $('#BodyContent_grdMolassesIssueView_txtSearch2').val();
                                        var jsondata = JSON.stringify($('#BodyContent_grdMolassesIssueView_txtSearch2').val());
                                        $.ajax({
                                            type: "POST",
                                            //url: "UserRegistrationForm.aspx/chkDuplicateEmail",
                                            url: "MolassesIssueRegisterList.aspx/chkDuplicateAccessTypeName",
                                            data: '{name:' + jsondata + '}',
                                    ...
                                    $(document).ready(function () {
                                        $('#BodyContent_grdMolassesIssueView_ddlsearch1').change(function () {
                                            $('#BodyContent_grdMolassesIssueView_txtSearch2').val('');
                                        });
                                    });
                            ...
                            <body>
                                 <div>
                                  ...
                                  <a>
                                 <asp:LinkButton runat="server" CssClass="myButton3 " ID="btnAddRecord" OnClick="AddRecord_Click"   style="float:right" ><i class="fa fa-plus-circle"> ADD NEW RECORD</i></asp:LinkButton></a>
                                <div class="x_title">
                                    <h2>Molasses Issue Register List</h2>
                                ...
                                <div class="x_content">
                                    <asp:GridView ID="grdMolassesIssueView" OnDataBound="grdMolassesIssueView_DataBound" runat="server"  AutoGenerateColumns="false" PageSize="10" AllowPaging="true"  EmptyDataText="No Records" OnPageIndexChanging="grdMolassesIssueView_PageIndexChanging"
                                    ...
                                    <PagerSettings FirstPageImageUrl="~/img/icons8-first-50.png" 
                                               ...
                                               <asp:ListItem Text="Select" Value="Select"></asp:ListItem>
                                                <asp:ListItem Text="To Party Name" Value="party_name"></asp:ListItem>
                                                                <asp:ListItem Text="VAT Name" Value="vat_name"></asp:ListItem>
                                                                  <asp:ListItem Text="Entry Date" Value="mir_entrydate"></asp:ListItem>
                                                                           <asp:ListItem Text="Issued Pass No" Value="pass_issueno"></asp:ListItem>
                                                                   <asp:ListItem Text="Issued QTY" Value="issuedqty"></asp:ListItem>
                        ...
                        ID="btnLast" runat="server" CommandArgument="Last" Width="30px" Visible="false" Height="20px" BackColor="Blue" CommandName="Page" ImageUrl="~/img/icons8-last-50.png" />
                                                        ...
                                                        <Columns>
                                                          <asp:TemplateField HeaderText="Party Code" ItemStyle-Font-Bold="true" Visible="false" ItemStyle-Width="20px">
                                                            ...
                                                            <asp:TemplateField HeaderText="To Party Name" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="Entry Date" ItemStyle-Font-Bold="true" ItemStyle-Width="20px" >
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblEntryDate" runat="server" Visible="true" Text='<%#Eval("mir_entrydate") %>' ></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Issued Pass No" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblissuedpassno" runat="server" Visible="true" Text='<%#Eval("pass_issuedno") %>'  ></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Pass No" ItemStyle-Font-Bold="true" Visible="false" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblpassno" runat="server" Visible="true" Text='<%#Eval("passno") %>'  ></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                             <asp:TemplateField HeaderText="Issued QTY" ItemStyle-Font-Bold="true" Visible="true" ItemStyle-Width="20px" >
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblTodaysProduction" runat="server" Visible="true" Text='<%#Eval("issuedqty") %>' ></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                             <asp:TemplateField HeaderText="UOM" ItemStyle-Font-Bold="true" Visible="true" ItemStyle-Width="20px" >
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblUOM" runat="server" Visible="true" Text='<%#Eval("uom") %>' ></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                              <asp:TemplateField HeaderText="mirid" ItemStyle-Font-Bold="true" Visible="false" ItemStyle-Width="20px" >
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblmirid" runat="server" Visible="true" Text='<%#Eval("molassesissueregister_id") %>' ></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Action"     ItemStyle-Font-Bold="true" HeaderStyle-HorizontalAlign="Center" >
                                                                <ItemTemplate>
                                                                   ...
                                                                   <asp:LinkButton Text="Edit" id="btnEdit"  CssClass="myButton1"    runat="server" OnClick="btnEdit_Click"  CommandName="Edit" Visible='<%# Eval("record_status").ToString() == "A" ? false:Eval("record_status").ToString() == "Y" ? false : true %>'  ><i class="fa fa-pencil-square-o"> 
                                                                                    </i> 
                                                                            </asp:LinkButton>
                                                                </ItemTemplate>
