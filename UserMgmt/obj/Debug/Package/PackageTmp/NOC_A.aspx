<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin.Master" CodeBehind="NOC_A.aspx.cs" Inherits="UserMgmt.NOC_A" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyContent" runat="server">
                            ...
                            <body>
                                   <div>
                                    <ul class="nav nav-tabs">
                                       <li >
                                            <asp:LinkButton ID="btn_P" runat="server" OnClick="btn_P_Click" ><span style="color:#fff;font-size:14px;">NOC Application Pending List</span></asp:LinkButton></li>
                                         <li >
                                            <asp:LinkButton ID="btn_R" runat="server" OnClick="btn_R_Click" ><span style="color:#fff;font-size:14px;">NOC Application ReferBack List</span></asp:LinkButton></li>
                                         <li class="active">
                                            <asp:LinkButton ID="btn_A" runat="server" OnClick="btn_A_Click" ><span style="color:#fff;font-size:14px;">NOC Application Approved List</span></asp:LinkButton></li>
                                         <li >
                                            <asp:LinkButton ID="btn_I" runat="server" OnClick="btn_I_Click" ><span style="color:#fff;font-size:14px;">NOC Application Issued List</span></asp:LinkButton></li>
                                ...
                                <div class="x_title">
                                    <h2>NOC Application Approved List</h2>
                                    <div class="clearfix"></div>
                                </div>
 <div class="col-md-4 col-sm-12 col-xs-12 form-inline" id="passfor" runat="server">
               &nbsp; <label class="control-label" style="display:inline"><span style="color:red">*</span>Product Name</label> <br />                                          
                                          &nbsp;  <asp:DropDownList ID="ddproduct" AutoPostBack="true" runat="server" data-toggle="tooltip" data-placement="right" Width="230px" title="product" OnTextChanged="ddproduct_TextChanged" CssClass="form-control" style="">
                                           ...
                                           <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Customer Name" ItemStyle-Font-Bold="true" Visible="true" ItemStyle-Width="18px">
                                                <ItemTemplate>
                                                 ...
                                                 <asp:TemplateField HeaderText="financialyear" ItemStyle-Font-Bold="true" Visible="true" ItemStyle-Width="18px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblfinancialyear" Font-Size="Smaller"  runat="server" Visible="true" Text='<%#Eval("financial_year") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
