<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin.Master" CodeBehind="NOC_P.aspx.cs" Inherits="UserMgmt.NOC_P" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyContent" runat="server">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="x_panel">
                            ...
                            <body>
                                ...
                                <div class="x_title">
                                    <h2>NOC Application Pending List</h2>
                                    <div class="clearfix"></div>
                                </div>
 <div class="col-md-4 col-sm-12 col-xs-12 form-inline" id="passfor" runat="server">
               &nbsp; <label class="control-label" style="display:inline"><span style="color:red">*</span>Product Name</label> <br />                                          
                                          &nbsp;  <asp:DropDownList ID="ddproduct" AutoPostBack="true" runat="server" data-toggle="tooltip" Width="230px" data-placement="right" title="product" OnTextChanged="ddproduct_TextChanged" CssClass="form-control" style="">
