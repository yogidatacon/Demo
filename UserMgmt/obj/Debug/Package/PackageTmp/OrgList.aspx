<%@ Page Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="OrgList.aspx.cs" Inherits="UserMgmt.OrgList" %>
                            ...
                            <head>
                                <title>User Management</title>
                                    ...
                                    function chkDuplicateAccessTypeName() {
                                        debugger;
                                        var email = $('#BodyContent_OrgListView_txtSearch2').val();
                                        var jsondata = JSON.stringify($('#BodyContent_OrgListView_txtSearch2').val());
                                        $.ajax({
                                            type: "POST",
                                            //url: "UserRegistrationForm.aspx/chkDuplicateEmail",
                                            url: "OrgList.aspx/chkDuplicateAccessTypeName",
                                            data: '{name:' + jsondata + '}',
                                    ...
                                    $(document).ready(function () {
                                        $('#BodyContent_OrgListView_ddlsearch1').change(function () {
                                            $('#BodyContent_OrgListView_txtSearch2').val('');
                                        });
                                    });
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="x_panel">
                                                <div class="x_title">
                                                    ...
                                                    <h2>Organisation List</h2>
                                                     <div runat="server" visible="false"   style="float:right">
                                                         <asp:TextBox ID="txtSearch" runat="server" Width="250px" AutoComplete="off"   Height="30px" placeholder="Search Organisation Name"  AutoPostBack="true" OnTextChanged="txtSearch_TextChanged" ></asp:TextBox>
                                                    ...
                                                    <ContentTemplate>
                                                <div class="x_content">
                                                    <asp:GridView ID="OrgListView" runat="server" AutoGenerateColumns="false" PageSize="10" AllowPaging="true" OnPageIndexChanging="grdMF2List_PageIndexChanging"
                                                        HeaderStyle-BackColor="#26b8b8" OnDataBound="OrgListView_DataBound" HeaderStyle-ForeColor="#ECF0F1" class="table table-striped responsive-utilities jambo_table" HeaderStyle-HorizontalAlign="Center">
                                             ...
                                             <asp:DropDownList ID="ddlsearch1" runat="server" Width="150px" Font-Bold="true" Height="25px" ForeColor="Black" Font-Size="12px" style="float:left">
                                               ...
                                               <asp:ListItem Text="Org Name" Value="org_name"></asp:ListItem>
                                                <asp:ListItem Text="Org Type" Value="org_type"></asp:ListItem>
                                                 <asp:ListItem Text="Description" Value="org_desc"></asp:ListItem>
                                                <asp:ListItem Text="Address" Value="org_address"></asp:ListItem>
                ...
                <asp:ImageButton ID="btnNext" Visible="false"
                    runat="server" CommandArgument="Next" Width="30px" Height="20px" CommandName="Page" ForeColor="Blue" BackColor="Blue" ImageUrl="~/img/icons8-next-50.png"  /> <asp:ImageButton
                        ID="btnLast" runat="server" CommandArgument="Last" Width="30px" Visible="false" Height="20px" BackColor="Blue" CommandName="Page" ImageUrl="~/img/icons8-last-50.png" />
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="Org Name" ItemStyle-Font-Bold="true" ItemStyle-Width="20px" HeaderStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblOrgName" runat="server" Visible="true" Text='<%#Eval("org_name") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Org Type" HeaderStyle-HorizontalAlign="Center" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblOrgType" runat="server" Visible="true" Text='<%#Eval("org_type") %>'></asp:Label>

                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Description" HeaderStyle-HorizontalAlign="Center" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblDescription" runat="server" Visible="true" Text='<%#Eval("org_desc") %>'></asp:Label>

                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Address" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblAddress" runat="server" Visible="true" Text='<%#Eval("org_address") %>'></asp:Label>
                                                            ...
                                                            <asp:TemplateField HeaderText="Action" ItemStyle-Font-Bold="true" HeaderStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton Text="View" ID="btnView" CssClass="myButton" runat="server" CommandArgument='<%# Bind("org_id") %>' CommandName="View" OnClick="btnView_Click"><i class="fa fa-search-plus">
                                                                                    </i> 
                                                                    </asp:LinkButton>
                                                                    <asp:LinkButton Text="Edit" ID="btnEdit" CssClass="myButton1" runat="server" CommandArgument='<%# Bind("org_id") %>' CommandName="Edit" OnClick="btnEdit_Click"><i class="fa fa-pencil-square-o"> 
                                                                                    </i> 
                                                                    </asp:LinkButton>
                                                                </ItemTemplate>
