<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="PassForm.aspx.cs" Inherits="UserMgmt.PassForm" %>
                                ...
                                <script  type="text/javascript">
                                    function validationMsg() {
                                       ...
                                       if (document.getElementById('<%=txtQtyDispatch.ClientID%>').value == '') {
                                        ...
                                        if (balance < dispatch) {
                                            alert("Dispatch qty not Morethan of Balance Qty");
                                            $('#BodyContent_txtQtyDispatch').val('');
                                            $('#BodyContent_txtQtyDispatch').focus();
                                            return false;
                                        }
                                        if (dispatch<=0) {
                                            alert("Dispatch qty not  Zero not Allowed");
                                            $('#BodyContent_txtQtyDispatch').val('');
                                            $('#BodyContent_txtQtyDispatch').focus();
                                            return false;
                                        }
                                   ...
                                   //     var available = parseFloat(available1) - parseFloat(reserved);
                                    ...
                                    if (balance < dispatch)
                                    {
                                        alert("Dispatch qty not  Morethan of Requested Qty");
                                        $('#BodyContent_txtQtyDispatch').val('');
                                        $('#BodyContent_txtQtyDispatch').focus();
                                        return ;
                                    }
                            ...
                            <body>
                                ...
                                <div class="x_content">
                                    ...
                                    <p>&nbsp;</p>
                                     <div style="display: none" class="col-md-3 col-sm-12 col-xs-12 form-inline">
                                       ...
                                       <%-- <asp:DropDownList ID="ddlPassRequestNo" re runat="server" CssClass="form-control"  data-toggle="tooltip" data-placement="right" title="Pass Request No"></asp:DropDownList>--%>
                                         <asp:TextBox ID="txtPassRequestNo" Width="80%" CssClass="form-control" runat="server" data-toggle="tooltip" data-placement="right" title="Pass Request No" ReadOnly="true"></asp:TextBox>
                                    </div>

                                    <div class="col-md-3 col-sm-12 col-xs-12 form-inline">
                                        <label id="ReleaseRequest" runat="server" class="control-label" style="display: inline"><span style="color: red">*</span>Release Request No</label>
                                  ...
                                  <%--      <asp:DropDownList ID="ddlReleaseRequestNo" runat="server" CssClass="form-control" Width="70%" data-toggle="tooltip" data-placement="right" title="Release Request No"></asp:DropDownList>--%>
                                    ...
                                    <div class="col-md-3 col-sm-12 col-xs-12 form-inline">
                                        <label id="ValidUpto" runat="server" class="control-label" style="display: inline"><span style="color: red">*</span>Valid Upto</label>
                                        <br />
                                     ...
                                     <div class="col-md-3 col-sm-12 col-xs-12 form-inline" id="issued" runat="server">
                                        ...
                                        <br />
                                        <asp:TextBox ID="txtpassissuedno" Width="85%" CssClass="form-control" runat="server" data-toggle="tooltip" data-placement="right" title="Pass Issued NO" ReadOnly="true"></asp:TextBox>
                                    </div>
                                     <div class="clearfix"></div>
                                    <p>&nbsp;</p>
                                    <div class="col-md-3 col-sm-12 col-xs-12 form-inline">
                                        <label class="control-label"  id="AllNo" runat="server" style="display: inline"><span style="color: red">*</span>Allotment Request No</label>
                                    ...
                                    <div class="col-md-3 col-sm-12 col-xs-12 form-inline">
                                        ...
                                        <br />
                                        <asp:TextBox ID="txtSupplierName" CssClass="form-control" Width="80%" runat="server" data-toggle="tooltip" data-placement="right" title="Supplier Name" ReadOnly="true"></asp:TextBox>
                                    </div>
                                    ...
                                    <div id="Depot" runat="server" class="col-md-3 col-sm-12 col-xs-12 form-inline">
                                        ...
                                        <br />
                                        <asp:TextBox ID="txtDepot" CssClass="form-control" Width="60%" runat="server" data-toggle="tooltip" data-placement="right" title="Depot"  ReadOnly="true"></asp:TextBox>
                                   ...
                                   <%-- <div class="col-md-3 col-sm-12 col-xs-12 form-inline">
                                    ...
                                    <div class="col-md-3 col-sm-12 col-xs-12 form-inline">
                                        ...
                                        <br />
                                        <asp:DropDownList ID="ddlDispatchType" runat="server"  CssClass="form-control" data-toggle="tooltip" data-placement="right" AutoPostBack="true" title="Dispatch Type" OnSelectedIndexChanged="ddlDispatchType_SelectedIndexChanged"></asp:DropDownList>
                                    </div>
                                    ...
                                    <div class="col-md-3 col-sm-12 col-xs-12 form-inline">
                                        ...
                                        <br />
                                        <asp:TextBox ID="txtQtyDispatch" onchange="CheckQTY()"  CssClass="form-control" runat="server" onkeypress="return onlyDotsAndNumbers(this,event);" data-toggle="tooltip" data-placement="right" title="Qty Dispatch"></asp:TextBox>
                                    </div>
                                    ...
                                    <div class="col-md-3 col-sm-12 col-xs-12 form-inline">
                                        ...
                                        <br />
                                             <asp:TextBox ID="txtVehicleNo" style="text-transform:uppercase;" CssClass="form-control" runat="server" data-toggle="tooltip" data-placement="right" title="Vehicle No" MaxLength="10"></asp:TextBox>
                                    </div>
                                    ...
                                    <div class="col-md-3 col-sm-12 col-xs-12 form-inline">
                                        ...
                                        <div class="col-md-5 col-sm-12 col-xs-12">
                                        <label class="control-label" style="display: inline"><span style="color: red">*</span>Route Details</label>
                                        <br />
                                        <asp:TextBox ID="txtRouteDetails" CssClass="form-control" runat="server" data-toggle="tooltip" data-placement="right" title="Route Details" TextMode="MultiLine"></asp:TextBox>
                                    </div>
                                             </div>
                                         <div class="clearfix"></div>
                                    <p>&nbsp;</p>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12 form-inline">
                                        ...
                                        <asp:LinkButton ID="btnSubmit" runat="server" OnClientClick="javascript:return validationMsg();" CssClass="btn btn-primary" OnClick="btnSubmit_Click">
                                         ...
                                         <asp:LinkButton ID="btnApprove" CssClass="btn btn-primary" OnClientClick="javascript:return validationMsg12()" runat="server" Style="width: 85px;" Text="Issue" OnClick="btnApprove_Click"/>
                                          <asp:LinkButton ID="btnupdate" runat="server" Visible="false" OnClientClick="javascript:return validationMsg1();" CssClass="btn btn-primary" OnClick="btnupdate_Click"><span aria-hidden="true" > </span>Submit</asp:LinkButton>
