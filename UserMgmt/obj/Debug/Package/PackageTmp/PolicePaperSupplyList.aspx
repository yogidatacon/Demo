<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterCaseMgmt.Master" AutoEventWireup="true" CodeBehind="PolicePaperSupplyList.aspx.cs" Inherits="UserMgmt.PolicePaperSupplyList" %>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="x_panel">
                            ...
                            <head>
                                ...
                                <title>Police Supply Paper List</title>
                            </head>
                            <body>
                                ...
                                <div class="x_title">
                                    <h2>Police Supply Paper List</h2>
                                    <div class="clearfix"></div>
                                </div>
                                ...
                                <div class="x_content">
                                    ...
                                    <asp:GridView ID="grdPoliceSupplyPaperListView" runat="server" AutoGenerateColumns="false" PageSize="10" AllowPaging="true" EmptyDataText="No Records" 
                                        HeaderStyle-BackColor="#26b8b8" HeaderStyle-ForeColor="#ECF0F1" class="table table-striped responsive-utilities jambo_table" OnPageIndexChanging="grdPoliceSupplyPaperListView_PageIndexChanging">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="PolicePaperSupplyDate" ItemStyle-Font-Bold="true"  ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblPolicePaperSupplyDate" runat="server" Visible="true" Text='<%#Eval("currentstagedate") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
