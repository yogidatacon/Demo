<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="RawMaterialList.aspx.cs" Inherits="UserMgmt.RawMaterialList" %>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="x_panel">
                            ...
                            <head>
                                ...
                                <title>Raw Material Master List</title>
                                   <script>
                                    function chkDuplicateAccessTypeName() {
                                        debugger;
                                        var email = $('#BodyContent_grdRawMaterialMasterView_txtSearch2').val();
                                        var jsondata = JSON.stringify($('#BodyContent_grdRawMaterialMasterView_txtSearch2').val());
                                        $.ajax({
                                            type: "POST",
                                            //url: "UserRegistrationForm.aspx/chkDuplicateEmail",
                                            url: "RawMaterialList.aspx/chkDuplicateAccessTypeName",
                                            data: '{name:' + jsondata + '}',
                                    ...
                                    $(document).ready(function () {
                                        $('#BodyContent_grdRawMaterialMasterView_ddlsearch1').change(function () {
                                            $('#BodyContent_grdRawMaterialMasterView_txtSearch2').val('');
                                        });
                                    });
                            ...
                            <body>
                                <ul class="nav nav-tabs">
                                    ...
                                    <li >
                                     ...
                                     <li >  <asp:LinkButton ID="RawMaterialTypeMaster" OnClick="RawMaterialTypeMaster_Click" runat="server"><span style="color:#fff;font-size:14px;">Raw Material Type Master</span></asp:LinkButton></li>
                                        <li class="active">  <asp:LinkButton ID="RawMaterial" OnClick="RawMaterial_Click" runat="server"><span style="color:#fff;font-size:14px;">Raw Material</span></asp:LinkButton></li>
                                   <li>
                                ...
                                <div class="x_panel">
                                 <div class="x_title">
                                    ...
                                    <h2>Raw Material  Master List</h2>
                                     <div runat="server" visible="false"   style="float:right">
                                         <asp:TextBox ID="txtSearch" runat="server" Width="250px" AutoComplete="off"   Height="30px" placeholder="Search Raw Material Name"  AutoPostBack="true" OnTextChanged="txtSearch_TextChanged"></asp:TextBox>
                                ...
                                <asp:UpdatePanel runat="server">
                                                    <ContentTemplate>
                                <div class="x_content">
                                    <asp:GridView ID="grdRawMaterialMasterView" OnDataBound="grdRawMaterialMasterView_DataBound" runat="server"  AutoGenerateColumns="false" PageSize="10" AllowPaging="true"  EmptyDataText="No Records" OnPageIndexChanging="grdRawMaterialMasterView_PageIndexChanging"
                                        ...
                                        <PagerSettings FirstPageImageUrl="~/img/icons8-first-50.png" 
                                               ...
                                               <asp:ListItem Text="Select" Value="Select"></asp:ListItem>
                                                <asp:ListItem Text="Raw Material Type Name" Value="rawmaterial_type_name"></asp:ListItem>
                                                                 <%-- <asp:ListItem Text="Raw Material Code" Value="rawmaterial_code"></asp:ListItem>--%>
                                                                  <asp:ListItem Text="Raw Material Name" Value="rawmaterial_name"></asp:ListItem>
                                                                  <asp:ListItem Text="Uom Name" Value="uom_name"></asp:ListItem>
                ...
                <asp:ImageButton ID="btnNext" Visible="false"
                    runat="server" CommandArgument="Next" Width="30px" Height="20px" CommandName="Page" ForeColor="Blue" BackColor="Blue" ImageUrl="~/img/icons8-next-50.png"  /> <asp:ImageButton
                        ID="btnLast" runat="server" CommandArgument="Last" Width="30px" Visible="false" Height="20px" BackColor="Blue" CommandName="Page" ImageUrl="~/img/icons8-last-50.png" />
                                        ...
                                        <Columns>
                                                          <asp:TemplateField HeaderText="Raw Material Type Code" ItemStyle-Font-Bold="true" Visible="false" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblRawMaterialTypeCode" runat="server" Visible="false" Text='<%#Eval("rawmaterial_type_code") %>'  ></asp:Label>
                                                                   
                                                                </ItemTemplate>
                                                            </asp:TemplateField>

                                                            <asp:TemplateField HeaderText="Raw Material Type Name" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblRawMaterialTypeName" runat="server" Visible="true" Text='<%#Eval("rawmaterial_type_name") %>'  ></asp:Label>
                                                                   
                                                                </ItemTemplate>
                                                            </asp:TemplateField>

                                                             <asp:TemplateField HeaderText="Raw Material Code" ItemStyle-Font-Bold="true" Visible="false" ItemStyle-Width="20px" >
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblRawMaterialCode" runat="server" Visible="false" Text='<%#Eval("rawmaterial_code") %>' ></asp:Label>
                                                                   
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                              <asp:TemplateField HeaderText="Raw Material Name" ItemStyle-Font-Bold="true" ItemStyle-Width="20px" >
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblRawMaterialName" runat="server" Visible="true" Text='<%#Eval("rawmaterial_name") %>' ></asp:Label>
                                                                   
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                              <asp:TemplateField HeaderText="UOMCode" ItemStyle-Font-Bold="true" Visible="false" ItemStyle-Width="20px" >
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblUOMCode" runat="server" Visible="false" Text='<%#Eval("uom_code") %>' ></asp:Label>
                                                                   
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                             <asp:TemplateField HeaderText="Producttypecode" ItemStyle-Font-Bold="true" Visible="false" ItemStyle-Width="20px" >
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblProducttypecode" runat="server" Visible="false" Text='<%#Eval("product_type_code") %>' ></asp:Label>
                                                             ...
                                                             <%-- <asp:TemplateField HeaderText="Description" ItemStyle-Font-Bold="true" ItemStyle-Width="20px" >
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblDescription" runat="server" Visible="true" Text='<%#Eval("rawmaterial_description") %>' ></asp:Label>
