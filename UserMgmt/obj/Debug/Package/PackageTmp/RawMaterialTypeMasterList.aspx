<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="RawMaterialTypeMasterList.aspx.cs" Inherits="UserMgmt.RawMaterialTypeMasterList" %>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="x_panel">
                            ...
                            <head>
                                ...
                                <title>Raw Material Type Master List</title>
                                   <script>
                                    function chkDuplicateAccessTypeName() {
                                        ...
                                        $.ajax({
                                            ...
                                            url: "RawMaterialTypeMasterList.aspx/chkDuplicateAccessTypeName",
                                            data: '{name:' + jsondata + '}',
                            ...
                            <body>
                                <ul class="nav nav-tabs">
                                    ...
                                    <li >
                                     ...
                                     <li class="active">  <asp:LinkButton ID="RawMaterialTypeMaster" OnClick="RawMaterialTypeMaster_Click" runat="server"><span style="color:#fff;font-size:14px;">Raw Material Type Master</span></asp:LinkButton></li>
                                ...
                                <div class="x_panel">
                                 <div class="x_title">
                                    ...
                                    <h2>Raw Material Type Master List</h2>
                                    <div runat="server" visible="false"   style="float:right">
                                                         <asp:TextBox ID="txtSearch" runat="server" Width="250px" AutoComplete="off"   Height="30px" placeholder="Search Raw Material Type Name"  AutoPostBack="true" OnTextChanged="txtSearch_TextChanged" ></asp:TextBox>
                                 ...
                                 <asp:UpdatePanel runat="server">
                                                    <ContentTemplate>
                                <div class="x_content">
                                    <asp:GridView ID="grdRawMaterialMasterView" OnDataBound="grdRawMaterialMasterView_DataBound" runat="server" 
                                         AutoGenerateColumns="false" PageSize="10" AllowPaging="true"  EmptyDataText="No Records" OnPageIndexChanging="grdRawMaterialMasterView_PageIndexChanging"
                                    ...
                                    <PagerSettings FirstPageImageUrl="~/img/icons8-first-50.png" 
                                               ...
                                               <asp:ListItem Text="Select" Value="Select"></asp:ListItem>
                                                                <%--  <asp:ListItem Text="Raw Material Type Code" Value="rawmaterial_type_code"></asp:ListItem>--%>
                ...
                <asp:ImageButton ID="btnNext" Visible="false"
                    runat="server" CommandArgument="Next" Width="30px" Height="20px" CommandName="Page" ForeColor="Blue" BackColor="Blue" ImageUrl="~/img/icons8-next-50.png"  /> <asp:ImageButton
                        ID="btnLast" runat="server" CommandArgument="Last" Width="30px" Visible="false" Height="20px" BackColor="Blue" CommandName="Page" ImageUrl="~/img/icons8-last-50.png" />
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="Raw Material Type Code" ItemStyle-Font-Bold="true" ItemStyle-Width="20px" Visible="false">
                                                                <ItemTemplate>
