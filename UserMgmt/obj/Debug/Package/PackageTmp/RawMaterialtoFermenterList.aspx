<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="RawMaterialtoFermenterList.aspx.cs" Inherits="UserMgmt.RawMaterialtoFermenterList" %>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="x_panel">
                            ...
                            <head>
                                ...
                                <title>RawMaterial to Fermenter List</title>
                                 <script>
                                    function chkDuplicateAccessTypeName() {
                                        debugger;
                                        var email = $('#BodyContent_grdFermenterSetup_txtSearch2').val();
                                        var jsondata = JSON.stringify($('#BodyContent_grdFermenterSetup_txtSearch2').val());
                                        $.ajax({
                                            type: "POST",
                                            //url: "UserRegistrationForm.aspx/chkDuplicateEmail",
                                            url: "RawMaterialtoFermenterList.aspx/chkDuplicateAccessTypeName",
                                            data: '{name:' + jsondata + '}',
                                    ...
                                    $(document).ready(function () {
                                        $('#BodyContent_grdFermenterSetup_ddlsearch1').change(function () {
                                            $('#BodyContent_grdFermenterSetup_txtSearch2').val('');
                                        });
                                    });
                            ...
                            <body>
                                ...
                                <div >
                                    <asp:GridView ID="grdFermenterSetup" OnDataBound="grdFermenterSetup_DataBound" runat="server" 
                                        AutoGenerateColumns="false" PageSize="10" AllowPaging="true" EmptyDataText="No Records" 
                                        HeaderStyle-BackColor="#26b8b8" HeaderStyle-ForeColor="#ECF0F1" class="table table-striped responsive-utilities jambo_table" 
                                        OnPageIndexChanging="grdFermenterSetup_PageIndexChanging" >
                                               ...
                                               <asp:ListItem Text="Select" Value="Select"></asp:ListItem>
                                                <asp:ListItem Text="Party Name" Value="party_name"></asp:ListItem>
                                                                <asp:ListItem Text="Setup Date" Value="setup_date"></asp:ListItem>
                                                                  ...
                                                                  <asp:ListItem Text="Molasses Total" Value="total_qty_transferred"></asp:ListItem>
                                                       ...
                                                       <span><asp:Button ID="Button2" runat="server" style="float:left; margin-left:10px"   Text="Search" CssClass="btn btn-primary" OnClick="btnsearch_Click" /></span> 
                                                             <span><asp:LinkButton ID="LinkButton5" runat="server" OnClick="Button1_Click" CssClass="btn btn-primary left"><i class="fa fa-refresh"> </i></asp:LinkButton></span> 
                ...
                <asp:ImageButton ID="btnNext" Visible="false"
                    runat="server" CommandArgument="Next" Width="30px" Height="20px" CommandName="Page" ForeColor="Blue" BackColor="Blue" ImageUrl="~/img/icons8-next-50.png"  /> <asp:ImageButton
                        ID="btnLast" runat="server" CommandArgument="Last" Width="30px" Visible="false" Height="20px" BackColor="Blue" CommandName="Page" ImageUrl="~/img/icons8-last-50.png" />
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="RawFermenterid" ItemStyle-Font-Bold="true" Visible="false" ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblid" runat="server" Visible="true" Text='<%#Eval("rawmaterial_fermenter_id") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                             <asp:TemplateField HeaderText="Party Name" ItemStyle-Font-Bold="true" Visible="true" ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblPartyname" runat="server" Visible="true" Text='<%#Eval("party_name") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Setup Date" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblDate" runat="server" Visible="true" Text='<%#Eval("setup_date") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText=" Molasses Total" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblMolasses" runat="server" Visible="true" Text='<%#Eval("total_qty_transferred") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                              <asp:TemplateField HeaderText="Setup Completed" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblSetupComplited" runat="server" Visible="true" Text='<%#Eval("setup_complete").ToString() == "Y" ? "Yes" :"No"%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
