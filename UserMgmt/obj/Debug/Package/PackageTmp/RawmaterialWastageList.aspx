<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="RawmaterialWastageList.aspx.cs" Inherits="UserMgmt.RawmaterialWastageList" %>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="x_panel">
                            ...
                            <head>
                                ...
                                <title>Raw Material Wastage & Adjustment List</title>
                                 <script>
                                    function chkDuplicateAccessTypeName() {
                                        ...
                                        $.ajax({
                                            ...
                                            url: "RawmaterialWastageList.aspx/chkDuplicateAccessTypeName",
                                            data: '{name:' + jsondata + '}',
                            ...
                            <body>
                                ...
                                <div class="x_title">
                                    <h2>Raw Material Wastage & Adjustment List </h2>
                                    <div class="clearfix"></div>
                                     <asp:HiddenField ID="party_code" runat="server" />
                                </div>
                                <div >
                                    <asp:GridView ID="grdFermenterSetup" OnDataBound="grdFermenterSetup_DataBound" runat="server" AutoGenerateColumns="false" PageSize="10" AllowPaging="true" EmptyDataText="No Records"
                                        HeaderStyle-BackColor="#26b8b8" HeaderStyle-ForeColor="#ECF0F1" class="table table-striped responsive-utilities jambo_table" OnPageIndexChanging="grdFermenterSetup_PageIndexChanging" >
                                       <PagerSettings FirstPageImageUrl="~/img/icons8-first-50.png" 
                                               ...
                                               <asp:ListItem Text="Select" Value="Select"></asp:ListItem>
                                                <asp:ListItem Text="Party Name" Value="party_name"></asp:ListItem>
                                                                <asp:ListItem Text="Date" Value="rmw_entrydate"></asp:ListItem>
                                                                  <%--<asp:ListItem Text="Setup Time" Value="setup_time"></asp:ListItem>--%>
                                                                           <asp:ListItem Text="VAT" Value="vat_name"></asp:ListItem>
                        ...
                        ID="btnLast" runat="server" CommandArgument="Last" Width="30px" Visible="false" Height="20px" BackColor="Blue" CommandName="Page" ImageUrl="~/img/icons8-last-50.png" />
                                         ...
                                         <Columns>
                                            <asp:TemplateField HeaderText="RawFermenterid" ItemStyle-Font-Bold="true" Visible="false" ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblid" runat="server" Visible="true" Text='<%#Eval("rawmaterial_wastage_id") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Date" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblDate" runat="server" Visible="true" Text='<%#Eval("rmw_entrydate") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                           <%-- <asp:TemplateField HeaderText="Setup Time " ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                            ...
                                            <asp:TemplateField HeaderText="VAT" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                <ItemTemplate>
