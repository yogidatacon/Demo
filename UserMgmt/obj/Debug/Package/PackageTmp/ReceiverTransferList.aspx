<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="ReceiverTransferList.aspx.cs" Inherits="UserMgmt.ReceiverTransferList" %>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="x_panel">
                                ...
                                <title>Transfer List</title>
                                  <script>
                                    function chkDuplicateAccessTypeName() {
                                        debugger;
                                        var email = $('#BodyContent_grdTransferList_txtSearch2').val();
                                        var jsondata = JSON.stringify($('#BodyContent_grdTransferList_txtSearch2').val());
                                        $.ajax({
                                            type: "POST",
                                            //url: "UserRegistrationForm.aspx/chkDuplicateEmail",
                                            url: "ReceiverTransferList.aspx/chkDuplicateAccessTypeName",
                                            data: '{name:' + jsondata + '}',
                                    ...
                                    $(document).ready(function () {
                                        $('#BodyContent_grdTransferList_ddlsearch1').change(function () {
                                            $('#BodyContent_grdTransferList_txtSearch2').val('');
                                        });
                                    });
                            ...
                            <body>
                                ...
                                <div class="x_content">
                                    <asp:GridView ID="grdTransferList" OnDataBound="grdTransferList_DataBound" runat="server"  AutoGenerateColumns="false" PageSize="10" AllowPaging="true"  EmptyDataText="No Records" OnPageIndexChanging="grdTransferList_PageIndexChanging"
                                    ...
                                    <PagerSettings FirstPageImageUrl="~/img/icons8-first-50.png" 
                                               ...
                                               <asp:ListItem Text="Select" Value="Select"></asp:ListItem>
                                                <asp:ListItem Text="Transfer Date" Value="transfer_date"></asp:ListItem>
                                                <asp:ListItem Text="Party Name" Value="party_name"></asp:ListItem>
                                                  <asp:ListItem Text="Storage VAT" Value="storagevat"></asp:ListItem> 
                                                   <asp:ListItem Text="Dispatch VAT" Value="dispatchvat"></asp:ListItem>
                                                   <asp:ListItem Text="Transfer Qty (BL)" Value="total_bl_transfer"></asp:ListItem>
                                                                  <asp:ListItem Text="Transfer Qty (LP)" Value="total_lp_transfer"></asp:ListItem>
                                                                         <%--  <asp:ListItem Text="Dispatch VAT" Value="dispatchvat"></asp:ListItem>
                        ...
                        ID="btnLast" runat="server" CommandArgument="Last" Width="30px" Visible="false" Height="20px" BackColor="Blue" CommandName="Page" ImageUrl="~/img/icons8-last-50.png" />
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="Transfer Date" ItemStyle-Font-Bold="true" ItemStyle-Width="20px" >
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblTransferDate" runat="server" Visible="true" Text='<%#Eval("transfer_date") %>' ></asp:Label>
                                                            ...
                                                            <asp:TemplateField HeaderText="Storagevat"  ItemStyle-Font-Bold="true" Visible="false" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblReceiverVAT" runat="server" Visible="true" Text='<%#Eval("fromstoragevat") %>'  ></asp:Label>
                                                                   
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Storage VAT" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblToStorageVAT" runat="server" Visible="true" Text='<%#Eval("storagevat") %>'  ></asp:Label>
                                                                   
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Dispatch VAT"   ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblDispatchVAT" runat="server" Visible="true" Text='<%#Eval("dispatchvat") %>'  ></asp:Label>
                                                                   
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                       <asp:TemplateField HeaderText="Transfer Qty (BL)" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblTransferQty" runat="server" Visible="true" Text='<%#Eval("total_bl_transfer") %>'  ></asp:Label>
                                                                   
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                             <asp:TemplateField HeaderText="Transfer Qty (Lp)" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblTransferQtylp" runat="server" Visible="true" Text='<%#Eval("total_lp_transfer") %>'  ></asp:Label>
                                                             ...
                                                             <asp:TemplateField HeaderText="form84id" Visible="false" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblform84id" runat="server" Visible="true" Text='<%#Eval("receiver_storage_transfer_id") %>'  ></asp:Label>
