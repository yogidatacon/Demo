<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="ReceivertoStorageList.aspx.cs" Inherits="UserMgmt.ReceivertoStorageList" %>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="x_panel">
                            ...
                            <head>
                                ...
                                <title>Receiver to Storage List</title>
                                   <script>
                                    function chkDuplicateAccessTypeName() {
                                        debugger;
                                        var email = $('#BodyContent_grdReceivertoStorage_txtSearch2').val();
                                        var jsondata = JSON.stringify($('#BodyContent_grdReceivertoStorage_txtSearch2').val());
                                        $.ajax({
                                            type: "POST",
                                            //url: "UserRegistrationForm.aspx/chkDuplicateEmail",
                                            url: "ReceivertoStorageList.aspx/chkDuplicateAccessTypeName",
                                            data: '{name:' + jsondata + '}',
                                    ...
                                    $(document).ready(function () {
                                        $('#BodyContent_grdReceivertoStorage_ddlsearch1').change(function () {
                                            $('#BodyContent_grdReceivertoStorage_txtSearch2').val('');
                                        });
                                    });
                            ...
                            <body>
                                ...
                                <div class="x_content">
                                    <asp:GridView ID="grdReceivertoStorage" OnDataBound="grdReceivertoStorage_DataBound" runat="server"  AutoGenerateColumns="false" PageSize="10" AllowPaging="true"  EmptyDataText="No Records" OnPageIndexChanging="grdReceivertoStorage_PageIndexChanging"
                                    ...
                                    <PagerSettings FirstPageImageUrl="~/img/icons8-first-50.png" 
                                               ...
                                               <asp:ListItem Text="Select" Value="Select"></asp:ListItem>
                                                ...
                                                <asp:ListItem Text="Party Name" Value="party_name"></asp:ListItem>
                                                  <asp:ListItem Text="Storage VAT" Value="vat_name"></asp:ListItem>
                        ...
                        ID="btnLast" runat="server" CommandArgument="Last" Width="30px" Visible="false" Height="20px" BackColor="Blue" CommandName="Page" ImageUrl="~/img/icons8-last-50.png" />
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Storagevat"  ItemStyle-Font-Bold="true" Visible="false" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblReceiverVAT" runat="server" Visible="true" Text='<%#Eval("to_storagevat") %>'  ></asp:Label>
                                                           ...
                                                           <%-- <asp:TemplateField HeaderText="Receiver VAT" Visible="false"  ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblReceiverVAT1" runat="server" Visible="true" Text='<%#Eval("from_receivervat") %>'  ></asp:Label>
                                                                   
                                                                </ItemTemplate>
                                                            </asp:TemplateField>--%>
                                                       <asp:TemplateField HeaderText="Receipt Qty (BL)" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblReceiptQty" runat="server" Visible="true" Text='<%#Eval("total_bl_receipt") %>'  ></asp:Label>
                                                                   
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                             <asp:TemplateField HeaderText="Receipt Qty (Lp)" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblReceiptQtylp" runat="server" Visible="true" Text='<%#Eval("total_lp_receipt") %>'  ></asp:Label>
                                                             ...
                                                             <asp:TemplateField HeaderText="form84id" Visible="false" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblform84id" runat="server" Visible="true" Text='<%#Eval("receiver_storage_receipt_id") %>'  ></asp:Label>
