<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin.master" CodeBehind="SEC_Registration_List.aspx.cs" Inherits="UserMgmt.SEC_Registration_List" %>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="x_panel">
                            ...
                            <head>
                                ...
                                <title>Case Registration List at Secretary Court for Vehicle / Property Under Prohibition Act</title>
                            ...
                            <body>
                                ...
                                <div class="x_title">
                                    <h2>Case Registration List at Secretary Court for Vehicle / Property Under Prohibition Act </h2>
                        ...
                        ID="btnLast" runat="server" CommandArgument="Last" Width="30px" Visible="false" Height="20px" BackColor="Blue" CommandName="Page" ImageUrl="~/img/icons8-last-50.png" />
                                                          ...
                                                          <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Appeal Status" ItemStyle-Font-Bold="true" Visible="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblAppealStatus" runat="server" Visible="true" Text='<%#Eval("hearing_status").ToString()=="N"? "Draft":Eval("hearing_status").ToString()=="Y"?"Submited":Eval("hearing_status").ToString()%>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
