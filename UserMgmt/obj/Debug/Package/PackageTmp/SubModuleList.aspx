<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="SubModuleList.aspx.cs" Inherits="UserMgmt.SubModuleList" %>
                                ...
                                <title>User Management</title>
                                  <script>
                                    function chkDuplicateAccessTypeName() {
                                        debugger;
                                        var email = $('#BodyContent_grdsubmoduleList_txtSearch2').val();
                                        var jsondata = JSON.stringify($('#BodyContent_grdsubmoduleList_txtSearch2').val());
                                        $.ajax({
                                            type: "POST",
                                            //url: "UserRegistrationForm.aspx/chkDuplicateEmail",
                                            url: "SubModuleList.aspx/chkDuplicateAccessTypeName",
                                            data: '{name:' + jsondata + '}',
                                    ...
                                    $(document).ready(function () {
                                        $('#BodyContent_grdsubmoduleList_ddlsearch1').change(function () {
                                            $('#BodyContent_grdsubmoduleList_txtSearch2').val('');
                                        });
                                    });
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="x_panel">
                                                <div class="x_title">
                                                    ...
                                                    <h2>Sub Module  List</h2>
                                                     <div runat="server" visible="false"  style="float:right">
                                                         <asp:TextBox ID="txtSearch" runat="server" Width="250px" AutoComplete="off"   Height="30px" placeholder="Search SubModule Name"  AutoPostBack="true" OnTextChanged="txtSearch_TextChanged" ></asp:TextBox>
                                                    ...
                                                    <ContentTemplate>
                                                <div class="x_content">
                                                    <asp:GridView ID="grdsubmoduleList" runat="server" AutoGenerateColumns="false" PageSize="10" AllowPaging="true"  EmptyDataText="No Records" OnPageIndexChanging="grdsubmoduleList_PageIndexChanging"
                                                        HeaderStyle-BackColor="#26b8b8" OnDataBound="grdsubmoduleList_DataBound" HeaderStyle-ForeColor="#ECF0F1" class="table table-striped responsive-utilities jambo_table">
                                               ...
                                               <asp:ListItem Text="SubModule Code" Value="submodule_code"></asp:ListItem>
                                                ...
                                                <asp:ListItem Text="Organisation Name" Value="org_name"></asp:ListItem>
                    ...
                    runat="server" CommandArgument="Next" Width="30px" Height="20px" CommandName="Page" ForeColor="Blue" BackColor="Blue" ImageUrl="~/img/icons8-next-50.png"  /> <asp:ImageButton
                        ID="btnLast" runat="server" CommandArgument="Last" Width="30px" Visible="false" Height="20px" BackColor="Blue" CommandName="Page" ImageUrl="~/img/icons8-last-50.png" />
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="SubModule Code "  ItemStyle-Font-Bold="true" ItemStyle-Width="20px"> 
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblsubModuleCode" runat="server" Visible="true" Text='<%#Eval("SubModule_Code") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="SubModule  Name " ItemStyle-Font-Bold="true" ItemStyle-Width="20px">  
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblsubmodulename" runat="server" Visible="true" Text='<%#Eval("SubModule_Name") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                             ...
                                                             <asp:TemplateField HeaderText="Module Name" Visible="false" ItemStyle-Font-Bold="true" ItemStyle-Width="20px"> 
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblmns_no" runat="server" Visible="true" Text='<%#Eval("mns_no") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Organisation Name" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">   
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblOrganisationName" runat="server" Visible="true" Text='<%#Eval("org_name") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                             <asp:TemplateField HeaderText="Organisation id" Visible="false" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">   
                                                                <ItemTemplate>
