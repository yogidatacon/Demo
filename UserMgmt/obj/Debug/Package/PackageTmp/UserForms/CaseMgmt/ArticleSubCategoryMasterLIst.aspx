<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="ArticleSubCategoryMasterLIst.aspx.cs" Inherits="UserMgmt.ArticleSubCategoryMasterLIst" %>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="x_panel">
                            ...
                            <head>
                                ...
                                <title>Article Sub Category Master List</title>
                                <script>
                                    $(function () {
                                        $(".ddlsearch1s").change(function () {
                                            if ($(this).find('option:selected').text() == "1") {
                                                ...
                                                $('#BodyContent_ArticleSubCategoryMasterView_txtSearch2').val('');
                                            }
                                        });
                                    });
                                ...
                                <script language="javascript" type="text/javascript">
                                    function validationMsg() {
                                        debugger;;
                                        if ($("#BodyContent_ArticleSubCategoryMasterView_ddlsearch1").val() == 'Select') {
                                            alert("select search column!");
                                            $("#BodyContent_ArticleSubCategoryMasterView_ddlsearch1").focus();
                                            return false;
                                        }
                                        if ($("#BodyContent_ArticleSubCategoryMasterView_txtSearch2").val() == '') {
                                            alert("Enter search column Value!");
                                            $("#BodyContent_ArticleSubCategoryMasterView_txtSearch2").focus();
                                            return false;
                                        }
                                    }
                                    </script> 
                            ...
                            <body>
                                   <ul class="nav nav-tabs">
                                    ...
                                    <li >
                                     ...
                                     <li class="active">
                                        <asp:LinkButton ID="ArticleSubCategory" OnClick="ArticleSubCategory_Click" runat="server"><span style="color:#fff;font-size:14px;">Article Sub Category</span></asp:LinkButton></li>
                                    <li  >
                                ...
                                <div class="x_title">
                                    <h2>Article Sub Category Master List</h2>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">
                                     <asp:GridView  ID="ArticleSubCategoryMasterView"  runat="server" AutoGenerateColumns="false"   AllowPaging="true" OnDataBound="ArticleSubCategoryMasterView_DataBound" 
                                                        HeaderStyle-BackColor="#26b8b8" HeaderStyle-ForeColor="#ECF0F1" class="table table-striped responsive-utilities jambo_table" OnPageIndexChanging="ArticleSubCategoryMasterView_PageIndexChanging">
                                         <PagerSettings FirstPageImageUrl="~/img/icons8-first-50.png" 
                                               ...
                                               <asp:ListItem Text="Select" Value="Select"></asp:ListItem>
                                                <asp:ListItem Text="Article Sub-Category Code" Value="article_sub_category_code"></asp:ListItem>
                        ...
                        ID="btnLast" runat="server" CommandArgument="Last" Width="30px" Visible="false" Height="20px" BackColor="Blue" CommandName="Page" ImageUrl="~/img/icons8-last-50.png" />
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="Code" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblCode" runat="server" Visible="true" Text='<%#Eval("article_sub_category_code") %>' ></asp:Label>
                                                                   
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Name" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblName" runat="server" Visible="true"  Text='<%#Eval("article_sub_category_name") %>'></asp:Label>
                                                                   
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Article Category" ItemStyle-Font-Bold="true" ItemStyle-Width="20px" Visible="false">
                                                                <ItemTemplate>
                                                             ...
                                                             <asp:TemplateField HeaderText="Id" ItemStyle-Font-Bold="true" ItemStyle-Width="20px" Visible="false">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblId" runat="server" Visible="true" Text='<%#Eval("article_sub_category_master_id") %>' ></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
