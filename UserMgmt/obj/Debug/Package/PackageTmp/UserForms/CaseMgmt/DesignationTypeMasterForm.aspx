<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="DesignationTypeMasterForm.aspx.cs" Inherits="UserMgmt.DesignationTypeMasterForm" %>
                                  ...
                                  <script language="javascript" type="text/javascript">
                                    function validationMsg() {
                                        ...
                                        if (document.getElementById('<%=txtCode.ClientID%>').value == '') {
                                            alert("Enter  Designation Type Code");
                                              document.getElementById("<% =txtCode.ClientID%>").focus();
                                            return false;
                                          
                                        }
                                        if (document.getElementById('<%=txtName.ClientID%>').value == '') {
                                            alert("Enter  Designation Type Name");
