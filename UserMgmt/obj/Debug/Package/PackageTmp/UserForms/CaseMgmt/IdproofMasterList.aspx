<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="IdproofMasterList.aspx.cs" Inherits="UserMgmt.IdproofMasterList" %>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="x_panel">
                            ...
                            <head>
                                ...
                                <title>Idproof  Master List</title>
                                <script>
                                    $(function () {
                                        $(".ddlsearch1s").change(function () {
                                            if ($(this).find('option:selected').text() == "1") {
                                                ...
                                                $('#BodyContent_IdproofMasterView_txtSearch2').val('');
                                            }
                                        });
                                    });
                                   ...
                                   <script language="javascript" type="text/javascript">
                                    function validationMsg() {
                                        debugger;;
                                        if ($("#BodyContent_IdproofMasterView_ddlsearch1").val() == 'Select') {
                                            alert("select search column!");
                                            $("#BodyContent_IdproofMasterView_ddlsearch1").focus();
                                            return false;
                                        }
                                        if ($("#BodyContent_IdproofMasterView_txtSearch2").val() == '') {
                                            alert("Enter search column Value!");
                                            $("#BodyContent_IdproofMasterView_txtSearch2").focus();
                                            return false;
                                        }
                                    }
                                    </script> 
                            ...
                            <body>
                                ...
                                <div class="x_title">
                                    <h2>Idproof  Master List</h2>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">
                                     <asp:GridView  ID="IdproofMasterView"  runat="server" AutoGenerateColumns="false"   AllowPaging="true" OnDataBound="IdproofMasterView_DataBound" 
                                                        HeaderStyle-BackColor="#26b8b8" HeaderStyle-ForeColor="#ECF0F1" class="table table-striped responsive-utilities jambo_table" OnPageIndexChanging="IdproofMasterView_PageIndexChanging">
                                         ...
                                         <PagerTemplate>
                                             <asp:DropDownList ID="ddlsearch1" runat="server" CssClass="ddlsearch1s" Width="150px" Font-Bold="true" Height="25px" 
                                                                ForeColor="Black" Font-Size="12px" style="float:left">
                                               <asp:ListItem Text="Select" Value="Select"></asp:ListItem>
                                                <asp:ListItem Text="Id Proof Code" Value="idproof_code"></asp:ListItem>
                                                <asp:ListItem Text="Id Proof Name" Value="idproof_name"></asp:ListItem>
                        ...
                        ID="btnLast" runat="server" CommandArgument="Last" Width="30px" Visible="false" Height="20px" BackColor="Blue" CommandName="Page" ImageUrl="~/img/icons8-last-50.png" />
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="Code" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblCode" runat="server" Visible="true" Text='<%#Eval("idproof_code") %>'  ></asp:Label>
                                                                   
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Name" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblName" runat="server" Visible="true" Text='<%#Eval("idproof_name") %>'  ></asp:Label>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblId" runat="server" Visible="true" Text='<%#Eval("idproof_master_id") %>'  ></asp:Label>
