<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="OffenceTypeMasterList.aspx.cs" Inherits="UserMgmt.OffenceTypeMasterList" %>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="x_panel">
                            ...
                            <head>
                                ...
                                <title>Offence Type  Master List</title>
                                <script>
                                    $(function () {
                                        $(".ddlsearch1s").change(function () {
                                            if ($(this).find('option:selected').text() == "1") {
                                                ...
                                                $('#BodyContent_OffenceTypeMasterView_txtSearch2').val('');
                                            }
                                        });
                                    });
                                 ...
                                 <script language="javascript" type="text/javascript">
                                    function validationMsg() {
                                        debugger;;
                                        if ($("#BodyContent_OffenceTypeMasterView_ddlsearch1").val() == 'Select') {
                                            alert("select search column!");
                                            $("#BodyContent_OffenceTypeMasterView_ddlsearch1").focus();
                                            return false;
                                        }
                                        if ($("#BodyContent_OffenceTypeMasterView_txtSearch2").val() == '') {
                                            alert("Enter search column Value!");
                                            $("#BodyContent_OffenceTypeMasterView_txtSearch2").focus();
                                            return false;
                                        }
                                    }
                                    </script> 
                            ...
                            <body>
                                ...
                                <div class="x_title">
                                    <h2>Offence Type  Master List</h2>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">
                                     <asp:GridView  ID="OffenceTypeMasterView"  runat="server" AutoGenerateColumns="false"   AllowPaging="true" OnDataBound="OffenceTypeMasterView_DataBound" 
                                                        HeaderStyle-BackColor="#26b8b8" HeaderStyle-ForeColor="#ECF0F1" class="table table-striped responsive-utilities jambo_table" OnPageIndexChanging="OffenceTypeMasterView_PageIndexChanging">
                                         <PagerSettings FirstPageImageUrl="~/img/icons8-first-50.png" 
                                               ...
                                               <asp:ListItem Text="Select" Value="Select"></asp:ListItem>
                                                <asp:ListItem Text="Offence Type Code" Value="offence_type_code"></asp:ListItem>
                                                <asp:ListItem Text="Offence Type Name" Value="offence_type_name"></asp:ListItem>
                        ...
                        ID="btnLast" runat="server" CommandArgument="Last" Width="30px" Visible="false" Height="20px" BackColor="Blue" CommandName="Page" ImageUrl="~/img/icons8-last-50.png" />
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="Code" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblCode" runat="server" Visible="true" Text='<%#Eval("offence_type_code") %>'  ></asp:Label>
                                                                   
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Name" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblName" runat="server" Visible="true" Text='<%#Eval("offence_type_name") %>'  ></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Id" ItemStyle-Font-Bold="true" ItemStyle-Width="20px" Visible="false">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblId" runat="server" Visible="true" Text='<%#Eval("offence_type_id") %>'  ></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
