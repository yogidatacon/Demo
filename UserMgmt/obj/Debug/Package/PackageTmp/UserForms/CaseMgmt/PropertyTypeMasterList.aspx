<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="PropertyTypeMasterList.aspx.cs" Inherits="UserMgmt.PropertyTypeMasterList" %>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="x_panel">
                            ...
                            <head>
                                ...
                                <title>Property Type Master List</title>
                                <script>
                                    $(function () {
                                        $(".ddlsearch1s").change(function () {
                                            if ($(this).find('option:selected').text() == "1") {
                                                ...
                                                $('#BodyContent_grdPropertyTypeMasterList_txtSearch2').val('');
                                            }
                                        });
                                    });
                                 ...
                                 <script language="javascript" type="text/javascript">
                                    function validationMsg() {
                                        debugger;;
                                        if ($("#BodyContent_grdPropertyTypeMasterList_ddlsearch1").val() == 'Select') {
                                            alert("select search column!");
                                            $("#BodyContent_grdPropertyTypeMasterList_ddlsearch1").focus();
                                            return false;
                                        }
                                        if ($("#BodyContent_grdPropertyTypeMasterList_txtSearch2").val() == '') {
                                            alert("Enter search column Value!");
                                            $("#BodyContent_grdPropertyTypeMasterList_txtSearch2").focus();
                                            return false;
                                        }
                                    }
                                    </script> 
                            ...
                            <body>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="x_panel">
                                            <div class="x_title">
                                                <h2>Property Type Master List</h2>
                                                <div class="clearfix"></div>
                                            </div>

                                            <div class="x_content">
                                                <asp:GridView ID="grdPropertyTypeMasterList" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="15" OnDataBound="grdPropertyTypeMasterList_DataBound"
                                                    HeaderStyle-BackColor="#26b8b8" HeaderStyle-ForeColor="#ECF0F1" class="table table-striped responsive-utilities jambo_table" OnPageIndexChanging="grdPropertyTypeMasterList_PageIndexChanging">
                                               ...
                                               <asp:ListItem Text="Select" Value="Select"></asp:ListItem>
                                                <asp:ListItem Text="Property Code" Value="property_type_code"></asp:ListItem>
                                                <asp:ListItem Text="Property Name" Value="property_type"></asp:ListItem>
                ...
                <asp:ImageButton ID="btnNext" Visible="false"
                    runat="server" CommandArgument="Next" Width="30px" Height="20px" CommandName="Page" ForeColor="Blue" BackColor="Blue" ImageUrl="~/img/icons8-next-50.png"  /> <asp:ImageButton
                        ID="btnLast" runat="server" CommandArgument="Last" Width="30px" Visible="false" Height="20px" BackColor="Blue" CommandName="Page" ImageUrl="~/img/icons8-last-50.png" />
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="Property Type Code" Visible="true" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblPropertyTypeCode" runat="server" Visible="true" Text='<%#Eval("product_type_code") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Property Type" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblPropertyTypeName" runat="server" Visible="true" Text='<%#Eval("product_type_name") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>

                                                           <asp:TemplateField HeaderText="Id" ItemStyle-Font-Bold="true" ItemStyle-Width="20px" Visible="false">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblId" runat="server" Visible="true" Text='<%#Eval("product_type_master_id") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
