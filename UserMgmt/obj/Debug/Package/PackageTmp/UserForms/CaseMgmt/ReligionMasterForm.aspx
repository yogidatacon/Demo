<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="ReligionMasterForm.aspx.cs" Inherits="UserMgmt.ReligionMasterForm" %>
                            ...
                            <body>
                                ...
                                <div class="x_content">
                                    <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                        ...
                                        <asp:TextBox ID="txtCode" AutoPostBack="true"  class="form-control" AutoComplete="off" data-toggle="tooltip" data-placement="right" title=" Code" runat="server" OnTextChanged="txtCode_TextChanged" MaxLength="3"></asp:TextBox>
                                    </div>
                                    <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
