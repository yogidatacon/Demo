<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="ReligionMasterList.aspx.cs" Inherits="UserMgmt.ReligionMasterList" %>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="x_panel">
                            ...
                            <head>
                                ...
                                <title>Religion Master List</title>
                                 <script>
                                    $(function () {
                                        $(".ddlsearch1s").change(function () {
                                            if ($(this).find('option:selected').text() == "1") {
                                                ...
                                                $('#BodyContent_ReligionMasterView_txtSearch2').val('');
                                            }
                                        });
                                    });
                                 ...
                                 <script language="javascript" type="text/javascript">
                                    function validationMsg() {
                                        debugger;;
                                        if ($("#BodyContent_ReligionMasterView_ddlsearch1").val() == 'Select') {
                                            alert("select search column!");
                                            $("#BodyContent_ReligionMasterView_ddlsearch1").focus();
                                            return false;
                                     }
                                        if ($("#BodyContent_ReligionMasterView_txtSearch2").val() == '') {
                                         alert("Enter search column Value!");
                                         $("#BodyContent_ReligionMasterView_txtSearch2").focus();
                                         return false;
                                     }
                                    }
                                    </script> 
                            ...
                            <body>
                                 ...
                                 <asp:LinkButton runat="server" CssClass="myButton3 " ID="AddRecord" Visible="false" style="float:right" OnClick="AddRecord_Click"><i class="fa fa-plus-circle"> ADD NEW RECORD</i></asp:LinkButton>
                                <div class="x_title">
                                    <h2>Religion Master List</h2>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">
                                     <asp:GridView  ID="ReligionMasterView"  runat="server" AutoGenerateColumns="false"   AllowPaging="true" OnDataBound="ReligionMasterView_DataBound" 
                                                        HeaderStyle-BackColor="#26b8b8" HeaderStyle-ForeColor="#ECF0F1" class="table table-striped responsive-utilities jambo_table" OnPageIndexChanging="ReligionMasterView_PageIndexChanging">
                                          <PagerSettings FirstPageImageUrl="~/img/icons8-first-50.png" 
                                                        ...
                                                        <PagerTemplate>
                                                            <asp:DropDownList ID="ddlsearch1" runat="server" Width="150px" Font-Bold="true" Height="25px" 
                                                        CssClass="ddlsearch1s"  ForeColor="Black" Font-Size="12px" style="float:left">
                                               <asp:ListItem Text="Select" Value="Select"></asp:ListItem>
                                                <asp:ListItem Text="Religion Code" Value="religion_code"></asp:ListItem>
                        ...
                        ID="btnLast" runat="server" CommandArgument="Last" Width="30px" Visible="false" Height="20px" BackColor="Blue" CommandName="Page" ImageUrl="~/img/icons8-last-50.png" />
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="Code" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblCode" runat="server" Visible="true" Text='<%#Eval("religion_code") %>'  ></asp:Label>
                                                                   
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Name" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblName" runat="server" Visible="true"  Text='<%#Eval("religion_name") %>' ></asp:Label>
                                                                   
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                              <asp:TemplateField HeaderText="Id" ItemStyle-Font-Bold="true" ItemStyle-Width="20px" Visible="false">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblId" runat="server" Visible="true"  Text='<%#Eval("religion_master_id") %>' ></asp:Label>
                                                            ...
                                                            <asp:TemplateField HeaderText="Action"     ItemStyle-Font-Bold="true" HeaderStyle-HorizontalAlign="Center" >
                                                                <ItemTemplate>
                                                                   ...
                                                                   <asp:LinkButton Text="Edit" id="LinkButton1"  CssClass="myButton1"   runat="server" Visible="false"   CommandName="Edit" OnClick="btnEdit_Click" ><i class="fa fa-pencil-square-o"> 
                                                                                    </i> 
                                                                            </asp:LinkButton>
                                                                </ItemTemplate>
