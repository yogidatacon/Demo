<%@ Page Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="UserPermissionsForm.aspx.cs" Inherits="UserMgmt.UserPermissions" %>
                        ...
                        <div class="x_panel">
                            ...
                            <head>
                                ...
                                <script type="text/javascript">
                                    ...
                                    function BindUserPermissionData() {
                                       
                                        $.ajax({
                                            type: "POST",
                                            url: "UserPermissionsForm.aspx/GetUserPermissionData",
                                            data: '{user_id: "test" }',
                                ...
                                <script language="javascript" type="text/javascript">
                                    ...
                                    function SaveUserPermissionsForm() {
                                        ...
                                        //mns_no, module_code, module_name
                                        //submodulenames
                                        //submodule_id,submodule_code,submodule_name
                                        //tabnames
                                        //tab_name_id,tab_name
                                        $.ajax({
                                            type: "POST",
                                            url: "UserPermissionsForm.aspx/SaveUserPermission",
                                            data: '{roleobj: ' + jsondata + ',rolecode:' + $("#BodyContent_ddRolename option:selected").val() + ',orgId:' + $("#BodyContent_ddorgnnames option:selected").val() + '}',
                                            //dataType: 'json',
                            ...
                            <body>
                                ...
                                <div id="mainRolePermission">
                                    <ul class="nav nav-tabs">
                                        <li>
                                            <asp:LinkButton ID="RolePermissions" OnClick="RolePermission_Click" runat="server"><span style="color:#fff;font-size:14px;">Role Permissions</span></asp:LinkButton></li>
                                        <li class="active">
                                            <asp:LinkButton ID="UserPermissions1" OnClick="UserPermission_Click" runat="server"><span style="color:#fff;font-size:14px;">User Permissions</span></asp:LinkButton></li>
                                    </ul>
                                    <br />
                                    <a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="x_content">
                                            ...
                                            <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                <label style="font-size: small"><a style="color: red">*</a> User ID</label><br />
                                                <asp:TextBox ID="txtuserid" AutoPostBack="true" Enabled="false" CssClass="form-control" data-toggle="tooltip" data-placement="right" title="user id" Width="350px" Height="30px" runat="server"></asp:TextBox>
                                            </div>
                                            <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                <label style="font-size: small"><a style="color: red">*</a> Organisation Name</label><br />
                                                <asp:DropDownList ID="ddorgnnames" Height="30px" Width="350px" runat="server" data-toggle="tooltip" CssClass="form-control" data-placement="right" title="Organisation Name"></asp:DropDownList>
                                                <asp:HiddenField ID="txtid" runat="server" />
                                            </div>
                                            <asp:HiddenField ID="org_id" runat="server" />
                                            <div class="col-md-4 col-sm-12 col-xs-12 form-inline">
                                                <label style="font-size: small"><a style="color: red">*</a> Role</label><br />
                                                <asp:DropDownList ID="ddRolename" Height="30px" Width="350px" runat="server" CssClass="form-control" data-toggle="tooltip" data-placement="right" title="Role Name"></asp:DropDownList>
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-9 form-inline">
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                 <input type="button" title="Save" class="btn btn-primary" id="btnSaveIndentForm" value="Submit" onclick="SaveUserPermissionsForm();">
