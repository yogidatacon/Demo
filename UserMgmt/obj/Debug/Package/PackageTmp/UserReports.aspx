<%@ Page Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="UserReports.aspx.cs" Inherits="UserMgmt.UserReports" %>
                                ...
                                <script language="javascript" type="text/javascript">
                                    function validationMsg() {
                                        ...
                                        if (document.getElementById('<%=ddlReportName.ClientID%>').value == 'Select') {
                                           ...
                                           if (document.getElementById('<%=ddlReportName.ClientID%>').value != '71' || document.getElementById('<%=ddlReportName.ClientID%>').value != '72'|| document.getElementById('<%=ddlReportName.ClientID%>').value != '73'|| document.getElementById('<%=ddlReportName.ClientID%>').value != '74') { 
                                        if (document.getElementById('<%=ddlfinancialyear.ClientID%>').value == 'Select') {
                                         ...
                                         if ((document.getElementById('<%=ddlReportName.ClientID%>').value == '21'||document.getElementById('<%=ddlReportName.ClientID%>').value == '22' ||document.getElementById('<%=ddlReportName.ClientID%>').value == '23'||document.getElementById('<%=ddlReportName.ClientID%>').value == '24'||document.getElementById('<%=ddlReportName.ClientID%>').value == '27')  && document.getElementById('<%=ddVats.ClientID%>').value == 'Select') {
                                            ...
                                            return false;
                                              ...
                                              if (document.getElementById('<%=ddlReportName.ClientID%>').value != '23' || document.getElementById('<%=ddlReportName.ClientID%>').value != '24') {
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="x_panel">
                                                ...
                                                <div id="financialyear"  runat="server" class="col-md-2 col-sm-12 col-xs-12 form-inline">
                                                    ...
                                                    <div id="vat" runat="server" class="col-md-2 col-sm-12 col-xs-12 form-inline">
                                                        <label class="control-label" style="font-size: small"><span style="color: red">*</span>VAT Name</label><br />
                                                        <asp:DropDownList ID="ddVats" Height="30px" width="95%" runat="server" data-toggle="tooltip" data-placement="right" title="Reports Name" name="ddlReportNames"  CssClass="form-control" Style="">
                                                            <asp:ListItem Enabled="true" Text="--Select--" Value="Select"></asp:ListItem>
                                                        </asp:DropDownList>
                                                    </div>
                                                        <%--<div id="vat1" visible="false" runat="server" class="col-md-2 col-sm-12 col-xs-12 form-inline">
                                                        <label class="control-label" style="font-size: small"><span style="color: red">*</span>VAT Name</label><br />
                                                        <asp:DropDownList ID="ddlFvat" Height="30px" width="95%" runat="server" data-toggle="tooltip" data-placement="right" title="Reports Name" name="ddlReportNames"  CssClass="form-control" Style="">
                                                            <asp:ListItem Enabled="true" Text="--Select--" Value="Select"></asp:ListItem>
                                                        </asp:DropDownList>
                                                    </div>--%>
                                                     <div id="sale" runat="server" class="col-md-2 col-sm-12 col-xs-12 form-inline">
                                                        <label class="control-label" style="font-size: small"><span style="color: red">*</span>Sale Type</label><br />
                                                        <asp:DropDownList ID="ddlSaleType" Height="30px" width="95%" runat="server" data-toggle="tooltip" data-placement="right" title="Sale Type" name="ddlReportNames"  CssClass="form-control" Style="">
                                                            <asp:ListItem Enabled="true" Text="--Select--" Value="Select"></asp:ListItem>
