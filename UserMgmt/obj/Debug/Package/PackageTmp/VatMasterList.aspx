<%@ Page Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="VatMasterList.aspx.cs" Inherits="UserMgmt.VatMasterList" %>
                                ...
                                <title>User Management</title>
                                   <script>
                                    function chkDuplicateAccessTypeName() {
                                        debugger;
                                        var email = $('#BodyContent_grdvatmasterList_txtSearch2').val();
                                        var jsondata = JSON.stringify($('#BodyContent_grdvatmasterList_txtSearch2').val());
                                        $.ajax({
                                            type: "POST",
                                            //url: "UserRegistrationForm.aspx/chkDuplicateEmail",
                                            url: "VatMasterList.aspx/chkDuplicateAccessTypeName",
                                            data: '{name:' + jsondata + '}',
                                    ...
                                    $(document).ready(function () {
                                        $('#BodyContent_grdvatmasterList_ddlsearch1').change(function () {
                                            $('#BodyContent_grdvatmasterList_txtSearch2').val('');
                                        });
                                    });
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="x_panel">
                                                <div class="x_title">
                                                    ...
                                                    <h2>VAT Master List</h2>
                                                     <div runat="server" visible="false"   style="float:right">

                                                         <asp:TextBox ID="txtSearch" runat="server" Width="250px" AutoComplete="off"   Height="30px" placeholder="Search VAT Name"  AutoPostBack="true" OnTextChanged="txtSearch_TextChanged"></asp:TextBox>
                                                    ...
                                                    <ContentTemplate>
                                                <div class="x_content">
                                                    <asp:GridView ID="grdvatmasterList" OnDataBound="grdvatmasterList_DataBound" runat="server" AutoGenerateColumns="false" PageSize="10" AllowPaging="true" OnPageIndexChanging="grdvatmasterList_PageIndexChanging" EmptyDataText="No Records"
                                               ...
                                               <asp:ListItem Text="Select" Value="Select"></asp:ListItem>
                                                <asp:ListItem Text="VAT Type" Value="vat_type_name"></asp:ListItem>
                                                 ...
                                                 <%--  <asp:ListItem Text="VAT Code" Value="vat_code"></asp:ListItem>--%>
                                                <asp:ListItem Text="VAT Name" Value="vat_name"></asp:ListItem>
                                                 <asp:ListItem Text="Storage Content" Value="product_name"></asp:ListItem>
                                                      <asp:ListItem Text="Capacity" Value="vat_totalcapacity"></asp:ListItem>
                        ...
                        ID="btnLast" runat="server" CommandArgument="Last" Width="30px" Visible="false" Height="20px" BackColor="Blue" CommandName="Page" ImageUrl="~/img/icons8-last-50.png" />
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Storage Content" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblStorage_Content" runat="server" Visible="true" Text='<%#Eval("product_name") %>'></asp:Label>

                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Capacity" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblCapacity" runat="server" Visible="true" Text='<%#Eval("vat_totalcapacity") %>'></asp:Label>
                                                            ...
                                                            <asp:TemplateField HeaderText="vat_code" Visible="false" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblvat_code" runat="server" Visible="true" Text='<%#Eval("vat_code") %>'></asp:Label>
