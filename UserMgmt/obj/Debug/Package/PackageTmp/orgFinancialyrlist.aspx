<%@ Page Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="orgFinancialyrlist.aspx.cs" Inherits="UserMgmt.orgFinancialyrlist" %>
                        ...
                        <div class="x_panel">
                                ...
                                <title>User Management</title>
                                  <script>
                                    function chkDuplicateAccessTypeName() {
                                        debugger;
                                        var email = $('#BodyContent_OrgFinancialList_txtSearch2').val();
                                        var jsondata = JSON.stringify($('#BodyContent_OrgFinancialList_txtSearch2').val());
                                        $.ajax({
                                            type: "POST",
                                            //url: "UserRegistrationForm.aspx/chkDuplicateEmail",
                                            url: "orgFinancialyrlist.aspx/chkDuplicateAccessTypeName",
                                            data: '{name:' + jsondata + '}',
                                    ...
                                    $(document).ready(function () {
                                        $('#BodyContent_OrgFinancialList_ddlsearch1').change(function () {
                                            $('#BodyContent_OrgFinancialList_txtSearch2').val('');
                                        });
                                    });
                            ...
                            <body>
                                <div>
                                    ...
                                    <br />
                                    <a>
                                        <asp:LinkButton runat="server" CssClass="myButton3" ID="AddRecords" OnClick="AddRecords_Click" Style="float: right"><i class="fa fa-list ">ADD NEW RECORD</i></asp:LinkButton></a>
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="x_panel">
                                                <div class="x_title">
                                                    ...
                                                    <h2>Organisation Financial Year List</h2>
                                                    <div runat="server" visible="false"   style="float:right">
                                                         <asp:TextBox ID="txtSearch" runat="server" Width="250px" AutoComplete="off"   Height="30px" placeholder="Search Financial Year"  AutoPostBack="true" OnTextChanged="txtSearch_TextChanged" ></asp:TextBox>
                                                ...
                                                <div class="x_content">
                                                    ...
                                                    <asp:GridView ID="OrgFinancialList" runat="server" AutoGenerateColumns="false" AllowPaging="true" OnPageIndexChanging="OrgFinancialList_PageIndexChanging" PageSize="10"
                                                        HeaderStyle-BackColor="#26b8b8" OnDataBound="OrgFinancialList_DataBound" HeaderStyle-ForeColor="#ECF0F1" class="table table-striped responsive-utilities jambo_table" HeaderStyle-HorizontalAlign="Center">
                ...
                <asp:ImageButton ID="btnNext" Visible="false"
                    runat="server" CommandArgument="Next" Width="30px" Height="20px" CommandName="Page" ForeColor="Blue" BackColor="Blue" ImageUrl="~/img/icons8-next-50.png"  /> <asp:ImageButton
                        ID="btnLast" runat="server" CommandArgument="Last" Width="30px" Visible="false" Height="20px" BackColor="Blue" CommandName="Page" ImageUrl="~/img/icons8-last-50.png" />
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="Financial Year" ItemStyle-Font-Bold="true" ItemStyle-Width="20px" HeaderStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblFinancialYear" runat="server" Visible="true" Text='<%#Eval("financial_year") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Org Name" HeaderStyle-HorizontalAlign="Center" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblOrgName" runat="server" Visible="true" Text='<%#Eval("org_Name") %>'></asp:Label>

                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Status" HeaderStyle-HorizontalAlign="Center" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="orgid" Visible="false" ItemStyle-Font-Bold="true" ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblorg_id" runat="server" Visible="true" Text='<%#Eval("slno") %>'></asp:Label>
                                                            ...
                                                            <asp:TemplateField HeaderText="Action" ItemStyle-Font-Bold="true" HeaderStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton Text="View" ID="btnView" CssClass="myButton" runat="server" CommandArgument='<%# Bind("slno") %>' CommandName="View" OnClick="btnView_Click"><i class="fa fa-search-plus">
                                                                                    </i> 
                                                                    </asp:LinkButton>
                                                                    <%-- <asp:LinkButton Text="Inactive" id="btnInactive"  CssClass="myButton2"   runat="server" CommandArgument='<%# Bind("slno") %>'   CommandName="Inactive" OnClick="btnInactive_Click" ><i class="fa fa-remove"> 
                                                                                    </i> 
                                                                            </asp:LinkButton>--%>
                                                                </ItemTemplate>
